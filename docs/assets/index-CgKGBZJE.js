 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var sx;function Zv(){if(sx)return le;sx=1;var o=Symbol.for("react.transitional.element"),e=Symbol.for("react.portal"),i=Symbol.for("react.fragment"),r=Symbol.for("react.strict_mode"),l=Symbol.for("react.profiler"),u=Symbol.for("react.consumer"),d=Symbol.for("react.context"),h=Symbol.for("react.forward_ref"),m=Symbol.for("react.suspense"),p=Symbol.for("react.memo"),v=Symbol.for("react.lazy"),g=Symbol.for("react.activity"),S=Symbol.iterator;function M(U){return U===null||typeof U!="object"?null:(U=S&&U[S]||U["@@iterator"],typeof U=="function"?U:null)}var T={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},D=Object.assign,y={};function _(U,et,vt){this.props=U,this.context=et,this.refs=y,this.updater=vt||T}_.prototype.isReactComponent={},_.prototype.setState=function(U,et){if(typeof U!="object"&&typeof U!="function"&&U!=null)throw Error("takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,U,et,"setState")},_.prototype.forceUpdate=function(U){this.updater.enqueueForceUpdate(this,U,"forceUpdate")};function P(){}P.prototype=_.prototype;function L(U,et,vt){this.props=U,this.context=et,this.refs=y,this.updater=vt||T}var F=L.prototype=new P;F.constructor=L,D(F,_.prototype),F.isPureReactComponent=!0;var k=Array.isArray;function N(){}var I={H:null,A:null,T:null,S:null},K=Object.prototype.hasOwnProperty;function C(U,et,vt){var yt=vt.ref;return{$$typeof:o,type:U,key:et,ref:yt!==void 0?yt:null,props:vt}}function R(U,et){return C(U.type,et,U.props)}function H(U){return typeof U=="object"&&U!==null&&U.$$typeof===o}function j(U){var et={"=":"=0",":":"=2"};return"$"+U.replace(/[=:]/g,function(vt){return et[vt]})}var rt=/\/+/g;function lt(U,et){return typeof U=="object"&&U!==null&&U.key!=null?j(""+U.key):et.toString(36)}function st(U){switch(U.status){case"fulfilled":return U.value;case"rejected":throw U.reason;default:switch(typeof U.status=="string"?U.then(N,N):(U.status="pending",U.then(function(et){U.status==="pending"&&(U.status="fulfilled",U.value=et)},function(et){U.status==="pending"&&(U.status="rejected",U.reason=et)})),U.status){case"fulfilled":return U.value;case"rejected":throw U.reason}}throw U}function O(U,et,vt,yt,Nt){var it=typeof U;(it==="undefined"||it==="boolean")&&(U=null);var ut=!1;if(U===null)ut=!0;else switch(it){case"bigint":case"string":case"number":ut=!0;break;case"object":switch(U.$$typeof){case o:case e:ut=!0;break;case v:return ut=U._init,O(ut(U._payload),et,vt,yt,Nt)}}if(ut)return Nt=Nt(U),ut=yt===""?"."+lt(U,0):yt,k(Nt)?(vt="",ut!=null&&(vt=ut.replace(rt,"$&/")+"/"),O(Nt,et,vt,"",function(Ht){return Ht})):Nt!=null&&(H(Nt)&&(Nt=R(Nt,vt+(Nt.key==null||U&&U.key===Nt.key?"":(""+Nt.key).replace(rt,"$&/")+"/")+ut)),et.push(Nt)),1;ut=0;var Ct=yt===""?".":yt+":";if(k(U))for(var Pt=0;Pt<U.length;Pt++)yt=U[Pt],it=Ct+lt(yt,Pt),ut+=O(yt,et,vt,it,Nt);else if(Pt=M(U),typeof Pt=="function")for(U=Pt.call(U),Pt=0;!(yt=U.next()).done;)yt=yt.value,it=Ct+lt(yt,Pt++),ut+=O(yt,et,vt,it,Nt);else if(it==="object"){if(typeof U.then=="function")return O(st(U),et,vt,yt,Nt);throw et=String(U),Error("Objects are not valid as a React child (found: "+(et==="[object Object]"?"object with keys {"+Object.keys(U).join(", ")+"}":et)+"). If you meant to render a collection of children, use an array instead.")}return ut}function V(U,et,vt){if(U==null)return U;var yt=[],Nt=0;return O(U,yt,"","",function(it){return et.call(vt,it,Nt++)}),yt}function W(U){if(U._status===-1){var et=U._result;et=et(),et.then(function(vt){(U._status===0||U._status===-1)&&(U._status=1,U._result=vt)},function(vt){(U._status===0||U._status===-1)&&(U._status=2,U._result=vt)}),U._status===-1&&(U._status=0,U._result=et)}if(U._status===1)return U._result.default;throw U._result}var pt=typeof reportError=="function"?reportError:function(U){if(typeof window=="object"&&typeof window.ErrorEvent=="function"){var et=new window.ErrorEvent("error",{bubbles:!0,cancelable:!0,message:typeof U=="object"&&U!==null&&typeof U.message=="string"?String(U.message):String(U),error:U});if(!window.dispatchEvent(et))return}else if(typeof process=="object"&&typeof process.emit=="function"){process.emit("uncaughtException",U);return}console.error(U)},dt={map:V,forEach:function(U,et,vt){V(U,function(){et.apply(this,arguments)},vt)},count:function(U){var et=0;return V(U,function(){et++}),et},toArray:function(U){return V(U,function(et){return et})||[]},only:function(U){if(!H(U))throw Error("React.Children.only expected to receive a single React element child.");return U}};return le.Activity=g,le.Children=dt,le.Component=_,le.Fragment=i,le.Profiler=l,le.PureComponent=L,le.StrictMode=r,le.Suspense=m,le.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=I,le.__COMPILER_RUNTIME={__proto__:null,c:function(U){return I.H.useMemoCache(U)}},le.cache=function(U){return function(){return U.apply(null,arguments)}},le.cacheSignal=function(){return null},le.cloneElement=function(U,et,vt){if(U==null)throw Error("The argument must be a React element, but you passed "+U+".");var yt=D({},U.props),Nt=U.key;if(et!=null)for(it in et.key!==void 0&&(Nt=""+et.key),et)!K.call(et,it)||it==="key"||it==="__self"||it==="__source"||it==="ref"&&et.ref===void 0||(yt[it]=et[it]);var it=arguments.length-2;if(it===1)yt.children=vt;else if(1<it){for(var ut=Array(it),Ct=0;Ct<it;Ct++)ut[Ct]=arguments[Ct+2];yt.children=ut}return C(U.type,Nt,yt)},le.createContext=function(U){return U={$$typeof:d,_currentValue:U,_currentValue2:U,_threadCount:0,Provider:null,Consumer:null},U.Provider=U,U.Consumer={$$typeof:u,_context:U},U},le.createElement=function(U,et,vt){var yt,Nt={},it=null;if(et!=null)for(yt in et.key!==void 0&&(it=""+et.key),et)K.call(et,yt)&&yt!=="key"&&yt!=="__self"&&yt!=="__source"&&(Nt[yt]=et[yt]);var ut=arguments.length-2;if(ut===1)Nt.children=vt;else if(1<ut){for(var Ct=Array(ut),Pt=0;Pt<ut;Pt++)Ct[Pt]=arguments[Pt+2];Nt.children=Ct}if(U&&U.defaultProps)for(yt in ut=U.defaultProps,ut)Nt[yt]===void 0&&(Nt[yt]=ut[yt]);return C(U,it,Nt)},le.createRef=function(){return{current:null}},le.forwardRef=function(U){return{$$typeof:h,render:U}},le.isValidElement=H,le.lazy=function(U){return{$$typeof:v,_payload:{_status:-1,_result:U},_init:W}},le.memo=function(U,et){return{$$typeof:p,type:U,compare:et===void 0?null:et}},le.startTransition=function(U){var et=I.T,vt={};I.T=vt;try{var yt=U(),Nt=I.S;Nt!==null&&Nt(vt,yt),typeof yt=="object"&&yt!==null&&typeof yt.then=="function"&&yt.then(N,pt)}catch(it){pt(it)}finally{et!==null&&vt.types!==null&&(et.types=vt.types),I.T=et}},le.unstable_useCacheRefresh=function(){return I.H.useCacheRefresh()},le.use=function(U){return I.H.use(U)},le.useActionState=function(U,et,vt){return I.H.useActionState(U,et,vt)},le.useCallback=function(U,et){return I.H.useCallback(U,et)},le.useContext=function(U){return I.H.useContext(U)},le.useDebugValue=function(){},le.useDeferredValue=function(U,et){return I.H.useDeferredValue(U,et)},le.useEffect=function(U,et){return I.H.useEffect(U,et)},le.useEffectEvent=function(U){return I.H.useEffectEvent(U)},le.useId=function(){return I.H.useId()},le.useImperativeHandle=function(U,et,vt){return I.H.useImperativeHandle(U,et,vt)},le.useInsertionEffect=function(U,et){return I.H.useInsertionEffect(U,et)},le.useLayoutEffect=function(U,et){return I.H.useLayoutEffect(U,et)},le.useMemo=function(U,et){return I.H.useMemo(U,et)},le.useOptimistic=function(U,et){return I.H.useOptimistic(U,et)},le.useReducer=function(U,et,vt){return I.H.useReducer(U,et,vt)},le.useRef=function(U){return I.H.useRef(U)},le.useState=function(U){return I.H.useState(U)},le.useSyncExternalStore=function(U,et,vt){return I.H.useSyncExternalStore(U,et,vt)},le.useTransition=function(){return I.H.useTransition()},le.version="19.2.1",le}var ox;function ph(){return ox||(ox=1,Vf.exports=Zv()),Vf.exports}var Oe=ph();const Kv=ug(Oe);var Xf={exports:{}},bo={},kf={exports:{}},Wf={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var lx;function Qv(){return lx||(lx=1,(function(o){function e(O,V){var W=O.length;O.push(V);t:for(;0<W;){var pt=W-1>>>1,dt=O[pt];if(0<l(dt,V))O[pt]=V,O[W]=dt,W=pt;else break t}}function i(O){return O.length===0?null:O[0]}function r(O){if(O.length===0)return null;var V=O[0],W=O.pop();if(W!==V){O[0]=W;t:for(var pt=0,dt=O.length,U=dt>>>1;pt<U;){var et=2*(pt+1)-1,vt=O[et],yt=et+1,Nt=O[yt];if(0>l(vt,W))yt<dt&&0>l(Nt,vt)?(O[pt]=Nt,O[yt]=W,pt=yt):(O[pt]=vt,O[et]=W,pt=et);else if(yt<dt&&0>l(Nt,W))O[pt]=Nt,O[yt]=W,pt=yt;else break t}}return V}function l(O,V){var W=O.sortIndex-V.sortIndex;return W!==0?W:O.id-V.id}if(o.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var u=performance;o.unstable_now=function(){return u.now()}}else{var d=Date,h=d.now();o.unstable_now=function(){return d.now()-h}}var m=[],p=[],v=1,g=null,S=3,M=!1,T=!1,D=!1,y=!1,_=typeof setTimeout=="function"?setTimeout:null,P=typeof clearTimeout=="function"?clearTimeout:null,L=typeof setImmediate<"u"?setImmediate:null;function F(O){for(var V=i(p);V!==null;){if(V.callback===null)r(p);else if(V.startTime<=O)r(p),V.sortIndex=V.expirationTime,e(m,V);else break;V=i(p)}}function k(O){if(D=!1,F(O),!T)if(i(m)!==null)T=!0,N||(N=!0,j());else{var V=i(p);V!==null&&st(k,V.startTime-O)}}var N=!1,I=-1,K=5,C=-1;function R(){return y?!0:!(o.unstable_now()-C<K)}function H(){if(y=!1,N){var O=o.unstable_now();C=O;var V=!0;try{t:{T=!1,D&&(D=!1,P(I),I=-1),M=!0;var W=S;try{e:{for(F(O),g=i(m);g!==null&&!(g.expirationTime>O&&R());){var pt=g.callback;if(typeof pt=="function"){g.callback=null,S=g.priorityLevel;var dt=pt(g.expirationTime<=O);if(O=o.unstable_now(),typeof dt=="function"){g.callback=dt,F(O),V=!0;break e}g===i(m)&&r(m),F(O)}else r(m);g=i(m)}if(g!==null)V=!0;else{var U=i(p);U!==null&&st(k,U.startTime-O),V=!1}}break t}finally{g=null,S=W,M=!1}V=void 0}}finally{V?j():N=!1}}}var j;if(typeof L=="function")j=function(){L(H)};else if(typeof MessageChannel<"u"){var rt=new MessageChannel,lt=rt.port2;rt.port1.onmessage=H,j=function(){lt.postMessage(null)}}else j=function(){_(H,0)};function st(O,V){I=_(function(){O(o.unstable_now())},V)}o.unstable_IdlePriority=5,o.unstable_ImmediatePriority=1,o.unstable_LowPriority=4,o.unstable_NormalPriority=3,o.unstable_Profiling=null,o.unstable_UserBlockingPriority=2,o.unstable_cancelCallback=function(O){O.callback=null},o.unstable_forceFrameRate=function(O){0>O||125<O?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):K=0<O?Math.floor(1e3/O):5},o.unstable_getCurrentPriorityLevel=function(){return S},o.unstable_next=function(O){switch(S){case 1:case 2:case 3:var V=3;break;default:V=S}var W=S;S=V;try{return O()}finally{S=W}},o.unstable_requestPaint=function(){y=!0},o.unstable_runWithPriority=function(O,V){switch(O){case 1:case 2:case 3:case 4:case 5:break;default:O=3}var W=S;S=O;try{return V()}finally{S=W}},o.unstable_scheduleCallback=function(O,V,W){var pt=o.unstable_now();switch(typeof W=="object"&&W!==null?(W=W.delay,W=typeof W=="number"&&0<W?pt+W:pt):W=pt,O){case 1:var dt=-1;break;case 2:dt=250;break;case 5:dt=1073741823;break;case 4:dt=1e4;break;default:dt=5e3}return dt=W+dt,O={id:v++,callback:V,priorityLevel:O,startTime:W,expirationTime:dt,sortIndex:-1},W>pt?(O.sortIndex=W,e(p,O),i(m)===null&&O===i(p)&&(D?(P(I),I=-1):D=!0,st(k,W-pt))):(O.sortIndex=dt,e(m,O),T||M||(T=!0,N||(N=!0,j()))),O},o.unstable_shouldYield=R,o.unstable_wrapCallback=function(O){var V=S;return function(){var W=S;S=V;try{return O.apply(this,arguments)}finally{S=W}}}})(Wf)),Wf}var cx;function Jv(){return cx||(cx=1,kf.exports=Qv()),kf.exports}var qf={exports:{}},wn={};/**
 * @license React
...
`)+`
`+_);const L=P+y+d,F=P+_+h,k=tg(l,l.VERTEX_SHADER,L),N=tg(l,l.FRAGMENT_SHADER,F);l.attachShader(D,k),l.attachShader(D,N),i.index0AttributeName!==void 0?l.bindAttribLocation(D,0,i.index0AttributeName):i.morphTargets===!0&&l.bindAttribLocation(D,0,"position"),l.linkProgram(D);function I(H){if(o.debug.checkShaderErrors){const j=l.getProgramInfoLog(D)||"",rt=l.getShaderInfoLog(k)||"",lt=l.getShaderInfoLog(N)||"",st=j.trim(),O=rt.trim(),V=lt.trim();let W=!0,pt=!0;if(l.getProgramParameter(D,l.LINK_STATUS)===!1)if(W=!1,typeof o.debug.onShaderError=="function")o.debug.onShaderError(l,D,k,N);else{const dt=ng(l,k,"vertex"),U=ng(l,N,"fragment");rn("THREE.WebGLProgram: Shader Error "+l.getError()+" - VALIDATE_STATUS "+l.getProgramParameter(D,l.VALIDATE_STATUS)+`
...
}`;function iE(o,e,i){let r=new Ng;const l=new ke,u=new ke,d=new sn,h=new Cy({depthPacking:IS}),m=new Dy,p={},v=i.maxTextureSize,g={[ja]:Xn,[Xn]:ja,[oa]:oa},S=new Li({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new ke},radius:{value:4}},vertexShader:eE,fragmentShader:nE}),M=S.clone();M.defines.HORIZONTAL_PASS=1;const T=new Ni;T.setAttribute("position",new ii(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const D=new Za(T,S),y=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=fg;let _=this.type;this.render=function(N,I,K){if(y.enabled===!1||y.autoUpdate===!1&&y.needsUpdate===!1||N.length===0)return;const C=o.getRenderTarget(),R=o.getActiveCubeFace(),H=o.getActiveMipmapLevel(),j=o.state;j.setBlending(ua),j.buffers.depth.getReversed()===!0?j.buffers.color.setClear(0,0,0,0):j.buffers.color.setClear(1,1,1,1),j.buffers.depth.setTest(!0),j.setScissorTest(!1);const rt=_!==sa&&this.type===sa,lt=_===sa&&this.type!==sa;for(let st=0,O=N.length;st<O;st++){const V=N[st],W=V.shadow;if(W===void 0){fe("WebGLShadowMap:",V,"has no shadow.");continue}if(W.autoUpdate===!1&&W.needsUpdate===!1)continue;l.copy(W.mapSize);const pt=W.getFrameExtents();if(l.multiply(pt),u.copy(W.mapSize),(l.x>v||l.y>v)&&(l.x>v&&(u.x=Math.floor(v/pt.x),l.x=u.x*pt.x,W.mapSize.x=u.x),l.y>v&&(u.y=Math.floor(v/pt.y),l.y=u.y*pt.y,W.mapSize.y=u.y)),W.map===null||rt===!0||lt===!0){const U=this.type!==sa?{minFilter:ni,magFilter:ni}:{};W.map!==null&&W.map.dispose(),W.map=new Ar(l.x,l.y,U),W.map.texture.name=V.name+".shadowMap",W.camera.updateProjectionMatrix()}o.setRenderTarget(W.map),o.clear();const dt=W.getViewportCount();for(let U=0;U<dt;U++){const et=W.getViewport(U);d.set(u.x*et.x,u.y*et.y,u.x*et.z,u.y*et.w),j.viewport(d),W.updateMatrices(V,U),r=W.getFrustum(),F(I,K,W.camera,V,this.type)}W.isPointLightShadow!==!0&&this.type===sa&&P(W,K),W.needsUpdate=!1}_=this.type,y.needsUpdate=!1,o.setRenderTarget(C,R,H)};function P(N,I){const K=e.update(D);S.defines.VSM_SAMPLES!==N.blurSamples&&(S.defines.VSM_SAMPLES=N.blurSamples,M.defines.VSM_SAMPLES=N.blurSamples,S.needsUpdate=!0,M.needsUpdate=!0),N.mapPass===null&&(N.mapPass=new Ar(l.x,l.y)),S.uniforms.shadow_pass.value=N.map.texture,S.uniforms.resolution.value=N.mapSize,S.uniforms.radius.value=N.radius,o.setRenderTarget(N.mapPass),o.clear(),o.renderBufferDirect(I,null,K,S,D,null),M.uniforms.shadow_pass.value=N.mapPass.texture,M.uniforms.resolution.value=N.mapSize,M.uniforms.radius.value=N.radius,o.setRenderTarget(N.map),o.clear(),o.renderBufferDirect(I,null,K,M,D,null)}function L(N,I,K,C){let R=null;const H=K.isPointLight===!0?N.customDistanceMaterial:N.customDepthMaterial;if(H!==void 0)R=H;else if(R=K.isPointLight===!0?m:h,o.localClippingEnabled&&I.clipShadows===!0&&Array.isArray(I.clippingPlanes)&&I.clippingPlanes.length!==0||I.displacementMap&&I.displacementScale!==0||I.alphaMap&&I.alphaTest>0||I.map&&I.alphaTest>0||I.alphaToCoverage===!0){const j=R.uuid,rt=I.uuid;let lt=p[j];lt===void 0&&(lt={},p[j]=lt);let st=lt[rt];st===void 0&&(st=R.clone(),lt[rt]=st,I.addEventListener("dispose",k)),R=st}if(R.visible=I.visible,R.wireframe=I.wireframe,C===sa?R.side=I.shadowSide!==null?I.shadowSide:I.side:R.side=I.shadowSide!==null?I.shadowSide:g[I.side],R.alphaMap=I.alphaMap,R.alphaTest=I.alphaToCoverage===!0?.5:I.alphaTest,R.map=I.map,R.clipShadows=I.clipShadows,R.clippingPlanes=I.clippingPlanes,R.clipIntersection=I.clipIntersection,R.displacementMap=I.displacementMap,R.displacementScale=I.displacementScale,R.displacementBias=I.displacementBias,R.wireframeLinewidth=I.wireframeLinewidth,R.linewidth=I.linewidth,K.isPointLight===!0&&R.isMeshDistanceMaterial===!0){const j=o.properties.get(R);j.light=K}return R}function F(N,I,K,C,R){if(N.visible===!1)return;if(N.layers.test(I.layers)&&(N.isMesh||N.isLine||N.isPoints)&&(N.castShadow||N.receiveShadow&&R===sa)&&(!N.frustumCulled||r.intersectsObject(N))){N.modelViewMatrix.multiplyMatrices(K.matrixWorldInverse,N.matrixWorld);const rt=e.update(N),lt=N.material;if(Array.isArray(lt)){const st=rt.groups;for(let O=0,V=st.length;O<V;O++){const W=st[O],pt=lt[W.materialIndex];if(pt&&pt.visible){const dt=L(N,pt,C,R);N.onBeforeShadow(o,N,I,K,rt,dt,W),o.renderBufferDirect(K,null,rt,dt,N,W),N.onAfterShadow(o,N,I,K,rt,dt,W)}}}else if(lt.visible){const st=L(N,lt,C,R);N.onBeforeShadow(o,N,I,K,rt,st,null),o.renderBufferDirect(K,null,rt,st,N,null),N.onAfterShadow(o,N,I,K,rt,st,null)}}const j=N.children;for(let rt=0,lt=j.length;rt<lt;rt++)F(j[rt],I,K,C,R)}function k(N){N.target.removeEventListener("dispose",k);for(const K in p){const C=p[K],R=N.target.uuid;R in C&&(C[R].dispose(),delete C[R])}}}const aE={[Ad]:Rd,[Cd]:Ud,[Dd]:Ld,[ys]:wd,[Rd]:Ad,[Ud]:Cd,[Ld]:Dd,[wd]:ys};function rE(o,e){function i(){let G=!1;const Dt=new sn;let At=null;const Rt=new sn(0,0,0,0);return{setMask:function(bt){At!==bt&&!G&&(o.colorMask(bt,bt,bt,bt),At=bt)},setLocked:function(bt){G=bt},setClear:function(bt,_t,It,se,Be){Be===!0&&(bt*=se,_t*=se,It*=se),Dt.set(bt,_t,It,se),Rt.equals(Dt)===!1&&(o.clearColor(bt,_t,It,se),Rt.copy(Dt))},reset:function(){G=!1,At=null,Rt.set(-1,0,0,0)}}}function r(){let G=!1,Dt=!1,At=null,Rt=null,bt=null;return{setReversed:function(_t){if(Dt!==_t){const It=e.get("EXT_clip_control");_t?It.clipControlEXT(It.LOWER_LEFT_EXT,It.ZERO_TO_ONE_EXT):It.clipControlEXT(It.LOWER_LEFT_EXT,It.NEGATIVE_ONE_TO_ONE_EXT),Dt=_t;const se=bt;bt=null,this.setClear(se)}},getReversed:function(){return Dt},setTest:function(_t){_t?ut(o.DEPTH_TEST):Ct(o.DEPTH_TEST)},setMask:function(_t){At!==_t&&!G&&(o.depthMask(_t),At=_t)},setFunc:function(_t){if(Dt&&(_t=aE[_t]),Rt!==_t){switch(_t){case Ad:o.depthFunc(o.NEVER);break;case Rd:o.depthFunc(o.ALWAYS);break;case Cd:o.depthFunc(o.LESS);break;case ys:o.depthFunc(o.LEQUAL);break;case Dd:o.depthFunc(o.EQUAL);break;case wd:o.depthFunc(o.GEQUAL);break;case Ud:o.depthFunc(o.GREATER);break;case Ld:o.depthFunc(o.NOTEQUAL);break;default:o.depthFunc(o.LEQUAL)}Rt=_t}},setLocked:function(_t){G=_t},setClear:function(_t){bt!==_t&&(Dt&&(_t=1-_t),o.clearDepth(_t),bt=_t)},reset:function(){G=!1,At=null,Rt=null,bt=null,Dt=!1}}}function l(){let G=!1,Dt=null,At=null,Rt=null,bt=null,_t=null,It=null,se=null,Be=null;return{setTest:function(Re){G||(Re?ut(o.STENCIL_TEST):Ct(o.STENCIL_TEST))},setMask:function(Re){Dt!==Re&&!G&&(o.stencilMask(Re),Dt=Re)},setFunc:function(Re,Dn,Wn){(At!==Re||Rt!==Dn||bt!==Wn)&&(o.stencilFunc(Re,Dn,Wn),At=Re,Rt=Dn,bt=Wn)},setOp:function(Re,Dn,Wn){(_t!==Re||It!==Dn||se!==Wn)&&(o.stencilOp(Re,Dn,Wn),_t=Re,It=Dn,se=Wn)},setLocked:function(Re){G=Re},setClear:function(Re){Be!==Re&&(o.clearStencil(Re),Be=Re)},reset:function(){G=!1,Dt=null,At=null,Rt=null,bt=null,_t=null,It=null,se=null,Be=null}}}const u=new i,d=new r,h=new l,m=new WeakMap,p=new WeakMap;let v={},g={},S=new WeakMap,M=[],T=null,D=!1,y=null,_=null,P=null,L=null,F=null,k=null,N=null,I=new Ie(0,0,0),K=0,C=!1,R=null,H=null,j=null,rt=null,lt=null;const st=o.getParameter(o.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let O=!1,V=0;const W=o.getParameter(o.VERSION);W.indexOf("WebGL")!==-1?(V=parseFloat(/^WebGL (\d)/.exec(W)[1]),O=V>=1):W.indexOf("OpenGL ES")!==-1&&(V=parseFloat(/^OpenGL ES (\d)/.exec(W)[1]),O=V>=2);let pt=null,dt={};const U=o.getParameter(o.SCISSOR_BOX),et=o.getParameter(o.VIEWPORT),vt=new sn().fromArray(U),yt=new sn().fromArray(et);function Nt(G,Dt,At,Rt){const bt=new Uint8Array(4),_t=o.createTexture();o.bindTexture(G,_t),o.texParameteri(G,o.TEXTURE_MIN_FILTER,o.NEAREST),o.texParameteri(G,o.TEXTURE_MAG_FILTER,o.NEAREST);for(let It=0;It<At;It++)G===o.TEXTURE_3D||G===o.TEXTURE_2D_ARRAY?o.texImage3D(Dt,0,o.RGBA,1,1,Rt,0,o.RGBA,o.UNSIGNED_BYTE,bt):o.texImage2D(Dt+It,0,o.RGBA,1,1,0,o.RGBA,o.UNSIGNED_BYTE,bt);return _t}const it={};it[o.TEXTURE_2D]=Nt(o.TEXTURE_2D,o.TEXTURE_2D,1),it[o.TEXTURE_CUBE_MAP]=Nt(o.TEXTURE_CUBE_MAP,o.TEXTURE_CUBE_MAP_POSITIVE_X,6),it[o.TEXTURE_2D_ARRAY]=Nt(o.TEXTURE_2D_ARRAY,o.TEXTURE_2D_ARRAY,1,1),it[o.TEXTURE_3D]=Nt(o.TEXTURE_3D,o.TEXTURE_3D,1,1),u.setClear(0,0,0,1),d.setClear(1),h.setClear(0),ut(o.DEPTH_TEST),d.setFunc(ys),ie(!1),re(px),ut(o.CULL_FACE),_e(ua);function ut(G){v[G]!==!0&&(o.enable(G),v[G]=!0)}function Ct(G){v[G]!==!1&&(o.disable(G),v[G]=!1)}function Pt(G,Dt){return g[G]!==Dt?(o.bindFramebuffer(G,Dt),g[G]=Dt,G===o.DRAW_FRAMEBUFFER&&(g[o.FRAMEBUFFER]=Dt),G===o.FRAMEBUFFER&&(g[o.DRAW_FRAMEBUFFER]=Dt),!0):!1}function Ht(G,Dt){let At=M,Rt=!1;if(G){At=S.get(Dt),At===void 0&&(At=[],S.set(Dt,At));const bt=G.textures;if(At.length!==bt.length||At[0]!==o.COLOR_ATTACHMENT0){for(let _t=0,It=bt.length;_t<It;_t++)At[_t]=o.COLOR_ATTACHMENT0+_t;At.length=bt.length,Rt=!0}}else At[0]!==o.BACK&&(At[0]=o.BACK,Rt=!0);Rt&&o.drawBuffers(At)}function $t(G){return T!==G?(o.useProgram(G),T=G,!0):!1}const Ze={[yr]:o.FUNC_ADD,[uS]:o.FUNC_SUBTRACT,[fS]:o.FUNC_REVERSE_SUBTRACT};Ze[dS]=o.MIN,Ze[hS]=o.MAX;const oe={[pS]:o.ZERO,[mS]:o.ONE,[xS]:o.SRC_COLOR,[Ed]:o.SRC_ALPHA,[MS]:o.SRC_ALPHA_SATURATE,[SS]:o.DST_COLOR,[_S]:o.DST_ALPHA,[gS]:o.ONE_MINUS_SRC_COLOR,[Td]:o.ONE_MINUS_SRC_ALPHA,[yS]:o.ONE_MINUS_DST_COLOR,[vS]:o.ONE_MINUS_DST_ALPHA,[bS]:o.CONSTANT_COLOR,[ES]:o.ONE_MINUS_CONSTANT_COLOR,[TS]:o.CONSTANT_ALPHA,[AS]:o.ONE_MINUS_CONSTANT_ALPHA};function _e(G,Dt,At,Rt,bt,_t,It,se,Be,Re){if(G===ua){D===!0&&(Ct(o.BLEND),D=!1);return}if(D===!1&&(ut(o.BLEND),D=!0),G!==cS){if(G!==y||Re!==C){if((_!==yr||F!==yr)&&(o.blendEquation(o.FUNC_ADD),_=yr,F=yr),Re)switch(G){case vs:o.blendFuncSeparate(o.ONE,o.ONE_MINUS_SRC_ALPHA,o.ONE,o.ONE_MINUS_SRC_ALPHA);break;case bd:o.blendFunc(o.ONE,o.ONE);break;case mx:o.blendFuncSeparate(o.ZERO,o.ONE_MINUS_SRC_COLOR,o.ZERO,o.ONE);break;case xx:o.blendFuncSeparate(o.DST_COLOR,o.ONE_MINUS_SRC_ALPHA,o.ZERO,o.ONE);break;default:rn("WebGLState: Invalid blending: ",G);break}else switch(G){case vs:o.blendFuncSeparate(o.SRC_ALPHA,o.ONE_MINUS_SRC_ALPHA,o.ONE,o.ONE_MINUS_SRC_ALPHA);break;case bd:o.blendFuncSeparate(o.SRC_ALPHA,o.ONE,o.ONE,o.ONE);break;case mx:rn("WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case xx:rn("WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:rn("WebGLState: Invalid blending: ",G);break}P=null,L=null,k=null,N=null,I.set(0,0,0),K=0,y=G,C=Re}return}bt=bt||Dt,_t=_t||At,It=It||Rt,(Dt!==_||bt!==F)&&(o.blendEquationSeparate(Ze[Dt],Ze[bt]),_=Dt,F=bt),(At!==P||Rt!==L||_t!==k||It!==N)&&(o.blendFuncSeparate(oe[At],oe[Rt],oe[_t],oe[It]),P=At,L=Rt,k=_t,N=It),(se.equals(I)===!1||Be!==K)&&(o.blendColor(se.r,se.g,se.b,Be),I.copy(se),K=Be),y=G,C=!1}function B(G,Dt){G.side===oa?Ct(o.CULL_FACE):ut(o.CULL_FACE);let At=G.side===Xn;Dt&&(At=!At),ie(At),G.blending===vs&&G.transparent===!1?_e(ua):_e(G.blending,G.blendEquation,G.blendSrc,G.blendDst,G.blendEquationAlpha,G.blendSrcAlpha,G.blendDstAlpha,G.blendColor,G.blendAlpha,G.premultipliedAlpha),d.setFunc(G.depthFunc),d.setTest(G.depthTest),d.setMask(G.depthWrite),u.setMask(G.colorWrite);const Rt=G.stencilWrite;h.setTest(Rt),Rt&&(h.setMask(G.stencilWriteMask),h.setFunc(G.stencilFunc,G.stencilRef,G.stencilFuncMask),h.setOp(G.stencilFail,G.stencilZFail,G.stencilZPass)),Ft(G.polygonOffset,G.polygonOffsetFactor,G.polygonOffsetUnits),G.alphaToCoverage===!0?ut(o.SAMPLE_ALPHA_TO_COVERAGE):Ct(o.SAMPLE_ALPHA_TO_COVERAGE)}function ie(G){R!==G&&(G?o.frontFace(o.CW):o.frontFace(o.CCW),R=G)}function re(G){G!==sS?(ut(o.CULL_FACE),G!==H&&(G===px?o.cullFace(o.BACK):G===oS?o.cullFace(o.FRONT):o.cullFace(o.FRONT_AND_BACK))):Ct(o.CULL_FACE),H=G}function Te(G){G!==j&&(O&&o.lineWidth(G),j=G)}function Ft(G,Dt,At){G?(ut(o.POLYGON_OFFSET_FILL),(rt!==Dt||lt!==At)&&(o.polygonOffset(Dt,At),rt=Dt,lt=At)):Ct(o.POLYGON_OFFSET_FILL)}function Le(G){G?ut(o.SCISSOR_TEST):Ct(o.SCISSOR_TEST)}function Wt(G){G===void 0&&(G=o.TEXTURE0+st-1),pt!==G&&(o.activeTexture(G),pt=G)}function ne(G,Dt,At){At===void 0&&(pt===null?At=o.TEXTURE0+st-1:At=pt);let Rt=dt[At];Rt===void 0&&(Rt={type:void 0,texture:void 0},dt[At]=Rt),(Rt.type!==G||Rt.texture!==Dt)&&(pt!==At&&(o.activeTexture(At),pt=At),o.bindTexture(G,Dt||it[G]),Rt.type=G,Rt.texture=Dt)}function w(){const G=dt[pt];G!==void 0&&G.type!==void 0&&(o.bindTexture(G.type,null),G.type=void 0,G.texture=void 0)}function b(){try{o.compressedTexImage2D(...arguments)}catch(G){G("WebGLState:",G)}}function Q(){try{o.compressedTexImage3D(...arguments)}catch(G){G("WebGLState:",G)}}function mt(){try{o.texSubImage2D(...arguments)}catch(G){G("WebGLState:",G)}}function St(){try{o.texSubImage3D(...arguments)}catch(G){G("WebGLState:",G)}}function ct(){try{o.compressedTexSubImage2D(...arguments)}catch(G){G("WebGLState:",G)}}function qt(){try{o.compressedTexSubImage3D(...arguments)}catch(G){G("WebGLState:",G)}}function Ut(){try{o.texStorage2D(...arguments)}catch(G){G("WebGLState:",G)}}function Kt(){try{o.texStorage3D(...arguments)}catch(G){G("WebGLState:",G)}}function kt(){try{o.texImage2D(...arguments)}catch(G){G("WebGLState:",G)}}function Mt(){try{o.texImage3D(...arguments)}catch(G){G("WebGLState:",G)}}function Et(G){vt.equals(G)===!1&&(o.scissor(G.x,G.y,G.z,G.w),vt.copy(G))}function Yt(G){yt.equals(G)===!1&&(o.viewport(G.x,G.y,G.z,G.w),yt.copy(G))}function Vt(G,Dt){let At=p.get(Dt);At===void 0&&(At=new WeakMap,p.set(Dt,At));let Rt=At.get(G);Rt===void 0&&(Rt=o.getUniformBlockIndex(Dt,G.name),At.set(G,Rt))}function Ot(G,Dt){const Rt=p.get(Dt).get(G);m.get(Dt)!==Rt&&(o.uniformBlockBinding(Dt,Rt,G.__bindingPointIndex),m.set(Dt,Rt))}function ae(){o.disable(o.BLEND),o.disable(o.CULL_FACE),o.disable(o.DEPTH_TEST),o.disable(o.POLYGON_OFFSET_FILL),o.disable(o.SCISSOR_TEST),o.disable(o.STENCIL_TEST),o.disable(o.SAMPLE_ALPHA_TO_COVERAGE),o.blendEquation(o.FUNC_ADD),o.blendFunc(o.ONE,o.ZERO),o.blendFuncSeparate(o.ONE,o.ZERO,o.ONE,o.ZERO),o.blendColor(0,0,0,0),o.colorMask(!0,!0,!0,!0),o.clearColor(0,0,0,0),o.depthMask(!0),o.depthFunc(o.LESS),d.setReversed(!1),o.clearDepth(1),o.stencilMask(4294967295),o.stencilFunc(o.ALWAYS,0,4294967295),o.stencilOp(o.KEEP,o.KEEP,o.KEEP),o.clearStencil(0),o.cullFace(o.BACK),o.frontFace(o.CCW),o.polygonOffset(0,0),o.activeTexture(o.TEXTURE0),o.bindFramebuffer(o.FRAMEBUFFER,null),o.bindFramebuffer(o.DRAW_FRAMEBUFFER,null),o.bindFramebuffer(o.READ_FRAMEBUFFER,null),o.useProgram(null),o.lineWidth(1),o.scissor(0,0,o.canvas.width,o.canvas.height),o.viewport(0,0,o.canvas.width,o.canvas.height),v={},pt=null,dt={},g={},S=new WeakMap,M=[],T=null,D=!1,y=null,_=null,P=null,L=null,F=null,k=null,N=null,I=new Ie(0,0,0),K=0,C=!1,R=null,H=null,j=null,rt=null,lt=null,vt.set(0,0,o.canvas.width,o.canvas.height),yt.set(0,0,o.canvas.width,o.canvas.height),u.reset(),d.reset(),h.reset()}return{buffers:{color:u,depth:d,stencil:h},enable:ut,disable:Ct,bindFramebuffer:Pt,drawBuffers:Ht,useProgram:$t,setBlending:_e,setMaterial:B,setFlipSided:ie,setCullFace:re,setLineWidth:Te,setPolygonOffset:Ft,setScissorTest:Le,activeTexture:Wt,bindTexture:ne,unbindTexture:w,compressedTexImage2D:b,compressedTexImage3D:Q,texImage2D:kt,texImage3D:Mt,updateUBOMapping:Vt,uniformBlockBinding:Ot,texStorage2D:Ut,texStorage3D:Kt,texSubImage2D:mt,texSubImage3D:St,compressedTexSubImage2D:ct,compressedTexSubImage3D:qt,scissor:Et,viewport:Yt,reset:ae}}function sE(o,e,i,r,l,u,d){const h=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,m=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),p=new ke,v=new WeakMap;let g;const S=new WeakMap;let M=!1;try{M=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function T(w,b){return M?new OffscreenCanvas(w,b):Cc("canvas")}function D(w,b,Q){let mt=1;const St=ne(w);if((St.width>Q||St.height>Q)&&(mt=Q/Math.max(St.width,St.height)),mt<1)if(typeof HTMLImageElement<"u"&&w instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&w instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&w instanceof ImageBitmap||typeof VideoFrame<"u"&&w instanceof VideoFrame){const ct=Math.floor(mt*St.width),qt=Math.floor(mt*St.height);g===void 0&&(g=T(ct,qt));const Ut=b?T(ct,qt):g;return Ut.width=ct,Ut.height=qt,Ut.getContext("2d").drawImage(w,0,0,ct,qt),fe("WebGLRenderer: Texture has been resized from ("+St.width+"x"+St.height+") to ("+ct+"x"+qt+")."),Ut}else return"data"in w&&fe("WebGLRenderer: Image in DataTexture is too big ("+St.width+"x"+St.height+")."),w;return w}function y(w){return w.generateMipmaps}function _(w){o.generateMipmap(w)}function P(w){return w.isWebGLCubeRenderTarget?o.TEXTURE_CUBE_MAP:w.isWebGL3DRenderTarget?o.TEXTURE_3D:w.isWebGLArrayRenderTarget||w.isCompressedArrayTexture?o.TEXTURE_2D_ARRAY:o.TEXTURE_2D}function L(w,b,Q,mt,St=!1){if(w!==null){if(o[w]!==void 0)return o[w];fe("WebGLRenderer: Attempt to use non-existing WebGL internal format '"+w+"'")}let ct=b;if(b===o.RED&&(Q===o.FLOAT&&(ct=o.R32F),Q===o.HALF_FLOAT&&(ct=o.R16F),Q===o.UNSIGNED_BYTE&&(ct=o.R8)),b===o.RED_INTEGER&&(Q===o.UNSIGNED_BYTE&&(ct=o.R8UI),Q===o.UNSIGNED_SHORT&&(ct=o.R16UI),Q===o.UNSIGNED_INT&&(ct=o.R32UI),Q===o.BYTE&&(ct=o.R8I),Q===o.SHORT&&(ct=o.R16I),Q===o.INT&&(ct=o.R32I)),b===o.RG&&(Q===o.FLOAT&&(ct=o.RG32F),Q===o.HALF_FLOAT&&(ct=o.RG16F),Q===o.UNSIGNED_BYTE&&(ct=o.RG8)),b===o.RG_INTEGER&&(Q===o.UNSIGNED_BYTE&&(ct=o.RG8UI),Q===o.UNSIGNED_SHORT&&(ct=o.RG16UI),Q===o.UNSIGNED_INT&&(ct=o.RG32UI),Q===o.BYTE&&(ct=o.RG8I),Q===o.SHORT&&(ct=o.RG16I),Q===o.INT&&(ct=o.RG32I)),b===o.RGB_INTEGER&&(Q===o.UNSIGNED_BYTE&&(ct=o.RGB8UI),Q===o.UNSIGNED_SHORT&&(ct=o.RGB16UI),Q===o.UNSIGNED_INT&&(ct=o.RGB32UI),Q===o.BYTE&&(ct=o.RGB8I),Q===o.SHORT&&(ct=o.RGB16I),Q===o.INT&&(ct=o.RGB32I)),b===o.RGBA_INTEGER&&(Q===o.UNSIGNED_BYTE&&(ct=o.RGBA8UI),Q===o.UNSIGNED_SHORT&&(ct=o.RGBA16UI),Q===o.UNSIGNED_INT&&(ct=o.RGBA32UI),Q===o.BYTE&&(ct=o.RGBA8I),Q===o.SHORT&&(ct=o.RGBA16I),Q===o.INT&&(ct=o.RGBA32I)),b===o.RGB&&(Q===o.UNSIGNED_INT_5_9_9_9_REV&&(ct=o.RGB9_E5),Q===o.UNSIGNED_INT_10F_11F_11F_REV&&(ct=o.R11F_G11F_B10F)),b===o.RGBA){const qt=St?Ac:Ue.getTransfer(mt);Q===o.FLOAT&&(ct=o.RGBA32F),Q===o.HALF_FLOAT&&(ct=o.RGBA16F),Q===o.UNSIGNED_BYTE&&(ct=qt===Xe?o.SRGB8_ALPHA8:o.RGBA8),Q===o.UNSIGNED_SHORT_4_4_4_4&&(ct=o.RGBA4),Q===o.UNSIGNED_SHORT_5_5_5_1&&(ct=o.RGB5_A1)}return(ct===o.R16F||ct===o.R32F||ct===o.RG16F||ct===o.RG32F||ct===o.RGBA16F||ct===o.RGBA32F)&&e.get("EXT_color_buffer_float"),ct}function F(w,b){let Q;return w?b===null||b===Tr||b===Lo?Q=o.DEPTH24_STENCIL8:b===ca?Q=o.DEPTH32F_STENCIL8:b===Uo&&(Q=o.DEPTH24_STENCIL8,fe("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):b===null||b===Tr||b===Lo?Q=o.DEPTH_COMPONENT24:b===ca?Q=o.DEPTH_COMPONENT32F:b===Uo&&(Q=o.DEPTH_COMPONENT16),Q}function k(w,b){return y(w)===!0||w.isFramebufferTexture&&w.minFilter!==ni&&w.minFilter!==pi?Math.log2(Math.max(b.width,b.height))+1:w.mipmaps!==void 0&&w.mipmaps.length>0?w.mipmaps.length:w.isCompressedTexture&&Array.isArray(w.image)?b.mipmaps.length:1}function N(w){const b=w.target;b.removeEventListener("dispose",N),K(b),b.isVideoTexture&&v.delete(b)}function I(w){const b=w.target;b.removeEventListener("dispose",I),R(b)}function K(w){const b=r.get(w);if(b.__webglInit===void 0)return;const Q=w.source,mt=S.get(Q);if(mt){const St=mt[b.__cacheKey];St.usedTimes--,St.usedTimes===0&&C(w),Object.keys(mt).length===0&&S.delete(Q)}r.remove(w)}function C(w){const b=r.get(w);o.deleteTexture(b.__webglTexture);const Q=w.source,mt=S.get(Q);delete mt[b.__cacheKey],d.memory.textures--}function R(w){const b=r.get(w);if(w.depthTexture&&(w.depthTexture.dispose(),r.remove(w.depthTexture)),w.isWebGLCubeRenderTarget)for(let mt=0;mt<6;mt++){if(Array.isArray(b.__webglFramebuffer[mt]))for(let St=0;St<b.__webglFramebuffer[mt].length;St++)o.deleteFramebuffer(b.__webglFramebuffer[mt][St]);else o.deleteFramebuffer(b.__webglFramebuffer[mt]);b.__webglDepthbuffer&&o.deleteRenderbuffer(b.__webglDepthbuffer[mt])}else{if(Array.isArray(b.__webglFramebuffer))for(let mt=0;mt<b.__webglFramebuffer.length;mt++)o.deleteFramebuffer(b.__webglFramebuffer[mt]);else o.deleteFramebuffer(b.__webglFramebuffer);if(b.__webglDepthbuffer&&o.deleteRenderbuffer(b.__webglDepthbuffer),b.__webglMultisampledFramebuffer&&o.deleteFramebuffer(b.__webglMultisampledFramebuffer),b.__webglColorRenderbuffer)for(let mt=0;mt<b.__webglColorRenderbuffer.length;mt++)b.__webglColorRenderbuffer[mt]&&o.deleteRenderbuffer(b.__webglColorRenderbuffer[mt]);b.__webglDepthRenderbuffer&&o.deleteRenderbuffer(b.__webglDepthRenderbuffer)}const Q=w.textures;for(let mt=0,St=Q.length;mt<St;mt++){const ct=r.get(Q[mt]);ct.__webglTexture&&(o.deleteTexture(ct.__webglTexture),d.memory.textures--),r.remove(Q[mt])}r.remove(w)}let H=0;function j(){H=0}function rt(){const w=H;return w>=l.maxTextures&&fe("WebGLTextures: Trying to use "+w+" texture units while this GPU supports only "+l.maxTextures),H+=1,w}function lt(w){const b=[];return b.push(w.wrapS),b.push(w.wrapT),b.push(w.wrapR||0),b.push(w.magFilter),b.push(w.minFilter),b.push(w.anisotropy),b.push(w.internalFormat),b.push(w.format),b.push(w.type),b.push(w.generateMipmaps),b.push(w.premultiplyAlpha),b.push(w.flipY),b.push(w.unpackAlignment),b.push(w.colorSpace),b.join()}function st(w,b){const Q=r.get(w);if(w.isVideoTexture&&Le(w),w.isRenderTargetTexture===!1&&w.isExternalTexture!==!0&&w.version>0&&Q.__version!==w.version){const mt=w.image;if(mt===null)fe("WebGLRenderer: Texture marked for update but no image data found.");else if(mt.complete===!1)fe("WebGLRenderer: Texture marked for update but image is incomplete");else{it(Q,w,b);return}}else w.isExternalTexture&&(Q.__webglTexture=w.sourceTexture?w.sourceTexture:null);i.bindTexture(o.TEXTURE_2D,Q.__webglTexture,o.TEXTURE0+b)}function O(w,b){const Q=r.get(w);if(w.isRenderTargetTexture===!1&&w.version>0&&Q.__version!==w.version){it(Q,w,b);return}else w.isExternalTexture&&(Q.__webglTexture=w.sourceTexture?w.sourceTexture:null);i.bindTexture(o.TEXTURE_2D_ARRAY,Q.__webglTexture,o.TEXTURE0+b)}function V(w,b){const Q=r.get(w);if(w.isRenderTargetTexture===!1&&w.version>0&&Q.__version!==w.version){it(Q,w,b);return}i.bindTexture(o.TEXTURE_3D,Q.__webglTexture,o.TEXTURE0+b)}function W(w,b){const Q=r.get(w);if(w.version>0&&Q.__version!==w.version){ut(Q,w,b);return}i.bindTexture(o.TEXTURE_CUBE_MAP,Q.__webglTexture,o.TEXTURE0+b)}const pt={[Pd]:o.REPEAT,[la]:o.CLAMP_TO_EDGE,[zd]:o.MIRRORED_REPEAT},dt={[ni]:o.NEAREST,[zS]:o.NEAREST_MIPMAP_NEAREST,[Jl]:o.NEAREST_MIPMAP_LINEAR,[pi]:o.LINEAR,[Yf]:o.LINEAR_MIPMAP_NEAREST,[br]:o.LINEAR_MIPMAP_LINEAR},U={[GS]:o.NEVER,[YS]:o.ALWAYS,[VS]:o.LESS,[yg]:o.LEQUAL,[XS]:o.EQUAL,[qS]:o.GEQUAL,[kS]:o.GREATER,[WS]:o.NOTEQUAL};function et(w,b){if(b.type===ca&&e.has("OES_texture_float_linear")===!1&&(b.magFilter===pi||b.magFilter===Yf||b.magFilter===Jl||b.magFilter===br||b.minFilter===pi||b.minFilter===Yf||b.minFilter===Jl||b.minFilter===br)&&fe("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),o.texParameteri(w,o.TEXTURE_WRAP_S,pt[b.wrapS]),o.texParameteri(w,o.TEXTURE_WRAP_T,pt[b.wrapT]),(w===o.TEXTURE_3D||w===o.TEXTURE_2D_ARRAY)&&o.texParameteri(w,o.TEXTURE_WRAP_R,pt[b.wrapR]),o.texParameteri(w,o.TEXTURE_MAG_FILTER,dt[b.magFilter]),o.texParameteri(w,o.TEXTURE_MIN_FILTER,dt[b.minFilter]),b.compareFunction&&(o.texParameteri(w,o.TEXTURE_COMPARE_MODE,o.COMPARE_REF_TO_TEXTURE),o.texParameteri(w,o.TEXTURE_COMPARE_FUNC,U[b.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(b.magFilter===ni||b.minFilter!==Jl&&b.minFilter!==br||b.type===ca&&e.has("OES_texture_float_linear")===!1)return;if(b.anisotropy>1||r.get(b).__currentAnisotropy){const Q=e.get("EXT_texture_filter_anisotropic");o.texParameterf(w,Q.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(b.anisotropy,l.getMaxAnisotropy())),r.get(b).__currentAnisotropy=b.anisotropy}}}function vt(w,b){let Q=!1;w.__webglInit===void 0&&(w.__webglInit=!0,b.addEventListener("dispose",N));const mt=b.source;let St=S.get(mt);St===void 0&&(St={},S.set(mt,St));const ct=lt(b);if(ct!==w.__cacheKey){St[ct]===void 0&&(St[ct]={texture:o.createTexture(),usedTimes:0},d.memory.textures++,Q=!0),St[ct].usedTimes++;const qt=St[w.__cacheKey];qt!==void 0&&(St[w.__cacheKey].usedTimes--,qt.usedTimes===0&&C(b)),w.__cacheKey=ct,w.__webglTexture=St[ct].texture}return Q}function yt(w,b,Q){return Math.floor(Math.floor(w/Q)/b)}function Nt(w,b,Q,mt){const ct=w.updateRanges;if(ct.length===0)i.texSubImage2D(o.TEXTURE_2D,0,0,0,b.width,b.height,Q,mt,b.data);else{ct.sort((Mt,Et)=>Mt.start-Et.start);let qt=0;for(let Mt=1;Mt<ct.length;Mt++){const Et=ct[qt],Yt=ct[Mt],Vt=Et.start+Et.count,Ot=yt(Yt.start,b.width,4),ae=yt(Et.start,b.width,4);Yt.start<=Vt+1&&Ot===ae&&yt(Yt.start+Yt.count-1,b.width,4)===Ot?Et.count=Math.max(Et.count,Yt.start+Yt.count-Et.start):(++qt,ct[qt]=Yt)}ct.length=qt+1;const Ut=o.getParameter(o.UNPACK_ROW_LENGTH),Kt=o.getParameter(o.UNPACK_SKIP_PIXELS),kt=o.getParameter(o.UNPACK_SKIP_ROWS);o.pixelStorei(o.UNPACK_ROW_LENGTH,b.width);for(let Mt=0,Et=ct.length;Mt<Et;Mt++){const Yt=ct[Mt],Vt=Math.floor(Yt.start/4),Ot=Math.ceil(Yt.count/4),ae=Vt%b.width,G=Math.floor(Vt/b.width),Dt=Ot,At=1;o.pixelStorei(o.UNPACK_SKIP_PIXELS,ae),o.pixelStorei(o.UNPACK_SKIP_ROWS,G),i.texSubImage2D(o.TEXTURE_2D,0,ae,G,Dt,At,Q,mt,b.data)}w.clearUpdateRanges(),o.pixelStorei(o.UNPACK_ROW_LENGTH,Ut),o.pixelStorei(o.UNPACK_SKIP_PIXELS,Kt),o.pixelStorei(o.UNPACK_SKIP_ROWS,kt)}}function it(w,b,Q){let mt=o.TEXTURE_2D;(b.isDataArrayTexture||b.isCompressedArrayTexture)&&(mt=o.TEXTURE_2D_ARRAY),b.isData3DTexture&&(mt=o.TEXTURE_3D);const St=vt(w,b),ct=b.source;i.bindTexture(mt,w.__webglTexture,o.TEXTURE0+Q);const qt=r.get(ct);if(ct.version!==qt.__version||St===!0){i.activeTexture(o.TEXTURE0+Q);const Ut=Ue.getPrimaries(Ue.workingColorSpace),Kt=b.colorSpace===Wa?null:Ue.getPrimaries(b.colorSpace),kt=b.colorSpace===Wa||Ut===Kt?o.NONE:o.BROWSER_DEFAULT_WEBGL;o.pixelStorei(o.UNPACK_FLIP_Y_WEBGL,b.flipY),o.pixelStorei(o.UNPACK_PREMULTIPLY_ALPHA_WEBGL,b.premultiplyAlpha),o.pixelStorei(o.UNPACK_ALIGNMENT,b.unpackAlignment),o.pixelStorei(o.UNPACK_COLORSPACE_CONVERSION_WEBGL,kt);let Mt=D(b.image,!1,l.maxTextureSize);Mt=Wt(b,Mt);const Et=u.convert(b.format,b.colorSpace),Yt=u.convert(b.type);let Vt=L(b.internalFormat,Et,Yt,b.colorSpace,b.isVideoTexture);et(mt,b);let Ot;const ae=b.mipmaps,G=b.isVideoTexture!==!0,Dt=qt.__version===void 0||St===!0,At=ct.dataReady,Rt=k(b,Mt);if(b.isDepthTexture)Vt=F(b.format===Oo,b.type),Dt&&(G?i.texStorage2D(o.TEXTURE_2D,1,Vt,Mt.width,Mt.height):i.texImage2D(o.TEXTURE_2D,0,Vt,Mt.width,Mt.height,0,Et,Yt,null));else if(b.isDataTexture)if(ae.length>0){G&&Dt&&i.texStorage2D(o.TEXTURE_2D,Rt,Vt,ae[0].width,ae[0].height);for(let bt=0,_t=ae.length;bt<_t;bt++)Ot=ae[bt],G?At&&i.texSubImage2D(o.TEXTURE_2D,bt,0,0,Ot.width,Ot.height,Et,Yt,Ot.data):i.texImage2D(o.TEXTURE_2D,bt,Vt,Ot.width,Ot.height,0,Et,Yt,Ot.data);b.generateMipmaps=!1}else G?(Dt&&i.texStorage2D(o.TEXTURE_2D,Rt,Vt,Mt.width,Mt.height),At&&Nt(b,Mt,Et,Yt)):i.texImage2D(o.TEXTURE_2D,0,Vt,Mt.width,Mt.height,0,Et,Yt,Mt.data);else if(b.isCompressedTexture)if(b.isCompressedArrayTexture){G&&Dt&&i.texStorage3D(o.TEXTURE_2D_ARRAY,Rt,Vt,ae[0].width,ae[0].height,Mt.depth);for(let bt=0,_t=ae.length;bt<_t;bt++)if(Ot=ae[bt],b.format!==Ei)if(Et!==null)if(G){if(At)if(b.layerUpdates.size>0){const It=Hx(Ot.width,Ot.height,b.format,b.type);for(const se of b.layerUpdates){const Be=Ot.data.subarray(se*It/Ot.data.BYTES_PER_ELEMENT,(se+1)*It/Ot.data.BYTES_PER_ELEMENT);i.compressedTexSubImage3D(o.TEXTURE_2D_ARRAY,bt,0,0,se,Ot.width,Ot.height,1,Et,Be)}b.clearLayerUpdates()}else i.compressedTexSubImage3D(o.TEXTURE_2D_ARRAY,bt,0,0,0,Ot.width,Ot.height,Mt.depth,Et,Ot.data)}else i.compressedTexImage3D(o.TEXTURE_2D_ARRAY,bt,Vt,Ot.width,Ot.height,Mt.depth,0,Ot.data,0,0);else fe("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else G?At&&i.texSubImage3D(o.TEXTURE_2D_ARRAY,bt,0,0,0,Ot.width,Ot.height,Mt.depth,Et,Yt,Ot.data):i.texImage3D(o.TEXTURE_2D_ARRAY,bt,Vt,Ot.width,Ot.height,Mt.depth,0,Et,Yt,Ot.data)}else{G&&Dt&&i.texStorage2D(o.TEXTURE_2D,Rt,Vt,ae[0].width,ae[0].height);for(let bt=0,_t=ae.length;bt<_t;bt++)Ot=ae[bt],b.format!==Ei?Et!==null?G?At&&i.compressedTexSubImage2D(o.TEXTURE_2D,bt,0,0,Ot.width,Ot.height,Et,Ot.data):i.compressedTexImage2D(o.TEXTURE_2D,bt,Vt,Ot.width,Ot.height,0,Ot.data):fe("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):G?At&&i.texSubImage2D(o.TEXTURE_2D,bt,0,0,Ot.width,Ot.height,Et,Yt,Ot.data):i.texImage2D(o.TEXTURE_2D,bt,Vt,Ot.width,Ot.height,0,Et,Yt,Ot.data)}else if(b.isDataArrayTexture)if(G){if(Dt&&i.texStorage3D(o.TEXTURE_2D_ARRAY,Rt,Vt,Mt.width,Mt.height,Mt.depth),At)if(b.layerUpdates.size>0){const bt=Hx(Mt.width,Mt.height,b.format,b.type);for(const _t of b.layerUpdates){const It=Mt.data.subarray(_t*bt/Mt.data.BYTES_PER_ELEMENT,(_t+1)*bt/Mt.data.BYTES_PER_ELEMENT);i.texSubImage3D(o.TEXTURE_2D_ARRAY,0,0,0,_t,Mt.width,Mt.height,1,Et,Yt,It)}b.clearLayerUpdates()}else i.texSubImage3D(o.TEXTURE_2D_ARRAY,0,0,0,0,Mt.width,Mt.height,Mt.depth,Et,Yt,Mt.data)}else i.texImage3D(o.TEXTURE_2D_ARRAY,0,Vt,Mt.width,Mt.height,Mt.depth,0,Et,Yt,Mt.data);else if(b.isData3DTexture)G?(Dt&&i.texStorage3D(o.TEXTURE_3D,Rt,Vt,Mt.width,Mt.height,Mt.depth),At&&i.texSubImage3D(o.TEXTURE_3D,0,0,0,0,Mt.width,Mt.height,Mt.depth,Et,Yt,Mt.data)):i.texImage3D(o.TEXTURE_3D,0,Vt,Mt.width,Mt.height,Mt.depth,0,Et,Yt,Mt.data);else if(b.isFramebufferTexture){if(Dt)if(G)i.texStorage2D(o.TEXTURE_2D,Rt,Vt,Mt.width,Mt.height);else{let bt=Mt.width,_t=Mt.height;for(let It=0;It<Rt;It++)i.texImage2D(o.TEXTURE_2D,It,Vt,bt,_t,0,Et,Yt,null),bt>>=1,_t>>=1}}else if(ae.length>0){if(G&&Dt){const bt=ne(ae[0]);i.texStorage2D(o.TEXTURE_2D,Rt,Vt,bt.width,bt.height)}for(let bt=0,_t=ae.length;bt<_t;bt++)Ot=ae[bt],G?At&&i.texSubImage2D(o.TEXTURE_2D,bt,0,0,Et,Yt,Ot):i.texImage2D(o.TEXTURE_2D,bt,Vt,Et,Yt,Ot);b.generateMipmaps=!1}else if(G){if(Dt){const bt=ne(Mt);i.texStorage2D(o.TEXTURE_2D,Rt,Vt,bt.width,bt.height)}At&&i.texSubImage2D(o.TEXTURE_2D,0,0,0,Et,Yt,Mt)}else i.texImage2D(o.TEXTURE_2D,0,Vt,Et,Yt,Mt);y(b)&&_(mt),qt.__version=ct.version,b.onUpdate&&b.onUpdate(b)}w.__version=b.version}function ut(w,b,Q){if(b.image.length!==6)return;const mt=vt(w,b),St=b.source;i.bindTexture(o.TEXTURE_CUBE_MAP,w.__webglTexture,o.TEXTURE0+Q);const ct=r.get(St);if(St.version!==ct.__version||mt===!0){i.activeTexture(o.TEXTURE0+Q);const qt=Ue.getPrimaries(Ue.workingColorSpace),Ut=b.colorSpace===Wa?null:Ue.getPrimaries(b.colorSpace),Kt=b.colorSpace===Wa||qt===Ut?o.NONE:o.BROWSER_DEFAULT_WEBGL;o.pixelStorei(o.UNPACK_FLIP_Y_WEBGL,b.flipY),o.pixelStorei(o.UNPACK_PREMULTIPLY_ALPHA_WEBGL,b.premultiplyAlpha),o.pixelStorei(o.UNPACK_ALIGNMENT,b.unpackAlignment),o.pixelStorei(o.UNPACK_COLORSPACE_CONVERSION_WEBGL,Kt);const kt=b.isCompressedTexture||b.image[0].isCompressedTexture,Mt=b.image[0]&&b.image[0].isDataTexture,Et=[];for(let _t=0;_t<6;_t++)!kt&&!Mt?Et[_t]=D(b.image[_t],!0,l.maxCubemapSize):Et[_t]=Mt?b.image[_t].image:b.image[_t],Et[_t]=Wt(b,Et[_t]);const Yt=Et[0],Vt=u.convert(b.format,b.colorSpace),Ot=u.convert(b.type),ae=L(b.internalFormat,Vt,Ot,b.colorSpace),G=b.isVideoTexture!==!0,Dt=ct.__version===void 0||mt===!0,At=St.dataReady;let Rt=k(b,Yt);et(o.TEXTURE_CUBE_MAP,b);let bt;if(kt){G&&Dt&&i.texStorage2D(o.TEXTURE_CUBE_MAP,Rt,ae,Yt.width,Yt.height);for(let _t=0;_t<6;_t++){bt=Et[_t].mipmaps;for(let It=0;It<bt.length;It++){const se=bt[It];b.format!==Ei?Vt!==null?G?At&&i.compressedTexSubImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+_t,It,0,0,se.width,se.height,Vt,se.data):i.compressedTexImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+_t,It,ae,se.width,se.height,0,se.data):fe("WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):G?At&&i.texSubImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+_t,It,0,0,se.width,se.height,Vt,Ot,se.data):i.texImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+_t,It,ae,se.width,se.height,0,Vt,Ot,se.data)}}}else{if(bt=b.mipmaps,G&&Dt){bt.length>0&&Rt++;const _t=ne(Et[0]);i.texStorage2D(o.TEXTURE_CUBE_MAP,Rt,ae,_t.width,_t.height)}for(let _t=0;_t<6;_t++)if(Mt){G?At&&i.texSubImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+_t,0,0,0,Et[_t].width,Et[_t].height,Vt,Ot,Et[_t].data):i.texImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+_t,0,ae,Et[_t].width,Et[_t].height,0,Vt,Ot,Et[_t].data);for(let It=0;It<bt.length;It++){const Be=bt[It].image[_t].image;G?At&&i.texSubImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+_t,It+1,0,0,Be.width,Be.height,Vt,Ot,Be.data):i.texImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+_t,It+1,ae,Be.width,Be.height,0,Vt,Ot,Be.data)}}else{G?At&&i.texSubImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+_t,0,0,0,Vt,Ot,Et[_t]):i.texImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+_t,0,ae,Vt,Ot,Et[_t]);for(let It=0;It<bt.length;It++){const se=bt[It];G?At&&i.texSubImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+_t,It+1,0,0,Vt,Ot,se.image[_t]):i.texImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+_t,It+1,ae,Vt,Ot,se.image[_t])}}}y(b)&&_(o.TEXTURE_CUBE_MAP),ct.__version=St.version,b.onUpdate&&b.onUpdate(b)}w.__version=b.version}function Ct(w,b,Q,mt,St,ct){const qt=u.convert(Q.format,Q.colorSpace),Ut=u.convert(Q.type),Kt=L(Q.internalFormat,qt,Ut,Q.colorSpace),kt=r.get(b),Mt=r.get(Q);if(Mt.__renderTarget=b,!kt.__hasExternalTextures){const Et=Math.max(1,b.width>>ct),Yt=Math.max(1,b.height>>ct);St===o.TEXTURE_3D||St===o.TEXTURE_2D_ARRAY?i.texImage3D(St,ct,Kt,Et,Yt,b.depth,0,qt,Ut,null):i.texImage2D(St,ct,Kt,Et,Yt,0,qt,Ut,null)}i.bindFramebuffer(o.FRAMEBUFFER,w),Ft(b)?h.framebufferTexture2DMultisampleEXT(o.FRAMEBUFFER,mt,St,Mt.__webglTexture,0,Te(b)):(St===o.TEXTURE_2D||St>=o.TEXTURE_CUBE_MAP_POSITIVE_X&&St<=o.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&o.framebufferTexture2D(o.FRAMEBUFFER,mt,St,Mt.__webglTexture,ct),i.bindFramebuffer(o.FRAMEBUFFER,null)}function Pt(w,b,Q){if(o.bindRenderbuffer(o.RENDERBUFFER,w),b.depthBuffer){const mt=b.depthTexture,St=mt&&mt.isDepthTexture?mt.type:null,ct=F(b.stencilBuffer,St),qt=b.stencilBuffer?o.DEPTH_STENCIL_ATTACHMENT:o.DEPTH_ATTACHMENT,Ut=Te(b);Ft(b)?h.renderbufferStorageMultisampleEXT(o.RENDERBUFFER,Ut,ct,b.width,b.height):Q?o.renderbufferStorageMultisample(o.RENDERBUFFER,Ut,ct,b.width,b.height):o.renderbufferStorage(o.RENDERBUFFER,ct,b.width,b.height),o.framebufferRenderbuffer(o.FRAMEBUFFER,qt,o.RENDERBUFFER,w)}else{const mt=b.textures;for(let St=0;St<mt.length;St++){const ct=mt[St],qt=u.convert(ct.format,ct.colorSpace),Ut=u.convert(ct.type),Kt=L(ct.internalFormat,qt,Ut,ct.colorSpace),kt=Te(b);Q&&Ft(b)===!1?o.renderbufferStorageMultisample(o.RENDERBUFFER,kt,Kt,b.width,b.height):Ft(b)?h.renderbufferStorageMultisampleEXT(o.RENDERBUFFER,kt,Kt,b.width,b.height):o.renderbufferStorage(o.RENDERBUFFER,Kt,b.width,b.height)}}o.bindRenderbuffer(o.RENDERBUFFER,null)}function Ht(w,b){if(b&&b.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(i.bindFramebuffer(o.FRAMEBUFFER,w),!(b.depthTexture&&b.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const mt=r.get(b.depthTexture);mt.__renderTarget=b,(!mt.__webglTexture||b.depthTexture.image.width!==b.width||b.depthTexture.image.height!==b.height)&&(b.depthTexture.image.width=b.width,b.depthTexture.image.height=b.height,b.depthTexture.needsUpdate=!0),st(b.depthTexture,0);const St=mt.__webglTexture,ct=Te(b);if(b.depthTexture.format===No)Ft(b)?h.framebufferTexture2DMultisampleEXT(o.FRAMEBUFFER,o.DEPTH_ATTACHMENT,o.TEXTURE_2D,St,0,ct):o.framebufferTexture2D(o.FRAMEBUFFER,o.DEPTH_ATTACHMENT,o.TEXTURE_2D,St,0);else if(b.depthTexture.format===Oo)Ft(b)?h.framebufferTexture2DMultisampleEXT(o.FRAMEBUFFER,o.DEPTH_STENCIL_ATTACHMENT,o.TEXTURE_2D,St,0,ct):o.framebufferTexture2D(o.FRAMEBUFFER,o.DEPTH_STENCIL_ATTACHMENT,o.TEXTURE_2D,St,0);else throw new Error("Unknown depthTexture format")}function $t(w){const b=r.get(w),Q=w.isWebGLCubeRenderTarget===!0;if(b.__boundDepthTexture!==w.depthTexture){const mt=w.depthTexture;if(b.__depthDisposeCallback&&b.__depthDisposeCallback(),mt){const St=()=>{delete b.__boundDepthTexture,delete b.__depthDisposeCallback,mt.removeEventListener("dispose",St)};mt.addEventListener("dispose",St),b.__depthDisposeCallback=St}b.__boundDepthTexture=mt}if(w.depthTexture&&!b.__autoAllocateDepthBuffer){if(Q)throw new Error("target.depthTexture not supported in Cube render targets");const mt=w.texture.mipmaps;mt&&mt.length>0?Ht(b.__webglFramebuffer[0],w):Ht(b.__webglFramebuffer,w)}else if(Q){b.__webglDepthbuffer=[];for(let mt=0;mt<6;mt++)if(i.bindFramebuffer(o.FRAMEBUFFER,b.__webglFramebuffer[mt]),b.__webglDepthbuffer[mt]===void 0)b.__webglDepthbuffer[mt]=o.createRenderbuffer(),Pt(b.__webglDepthbuffer[mt],w,!1);else{const St=w.stencilBuffer?o.DEPTH_STENCIL_ATTACHMENT:o.DEPTH_ATTACHMENT,ct=b.__webglDepthbuffer[mt];o.bindRenderbuffer(o.RENDERBUFFER,ct),o.framebufferRenderbuffer(o.FRAMEBUFFER,St,o.RENDERBUFFER,ct)}}else{const mt=w.texture.mipmaps;if(mt&&mt.length>0?i.bindFramebuffer(o.FRAMEBUFFER,b.__webglFramebuffer[0]):i.bindFramebuffer(o.FRAMEBUFFER,b.__webglFramebuffer),b.__webglDepthbuffer===void 0)b.__webglDepthbuffer=o.createRenderbuffer(),Pt(b.__webglDepthbuffer,w,!1);else{const St=w.stencilBuffer?o.DEPTH_STENCIL_ATTACHMENT:o.DEPTH_ATTACHMENT,ct=b.__webglDepthbuffer;o.bindRenderbuffer(o.RENDERBUFFER,ct),o.framebufferRenderbuffer(o.FRAMEBUFFER,St,o.RENDERBUFFER,ct)}}i.bindFramebuffer(o.FRAMEBUFFER,null)}function Ze(w,b,Q){const mt=r.get(w);b!==void 0&&Ct(mt.__webglFramebuffer,w,w.texture,o.COLOR_ATTACHMENT0,o.TEXTURE_2D,0),Q!==void 0&&$t(w)}function oe(w){const b=w.texture,Q=r.get(w),mt=r.get(b);w.addEventListener("dispose",I);const St=w.textures,ct=w.isWebGLCubeRenderTarget===!0,qt=St.length>1;if(qt||(mt.__webglTexture===void 0&&(mt.__webglTexture=o.createTexture()),mt.__version=b.version,d.memory.textures++),ct){Q.__webglFramebuffer=[];for(let Ut=0;Ut<6;Ut++)if(b.mipmaps&&b.mipmaps.length>0){Q.__webglFramebuffer[Ut]=[];for(let Kt=0;Kt<b.mipmaps.length;Kt++)Q.__webglFramebuffer[Ut][Kt]=o.createFramebuffer()}else Q.__webglFramebuffer[Ut]=o.createFramebuffer()}else{if(b.mipmaps&&b.mipmaps.length>0){Q.__webglFramebuffer=[];for(let Ut=0;Ut<b.mipmaps.length;Ut++)Q.__webglFramebuffer[Ut]=o.createFramebuffer()}else Q.__webglFramebuffer=o.createFramebuffer();if(qt)for(let Ut=0,Kt=St.length;Ut<Kt;Ut++){const kt=r.get(St[Ut]);kt.__webglTexture===void 0&&(kt.__webglTexture=o.createTexture(),d.memory.textures++)}if(w.samples>0&&Ft(w)===!1){Q.__webglMultisampledFramebuffer=o.createFramebuffer(),Q.__webglColorRenderbuffer=[],i.bindFramebuffer(o.FRAMEBUFFER,Q.__webglMultisampledFramebuffer);for(let Ut=0;Ut<St.length;Ut++){const Kt=St[Ut];Q.__webglColorRenderbuffer[Ut]=o.createRenderbuffer(),o.bindRenderbuffer(o.RENDERBUFFER,Q.__webglColorRenderbuffer[Ut]);const kt=u.convert(Kt.format,Kt.colorSpace),Mt=u.convert(Kt.type),Et=L(Kt.internalFormat,kt,Mt,Kt.colorSpace,w.isXRRenderTarget===!0),Yt=Te(w);o.renderbufferStorageMultisample(o.RENDERBUFFER,Yt,Et,w.width,w.height),o.framebufferRenderbuffer(o.FRAMEBUFFER,o.COLOR_ATTACHMENT0+Ut,o.RENDERBUFFER,Q.__webglColorRenderbuffer[Ut])}o.bindRenderbuffer(o.RENDERBUFFER,null),w.depthBuffer&&(Q.__webglDepthRenderbuffer=o.createRenderbuffer(),Pt(Q.__webglDepthRenderbuffer,w,!0)),i.bindFramebuffer(o.FRAMEBUFFER,null)}}if(ct){i.bindTexture(o.TEXTURE_CUBE_MAP,mt.__webglTexture),et(o.TEXTURE_CUBE_MAP,b);for(let Ut=0;Ut<6;Ut++)if(b.mipmaps&&b.mipmaps.length>0)for(let Kt=0;Kt<b.mipmaps.length;Kt++)Ct(Q.__webglFramebuffer[Ut][Kt],w,b,o.COLOR_ATTACHMENT0,o.TEXTURE_CUBE_MAP_POSITIVE_X+Ut,Kt);else Ct(Q.__webglFramebuffer[Ut],w,b,o.COLOR_ATTACHMENT0,o.TEXTURE_CUBE_MAP_POSITIVE_X+Ut,0);y(b)&&_(o.TEXTURE_CUBE_MAP),i.unbindTexture()}else if(qt){for(let Ut=0,Kt=St.length;Ut<Kt;Ut++){const kt=St[Ut],Mt=r.get(kt);let Et=o.TEXTURE_2D;(w.isWebGL3DRenderTarget||w.isWebGLArrayRenderTarget)&&(Et=w.isWebGL3DRenderTarget?o.TEXTURE_3D:o.TEXTURE_2D_ARRAY),i.bindTexture(Et,Mt.__webglTexture),et(Et,kt),Ct(Q.__webglFramebuffer,w,kt,o.COLOR_ATTACHMENT0+Ut,Et,0),y(kt)&&_(Et)}i.unbindTexture()}else{let Ut=o.TEXTURE_2D;if((w.isWebGL3DRenderTarget||w.isWebGLArrayRenderTarget)&&(Ut=w.isWebGL3DRenderTarget?o.TEXTURE_3D:o.TEXTURE_2D_ARRAY),i.bindTexture(Ut,mt.__webglTexture),et(Ut,b),b.mipmaps&&b.mipmaps.length>0)for(let Kt=0;Kt<b.mipmaps.length;Kt++)Ct(Q.__webglFramebuffer[Kt],w,b,o.COLOR_ATTACHMENT0,Ut,Kt);else Ct(Q.__webglFramebuffer,w,b,o.COLOR_ATTACHMENT0,Ut,0);y(b)&&_(Ut),i.unbindTexture()}w.depthBuffer&&$t(w)}function _e(w){const b=w.textures;for(let Q=0,mt=b.length;Q<mt;Q++){const St=b[Q];if(y(St)){const ct=P(w),qt=r.get(St).__webglTexture;i.bindTexture(ct,qt),_(ct),i.unbindTexture()}}}const B=[],ie=[];function re(w){if(w.samples>0){if(Ft(w)===!1){const b=w.textures,Q=w.width,mt=w.height;let St=o.COLOR_BUFFER_BIT;const ct=w.stencilBuffer?o.DEPTH_STENCIL_ATTACHMENT:o.DEPTH_ATTACHMENT,qt=r.get(w),Ut=b.length>1;if(Ut)for(let kt=0;kt<b.length;kt++)i.bindFramebuffer(o.FRAMEBUFFER,qt.__webglMultisampledFramebuffer),o.framebufferRenderbuffer(o.FRAMEBUFFER,o.COLOR_ATTACHMENT0+kt,o.RENDERBUFFER,null),i.bindFramebuffer(o.FRAMEBUFFER,qt.__webglFramebuffer),o.framebufferTexture2D(o.DRAW_FRAMEBUFFER,o.COLOR_ATTACHMENT0+kt,o.TEXTURE_2D,null,0);i.bindFramebuffer(o.READ_FRAMEBUFFER,qt.__webglMultisampledFramebuffer);const Kt=w.texture.mipmaps;Kt&&Kt.length>0?i.bindFramebuffer(o.DRAW_FRAMEBUFFER,qt.__webglFramebuffer[0]):i.bindFramebuffer(o.DRAW_FRAMEBUFFER,qt.__webglFramebuffer);for(let kt=0;kt<b.length;kt++){if(w.resolveDepthBuffer&&(w.depthBuffer&&(St|=o.DEPTH_BUFFER_BIT),w.stencilBuffer&&w.resolveStencilBuffer&&(St|=o.STENCIL_BUFFER_BIT)),Ut){o.framebufferRenderbuffer(o.READ_FRAMEBUFFER,o.COLOR_ATTACHMENT0,o.RENDERBUFFER,qt.__webglColorRenderbuffer[kt]);const Mt=r.get(b[kt]).__webglTexture;o.framebufferTexture2D(o.DRAW_FRAMEBUFFER,o.COLOR_ATTACHMENT0,o.TEXTURE_2D,Mt,0)}o.blitFramebuffer(0,0,Q,mt,0,0,Q,mt,St,o.NEAREST),m===!0&&(B.length=0,ie.length=0,B.push(o.COLOR_ATTACHMENT0+kt),w.depthBuffer&&w.resolveDepthBuffer===!1&&(B.push(ct),ie.push(ct),o.invalidateFramebuffer(o.DRAW_FRAMEBUFFER,ie)),o.invalidateFramebuffer(o.READ_FRAMEBUFFER,B))}if(i.bindFramebuffer(o.READ_FRAMEBUFFER,null),i.bindFramebuffer(o.DRAW_FRAMEBUFFER,null),Ut)for(let kt=0;kt<b.length;kt++){i.bindFramebuffer(o.FRAMEBUFFER,qt.__webglMultisampledFramebuffer),o.framebufferRenderbuffer(o.FRAMEBUFFER,o.COLOR_ATTACHMENT0+kt,o.RENDERBUFFER,qt.__webglColorRenderbuffer[kt]);const Mt=r.get(b[kt]).__webglTexture;i.bindFramebuffer(o.FRAMEBUFFER,qt.__webglFramebuffer),o.framebufferTexture2D(o.DRAW_FRAMEBUFFER,o.COLOR_ATTACHMENT0+kt,o.TEXTURE_2D,Mt,0)}i.bindFramebuffer(o.DRAW_FRAMEBUFFER,qt.__webglMultisampledFramebuffer)}else if(w.depthBuffer&&w.resolveDepthBuffer===!1&&m){const b=w.stencilBuffer?o.DEPTH_STENCIL_ATTACHMENT:o.DEPTH_ATTACHMENT;o.invalidateFramebuffer(o.DRAW_FRAMEBUFFER,[b])}}}function Te(w){return Math.min(l.maxSamples,w.samples)}function Ft(w){const b=r.get(w);return w.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&b.__useRenderToTexture!==!1}function Le(w){const b=d.render.frame;v.get(w)!==b&&(v.set(w,b),w.update())}function Wt(w,b){const Q=w.colorSpace,mt=w.format,St=w.type;return w.isCompressedTexture===!0||w.isVideoTexture===!0||Q!==Es&&Q!==Wa&&(Ue.getTransfer(Q)===Xe?(mt!==Ei||St!==da)&&fe("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):rn("WebGLTextures: Unsupported texture color space:",Q)),b}function ne(w){return typeof HTMLImageElement<"u"&&w instanceof HTMLImageElement?(p.width=w.naturalWidth||w.width,p.height=w.naturalHeight||w.height):typeof VideoFrame<"u"&&w instanceof VideoFrame?(p.width=w.displayWidth,p.height=w.displayHeight):(p.width=w.width,p.height=w.height),p}this.allocateTextureUnit=rt,this.resetTextureUnits=j,this.setTexture2D=st,this.setTexture2DArray=O,this.setTexture3D=V,this.setTextureCube=W,this.rebindTextures=Ze,this.setupRenderTarget=oe,this.updateRenderTargetMipmap=_e,this.updateMultisampleRenderTarget=re,this.setupDepthRenderbuffer=$t,this.setupFrameBufferTexture=Ct,this.useMultisampledRTT=Ft}function oE(o,e){function i(r,l=Wa){let u;const d=Ue.getTransfer(l);if(r===da)return o.UNSIGNED_BYTE;if(r===gh)return o.UNSIGNED_SHORT_4_4_4_4;if(r===_h)return o.UNSIGNED_SHORT_5_5_5_1;if(r===xg)return o.UNSIGNED_INT_5_9_9_9_REV;if(r===gg)return o.UNSIGNED_INT_10F_11F_11F_REV;if(r===pg)return o.BYTE;if(r===mg)return o.SHORT;if(r===Uo)return o.UNSIGNED_SHORT;if(r===xh)return o.INT;if(r===Tr)return o.UNSIGNED_INT;if(r===ca)return o.FLOAT;if(r===As)return o.HALF_FLOAT;if(r===_g)return o.ALPHA;if(r===vg)return o.RGB;if(r===Ei)return o.RGBA;if(r===No)return o.DEPTH_COMPONENT;if(r===Oo)return o.DEPTH_STENCIL;if(r===Sg)return o.RED;if(r===vh)return o.RED_INTEGER;if(r===Sh)return o.RG;if(r===yh)return o.RG_INTEGER;if(r===Mh)return o.RGBA_INTEGER;if(r===yc||r===Mc||r===bc||r===Ec)if(d===Xe)if(u=e.get("WEBGL_compressed_texture_s3tc_srgb"),u!==null){if(r===yc)return u.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(r===Mc)return u.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(r===bc)return u.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(r===Ec)return u.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(u=e.get("WEBGL_compressed_texture_s3tc"),u!==null){if(r===yc)return u.COMPRESSED_RGB_S3TC_DXT1_EXT;if(r===Mc)return u.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(r===bc)return u.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(r===Ec)return u.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(r===Fd||r===Id||r===Bd||r===Hd)if(u=e.get("WEBGL_compressed_texture_pvrtc"),u!==null){if(r===Fd)return u.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(r===Id)return u.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(r===Bd)return u.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(r===Hd)return u.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(r===Gd||r===Vd||r===Xd)if(u=e.get("WEBGL_compressed_texture_etc"),u!==null){if(r===Gd||r===Vd)return d===Xe?u.COMPRESSED_SRGB8_ETC2:u.COMPRESSED_RGB8_ETC2;if(r===Xd)return d===Xe?u.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:u.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(r===kd||r===Wd||r===qd||r===Yd||r===jd||r===Zd||r===Kd||r===Qd||r===Jd||r===$d||r===th||r===eh||r===nh||r===ih)if(u=e.get("WEBGL_compressed_texture_astc"),u!==null){if(r===kd)return d===Xe?u.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:u.COMPRESSED_RGBA_ASTC_4x4_KHR;if(r===Wd)return d===Xe?u.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:u.COMPRESSED_RGBA_ASTC_5x4_KHR;if(r===qd)return d===Xe?u.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:u.COMPRESSED_RGBA_ASTC_5x5_KHR;if(r===Yd)return d===Xe?u.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:u.COMPRESSED_RGBA_ASTC_6x5_KHR;if(r===jd)return d===Xe?u.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:u.COMPRESSED_RGBA_ASTC_6x6_KHR;if(r===Zd)return d===Xe?u.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:u.COMPRESSED_RGBA_ASTC_8x5_KHR;if(r===Kd)return d===Xe?u.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:u.COMPRESSED_RGBA_ASTC_8x6_KHR;if(r===Qd)return d===Xe?u.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:u.COMPRESSED_RGBA_ASTC_8x8_KHR;if(r===Jd)return d===Xe?u.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:u.COMPRESSED_RGBA_ASTC_10x5_KHR;if(r===$d)return d===Xe?u.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:u.COMPRESSED_RGBA_ASTC_10x6_KHR;if(r===th)return d===Xe?u.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:u.COMPRESSED_RGBA_ASTC_10x8_KHR;if(r===eh)return d===Xe?u.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:u.COMPRESSED_RGBA_ASTC_10x10_KHR;if(r===nh)return d===Xe?u.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:u.COMPRESSED_RGBA_ASTC_12x10_KHR;if(r===ih)return d===Xe?u.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:u.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(r===ah||r===rh||r===sh)if(u=e.get("EXT_texture_compression_bptc"),u!==null){if(r===ah)return d===Xe?u.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:u.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(r===rh)return u.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(r===sh)return u.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(r===oh||r===lh||r===ch||r===uh)if(u=e.get("EXT_texture_compression_rgtc"),u!==null){if(r===oh)return u.COMPRESSED_RED_RGTC1_EXT;if(r===lh)return u.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(r===ch)return u.COMPRESSED_RED_GREEN_RGTC2_EXT;if(r===uh)return u.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return r===Lo?o.UNSIGNED_INT_24_8:o[r]!==void 0?o[r]:null}return{convert:i}}const lE=`
void main() {
...
`,SE=({analysis:o,capturedImage:e,active:i,growthTrigger:r,width:l,height:u})=>{const d=Oe.useRef(null),h=Oe.useRef(null),m=Oe.useRef(null),p=Oe.useRef(null),v=Oe.useRef(null),g=Oe.useRef(0),S=Oe.useRef(null),M=Oe.useRef(0),T=Oe.useRef(null),D=Oe.useRef(0),y=Oe.useRef(null),_=Oe.useRef(null),P=5e4,L=Oe.useRef(null),F=Oe.useRef(Date.now());Oe.useEffect(()=>{if(!e||!o||!i)return;(async()=>{const C=new Image;C.src=e,await new Promise(Ht=>{C.onload=Ht});const R=document.createElement("canvas");R.width=l,R.height=u;const H=R.getContext("2d");if(!H)return;const j=Math.max(l/C.width,u/C.height),rt=(l-C.width*j)/2,lt=(u-C.height*j)/2;H.drawImage(C,rt,lt,C.width*j,C.height*j);const st=o.box_2d;console.log("=== PlantGrowth Debug ==="),console.log("Original Box (0-1000):",st),console.log("Image size:",C.width,"x",C.height),console.log("Canvas size:",l,"x",u),console.log("Scale:",j),console.log("Offset:",rt,lt);const O=st[0]/1e3*C.height,V=st[1]/1e3*C.width,W=st[2]/1e3*C.height,pt=st[3]/1e3*C.width;console.log("Image pixels:",{imgYmin:O,imgXmin:V,imgYmax:W,imgXmax:pt});const dt=rt+V*j,U=lt+O*j,et=rt+pt*j,vt=lt+W*j;console.log("Canvas coords:",{cXmin:dt,cYmin:U,cXmax:et,cYmax:vt}),console.log("========================");const yt=Math.max(0,Math.floor(dt))|0,Nt=Math.max(0,Math.floor(U))|0,it=Math.min(l,Math.ceil(et))|0,ut=Math.min(u,Math.ceil(vt))|0,Ct=it-yt|0,Pt=ut-Nt|0;if(!(Ct<=0||Pt<=0))try{const Ht=H.getImageData(yt,Nt,Ct,Pt),$t=Ht.data,Ze=Ht.width,oe=[],_e=[],B=30;for(let ie=1;ie<Pt-1;ie+=2)for(let re=1;re<Ct-1;re+=2){const Te=(ie*Ze+re)*4,Ft=($t[Te]+$t[Te+1]+$t[Te+2])/3,Le=(ie*Ze+(re+1))*4,Wt=($t[Le]+$t[Le+1]+$t[Le+2])/3,ne=((ie+1)*Ze+re)*4,w=($t[ne]+$t[ne+1]+$t[ne+2])/3;if(Math.abs(Ft-Wt)+Math.abs(Ft-w)>B){const Q=yt+re,mt=Nt+ie,St=Q-l/2,ct=u/2-mt;oe.push(St,ct)}else if(Math.random()<.02){const Q=yt+re,mt=Nt+ie,St=Q-l/2,ct=u/2-mt;_e.push(St,ct)}}S.current=new Float32Array(oe),M.current=oe.length/2,T.current=new Float32Array(_e),D.current=_e.length/2}catch(Ht){console.error("Edge detection failed",Ht)}})()},[e,o,i,l,u]),Oe.useEffect(()=>{if(!d.current)return;const K=new yy,C=new zg(l/-2,l/2,u/2,u/-2,1,1e3);C.position.z=100;const R=new gE({alpha:!0,antialias:!1});R.setSize(l,u),R.setPixelRatio(Math.min(window.devicePixelRatio,2)),d.current.appendChild(R.domElement);const H=new Ni,j=new Float32Array(P*3),rt=new Float32Array(P*3),lt=new Float32Array(P).fill(0);H.setAttribute("position",new ii(j,3)),H.setAttribute("color",new ii(rt,3)),H.setAttribute("aType",new ii(lt,1));const st=new Li({uniforms:{uTime:{value:0}},vertexShader:_E,fragmentShader:vE,transparent:!0,blending:bd,depthTest:!1}),O=new Ry(H,st);return K.add(O),L.current={positions:j,colors:rt,types:lt,velocities:new Float32Array(P*3),life:new Float32Array(P),activeHeads:[]},m.current=K,p.current=C,v.current=R,y.current=H,_.current=st,I(),()=>{cancelAnimationFrame(g.current),d.current&&R.domElement&&d.current.removeChild(R.domElement),H.dispose(),st.dispose(),R.dispose()}},[l,u]),Oe.useEffect(()=>{r>0&&i&&k(40)},[r,i]);const k=K=>{if(!L.current)return;const{positions:C,colors:R,types:H,velocities:j,life:rt,activeHeads:lt}=L.current,st=S.current,O=M.current,V=T.current,W=D.current;if(!st&&!V)return;let pt=0;for(let dt=0;dt<P&&!(pt>=K);dt++)if(H[dt]===0){let U=0,et=0;if(W>0&&(Math.random()>.5||O===0)&&V){const yt=Math.floor(Math.random()*W);U=V[yt*2],et=V[yt*2+1]}else if(st&&O>0){const yt=Math.floor(Math.random()*O);U=st[yt*2],et=st[yt*2+1]}else continue;H[dt]=1,rt[dt]=1,C[dt*3]=U,C[dt*3+1]=et,C[dt*3+2]=0,j[dt*3]=(Math.random()-.5)*2,j[dt*3+1]=(Math.random()-.5)*2,R[dt*3]=0,R[dt*3+1]=1,R[dt*3+2]=.5,lt.push(dt),pt++}y.current&&(y.current.attributes.aType.needsUpdate=!0)},N=(K,C,R)=>{if(!L.current)return;const{positions:H,colors:j,types:rt,life:lt}=L.current,st=Math.floor(Math.random()*P);for(let O=0;O<50;O++){const V=(st+O)%P;if(rt[V]===0){rt[V]=R,H[V*3]=K,H[V*3+1]=C,H[V*3+2]=0,lt[V]=-1,R===2?(j[V*3]=0,j[V*3+1]=.5+Math.random()*.5,j[V*3+2]=.2):R===3&&(j[V*3]=1,j[V*3+1]=0+Math.random()*.2,j[V*3+2]=.8+Math.random()*.2);return}}},I=()=>{var O;if(!m.current||!L.current||!y.current||!_.current)return;const{positions:K,types:C,velocities:R,life:H,activeHeads:j}=L.current,rt=(Date.now()-F.current)/1e3;_.current.uniforms.uTime.value=rt;const lt=(O=h.current)==null?void 0:O.getContext("2d");lt&&(lt.clearRect(0,0,l,u),lt.strokeStyle="rgba(255, 255, 255, 0.4)",lt.fillStyle="#00FF00",lt.lineWidth=1,lt.font="10px monospace");const st=[];for(const V of j){if(C[V]!==1)continue;const W=K[V*3],pt=K[V*3+1];if(lt){const dt=W+l/2,U=u/2-pt;if(lt.strokeRect(dt-10,U-10,20,20),Math.random()>.8&&lt.fillText(Math.random().toFixed(3),dt+12,U-2),st.length>0&&Math.random()>.5){const et=st[st.length-1],vt=K[et*3]+l/2,yt=u/2-K[et*3+1];Math.abs(vt-dt)<100&&Math.abs(yt-U)<100&&(lt.beginPath(),lt.moveTo(dt,U),lt.lineTo(vt,yt),lt.stroke())}}K[V*3]+=R[V*3],K[V*3+1]+=R[V*3+1],Math.random()<.6&&N(W,pt,2),R[V*3]+=(Math.random()-.5)*.8,R[V*3+1]+=(Math.random()-.5)*.8,R[V*3]*=.92,R[V*3+1]*=.92,Math.random()<.03&&N(W+(Math.random()-.5)*15,pt+(Math.random()-.5)*15,3),H[V]-=.015,H[V]<=0?(C[V]=0,N(W,pt,3),N(W+5,pt+5,3)):st.push(V)}L.current.activeHeads=st,y.current.attributes.position.needsUpdate=!0,y.current.attributes.color.needsUpdate=!0,y.current.attributes.aType.needsUpdate=!0,v.current&&m.current&&p.current&&v.current.render(m.current,p.current),g.current=requestAnimationFrame(I)};return ue.jsxs(ue.Fragment,{children:[ue.jsx("div",{ref:d,className:"absolute inset-0 pointer-events-none z-10"}),ue.jsx("canvas",{ref:h,width:l,height:u,className:"absolute inset-0 pointer-events-none z-15 mix-blend-screen opacity-70"})]})},yE="https://royal-base-184.wufu104.workers.dev",ME=async o=>{try{const e=o.replace(/^data:image\/(png|jpeg|jpg);base64,/,""),i=await fetch(yE,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({image:e})});if(!i.ok)throw new Error(`Proxy error: ${i.status} ${i.statusText}`);return await i.json()}catch(e){return console.error("Gemini Analysis Error (using fallback bounding box):",e),{detected:!0,box_2d:[200,200,800,800],confidence:.5,label:"unknown_structure"}}},bE=()=>{const o=Oe.useRef(null),e=Oe.useRef(null),[i,r]=Oe.useState(an.IDLE),[l,u]=Oe.useState(null),[d,h]=Oe.useState(""),[m,p]=Oe.useState(null),[v,g]=Oe.useState({width:window.innerWidth,height:window.innerHeight}),[S,M]=Oe.useState(0);Oe.useEffect(()=>{const y=()=>g({width:window.innerWidth,height:window.innerHeight});return window.addEventListener("resize",y),()=>window.removeEventListener("resize",y)},[]),Oe.useEffect(()=>{(async()=>{try{const _=await navigator.mediaDevices.getUserMedia({video:{facingMode:"environment",width:{ideal:1920},height:{ideal:1080}},audio:!1});o.current&&(o.current.srcObject=_)}catch(_){console.error("Camera access denied:",_),h("CAMERA ERROR"),r(an.ERROR)}})()},[]);const T=Oe.useCallback(async()=>{if(i===an.IDLE){if(!o.current||!e.current)return;r(an.CAPTURING),h("");const y=o.current,_=e.current;_.width=y.videoWidth,_.height=y.videoHeight;const P=_.getContext("2d");if(!P)return;P.drawImage(y,0,0,_.width,_.height);const L=_.toDataURL("image/jpeg",.8);p(L),r(an.ANALYZING),h("VENI VIDI VICI QUID SUMUS");try{const F=await ME(L);console.log("=== API Response ==="),console.log("Detected:",F.detected),console.log("Box 2D:",F.box_2d),console.log("Confidence:",F.confidence),console.log("Label:",F.label),console.log("=================="),u(F),F.detected?(h(""),r(an.GROWING),M(k=>k+1)):(h("NO CONCRETE DETECTED."),r(an.GROWING),M(k=>k+1))}catch{h("OFFLINE MODE - USING LOCAL GROWTH"),r(an.GROWING),M(k=>k+1)}}else i===an.GROWING&&M(y=>y+1)},[i]),D=()=>{r(an.IDLE),p(null),u(null),M(0),h("")};return ue.jsxs("div",{className:"relative w-full h-screen bg-void-black overflow-hidden font-future select-none",children:[ue.jsx("canvas",{ref:e,className:"hidden"}),ue.jsx("video",{ref:o,autoPlay:!0,playsInline:!0,muted:!0,className:`absolute top-0 left-0 w-full h-full object-cover transition-opacity duration-700 ${m?"opacity-0":"opacity-100"}`,style:{filter:"contrast(1.1) brightness(1.1) saturate(0.8) sepia(0.2)"}}),m&&ue.jsx("img",{src:m,alt:"Frozen Reality",className:"absolute top-0 left-0 w-full h-full object-cover",style:{filter:"contrast(1.2) brightness(0.9) saturate(0.5) sepia(0.3) blur(0.5px)"}}),ue.jsx(SE,{active:i===an.GROWING,analysis:l,capturedImage:m,growthTrigger:S,width:v.width,height:v.height}),ue.jsx(rS,{gameState:i,onInteraction:T,onReset:D,analysisText:d,analysisResult:l}),ue.jsx("div",{className:"absolute inset-0 pointer-events-none bg-[radial-gradient(circle_at_center,transparent_40%,rgba(0,10,0,0.6)_100%)] mix-blend-multiply"}),ue.jsx("div",{className:"absolute inset-0 pointer-events-none opacity-20 bg-[url('https://grainy-gradients.vercel.app/noise.svg')] brightness-150 contrast-150"})]})},Vg=document.getElementById("root");if(!Vg)throw new Error("Could not find root element to mount to");const EE=aS.createRoot(Vg);EE.render(ue.jsx(Kv.StrictMode,{children:ue.jsx(bE,{})}));
