...
`)+`
`+_);const U=P+y+d,I=P+_+h,k=tg(l,l.VERTEX_SHADER,U),N=tg(l,l.FRAGMENT_SHADER,I);l.attachShader(D,k),l.attachShader(D,N),i.index0AttributeName!==void 0?l.bindAttribLocation(D,0,i.index0AttributeName):i.morphTargets===!0&&l.bindAttribLocation(D,0,"position"),l.linkProgram(D);function F(H){if(o.debug.checkShaderErrors){const j=l.getProgramInfoLog(D)||"",rt=l.getShaderInfoLog(k)||"",lt=l.getShaderInfoLog(N)||"",st=j.trim(),O=rt.trim(),V=lt.trim();let W=!0,pt=!0;if(l.getProgramParameter(D,l.LINK_STATUS)===!1)if(W=!1,typeof o.debug.onShaderError=="function")o.debug.onShaderError(l,D,k,N);else{const dt=ng(l,k,"vertex"),L=ng(l,N,"fragment");rn("THREE.WebGLProgram: Shader Error "+l.getError()+" - VALIDATE_STATUS "+l.getProgramParameter(D,l.VALIDATE_STATUS)+`
