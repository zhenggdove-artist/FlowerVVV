 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var sx;function Qv(){if(sx)return de;sx=1;var o=Symbol.for("react.transitional.element"),e=Symbol.for("react.portal"),i=Symbol.for("react.fragment"),r=Symbol.for("react.strict_mode"),l=Symbol.for("react.profiler"),u=Symbol.for("react.consumer"),d=Symbol.for("react.context"),h=Symbol.for("react.forward_ref"),m=Symbol.for("react.suspense"),p=Symbol.for("react.memo"),v=Symbol.for("react.lazy"),g=Symbol.for("react.activity"),S=Symbol.iterator;function y(D){return D===null||typeof D!="object"?null:(D=S&&D[S]||D["@@iterator"],typeof D=="function"?D:null)}var A={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},C=Object.assign,M={};function _(D,q,mt){this.props=D,this.context=q,this.refs=M,this.updater=mt||A}_.prototype.isReactComponent={},_.prototype.setState=function(D,q){if(typeof D!="object"&&typeof D!="function"&&D!=null)throw Error("takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,D,q,"setState")},_.prototype.forceUpdate=function(D){this.updater.enqueueForceUpdate(this,D,"forceUpdate")};function P(){}P.prototype=_.prototype;function L(D,q,mt){this.props=D,this.context=q,this.refs=M,this.updater=mt||A}var H=L.prototype=new P;H.constructor=L,C(H,_.prototype),H.isPureReactComponent=!0;var X=Array.isArray;function U(){}var z={H:null,A:null,T:null,S:null},Q=Object.prototype.hasOwnProperty;function w(D,q,mt){var ft=mt.ref;return{$$typeof:o,type:D,key:q,ref:ft!==void 0?ft:null,props:mt}}function T(D,q){return w(D.type,q,D.props)}function I(D){return typeof D=="object"&&D!==null&&D.$$typeof===o}function Y(D){var q={"=":"=0",":":"=2"};return"$"+D.replace(/[=:]/g,function(mt){return q[mt]})}var st=/\/+/g;function ct(D,q){return typeof D=="object"&&D!==null&&D.key!=null?Y(""+D.key):q.toString(36)}function rt(D){switch(D.status){case"fulfilled":return D.value;case"rejected":throw D.reason;default:switch(typeof D.status=="string"?D.then(U,U):(D.status="pending",D.then(function(q){D.status==="pending"&&(D.status="fulfilled",D.value=q)},function(q){D.status==="pending"&&(D.status="rejected",D.reason=q)})),D.status){case"fulfilled":return D.value;case"rejected":throw D.reason}}throw D}function O(D,q,mt,ft,Mt){var J=typeof D;(J==="undefined"||J==="boolean")&&(D=null);var dt=!1;if(D===null)dt=!0;else switch(J){case"bigint":case"string":case"number":dt=!0;break;case"object":switch(D.$$typeof){case o:case e:dt=!0;break;case v:return dt=D._init,O(dt(D._payload),q,mt,ft,Mt)}}if(dt)return Mt=Mt(D),dt=ft===""?"."+ct(D,0):ft,X(Mt)?(mt="",dt!=null&&(mt=dt.replace(st,"$&/")+"/"),O(Mt,q,mt,"",function(Nt){return Nt})):Mt!=null&&(I(Mt)&&(Mt=T(Mt,mt+(Mt.key==null||D&&D.key===Mt.key?"":(""+Mt.key).replace(st,"$&/")+"/")+dt)),q.push(Mt)),1;dt=0;var At=ft===""?".":ft+":";if(X(D))for(var Pt=0;Pt<D.length;Pt++)ft=D[Pt],J=At+ct(ft,Pt),dt+=O(ft,q,mt,J,Mt);else if(Pt=y(D),typeof Pt=="function")for(D=Pt.call(D),Pt=0;!(ft=D.next()).done;)ft=ft.value,J=At+ct(ft,Pt++),dt+=O(ft,q,mt,J,Mt);else if(J==="object"){if(typeof D.then=="function")return O(rt(D),q,mt,ft,Mt);throw q=String(D),Error("Objects are not valid as a React child (found: "+(q==="[object Object]"?"object with keys {"+Object.keys(D).join(", ")+"}":q)+"). If you meant to render a collection of children, use an array instead.")}return dt}function G(D,q,mt){if(D==null)return D;var ft=[],Mt=0;return O(D,ft,"","",function(J){return q.call(mt,J,Mt++)}),ft}function W(D){if(D._status===-1){var q=D._result;q=q(),q.then(function(mt){(D._status===0||D._status===-1)&&(D._status=1,D._result=mt)},function(mt){(D._status===0||D._status===-1)&&(D._status=2,D._result=mt)}),D._status===-1&&(D._status=0,D._result=q)}if(D._status===1)return D._result.default;throw D._result}var ut=typeof reportError=="function"?reportError:function(D){if(typeof window=="object"&&typeof window.ErrorEvent=="function"){var q=new window.ErrorEvent("error",{bubbles:!0,cancelable:!0,message:typeof D=="object"&&D!==null&&typeof D.message=="string"?String(D.message):String(D),error:D});if(!window.dispatchEvent(q))return}else if(typeof process=="object"&&typeof process.emit=="function"){process.emit("uncaughtException",D);return}console.error(D)},ot={map:G,forEach:function(D,q,mt){G(D,function(){q.apply(this,arguments)},mt)},count:function(D){var q=0;return G(D,function(){q++}),q},toArray:function(D){return G(D,function(q){return q})||[]},only:function(D){if(!I(D))throw Error("React.Children.only expected to receive a single React element child.");return D}};return de.Activity=g,de.Children=ot,de.Component=_,de.Fragment=i,de.Profiler=l,de.PureComponent=L,de.StrictMode=r,de.Suspense=m,de.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=z,de.__COMPILER_RUNTIME={__proto__:null,c:function(D){return z.H.useMemoCache(D)}},de.cache=function(D){return function(){return D.apply(null,arguments)}},de.cacheSignal=function(){return null},de.cloneElement=function(D,q,mt){if(D==null)throw Error("The argument must be a React element, but you passed "+D+".");var ft=C({},D.props),Mt=D.key;if(q!=null)for(J in q.key!==void 0&&(Mt=""+q.key),q)!Q.call(q,J)||J==="key"||J==="__self"||J==="__source"||J==="ref"&&q.ref===void 0||(ft[J]=q[J]);var J=arguments.length-2;if(J===1)ft.children=mt;else if(1<J){for(var dt=Array(J),At=0;At<J;At++)dt[At]=arguments[At+2];ft.children=dt}return w(D.type,Mt,ft)},de.createContext=function(D){return D={$$typeof:d,_currentValue:D,_currentValue2:D,_threadCount:0,Provider:null,Consumer:null},D.Provider=D,D.Consumer={$$typeof:u,_context:D},D},de.createElement=function(D,q,mt){var ft,Mt={},J=null;if(q!=null)for(ft in q.key!==void 0&&(J=""+q.key),q)Q.call(q,ft)&&ft!=="key"&&ft!=="__self"&&ft!=="__source"&&(Mt[ft]=q[ft]);var dt=arguments.length-2;if(dt===1)Mt.children=mt;else if(1<dt){for(var At=Array(dt),Pt=0;Pt<dt;Pt++)At[Pt]=arguments[Pt+2];Mt.children=At}if(D&&D.defaultProps)for(ft in dt=D.defaultProps,dt)Mt[ft]===void 0&&(Mt[ft]=dt[ft]);return w(D,J,Mt)},de.createRef=function(){return{current:null}},de.forwardRef=function(D){return{$$typeof:h,render:D}},de.isValidElement=I,de.lazy=function(D){return{$$typeof:v,_payload:{_status:-1,_result:D},_init:W}},de.memo=function(D,q){return{$$typeof:p,type:D,compare:q===void 0?null:q}},de.startTransition=function(D){var q=z.T,mt={};z.T=mt;try{var ft=D(),Mt=z.S;Mt!==null&&Mt(mt,ft),typeof ft=="object"&&ft!==null&&typeof ft.then=="function"&&ft.then(U,ut)}catch(J){ut(J)}finally{q!==null&&mt.types!==null&&(q.types=mt.types),z.T=q}},de.unstable_useCacheRefresh=function(){return z.H.useCacheRefresh()},de.use=function(D){return z.H.use(D)},de.useActionState=function(D,q,mt){return z.H.useActionState(D,q,mt)},de.useCallback=function(D,q){return z.H.useCallback(D,q)},de.useContext=function(D){return z.H.useContext(D)},de.useDebugValue=function(){},de.useDeferredValue=function(D,q){return z.H.useDeferredValue(D,q)},de.useEffect=function(D,q){return z.H.useEffect(D,q)},de.useEffectEvent=function(D){return z.H.useEffectEvent(D)},de.useId=function(){return z.H.useId()},de.useImperativeHandle=function(D,q,mt){return z.H.useImperativeHandle(D,q,mt)},de.useInsertionEffect=function(D,q){return z.H.useInsertionEffect(D,q)},de.useLayoutEffect=function(D,q){return z.H.useLayoutEffect(D,q)},de.useMemo=function(D,q){return z.H.useMemo(D,q)},de.useOptimistic=function(D,q){return z.H.useOptimistic(D,q)},de.useReducer=function(D,q,mt){return z.H.useReducer(D,q,mt)},de.useRef=function(D){return z.H.useRef(D)},de.useState=function(D){return z.H.useState(D)},de.useSyncExternalStore=function(D,q,mt){return z.H.useSyncExternalStore(D,q,mt)},de.useTransition=function(){return z.H.useTransition()},de.version="19.2.1",de}var ox;function ph(){return ox||(ox=1,Vf.exports=Qv()),Vf.exports}var Kt=ph();const Jv=dg(Kt);var kf={exports:{}},bo={},Xf={exports:{}},Wf={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var lx;function $v(){return lx||(lx=1,(function(o){function e(O,G){var W=O.length;O.push(G);t:for(;0<W;){var ut=W-1>>>1,ot=O[ut];if(0<l(ot,G))O[ut]=G,O[W]=ot,W=ut;else break t}}function i(O){return O.length===0?null:O[0]}function r(O){if(O.length===0)return null;var G=O[0],W=O.pop();if(W!==G){O[0]=W;t:for(var ut=0,ot=O.length,D=ot>>>1;ut<D;){var q=2*(ut+1)-1,mt=O[q],ft=q+1,Mt=O[ft];if(0>l(mt,W))ft<ot&&0>l(Mt,mt)?(O[ut]=Mt,O[ft]=W,ut=ft):(O[ut]=mt,O[q]=W,ut=q);else if(ft<ot&&0>l(Mt,W))O[ut]=Mt,O[ft]=W,ut=ft;else break t}}return G}function l(O,G){var W=O.sortIndex-G.sortIndex;return W!==0?W:O.id-G.id}if(o.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var u=performance;o.unstable_now=function(){return u.now()}}else{var d=Date,h=d.now();o.unstable_now=function(){return d.now()-h}}var m=[],p=[],v=1,g=null,S=3,y=!1,A=!1,C=!1,M=!1,_=typeof setTimeout=="function"?setTimeout:null,P=typeof clearTimeout=="function"?clearTimeout:null,L=typeof setImmediate<"u"?setImmediate:null;function H(O){for(var G=i(p);G!==null;){if(G.callback===null)r(p);else if(G.startTime<=O)r(p),G.sortIndex=G.expirationTime,e(m,G);else break;G=i(p)}}function X(O){if(C=!1,H(O),!A)if(i(m)!==null)A=!0,U||(U=!0,Y());else{var G=i(p);G!==null&&rt(X,G.startTime-O)}}var U=!1,z=-1,Q=5,w=-1;function T(){return M?!0:!(o.unstable_now()-w<Q)}function I(){if(M=!1,U){var O=o.unstable_now();w=O;var G=!0;try{t:{A=!1,C&&(C=!1,P(z),z=-1),y=!0;var W=S;try{e:{for(H(O),g=i(m);g!==null&&!(g.expirationTime>O&&T());){var ut=g.callback;if(typeof ut=="function"){g.callback=null,S=g.priorityLevel;var ot=ut(g.expirationTime<=O);if(O=o.unstable_now(),typeof ot=="function"){g.callback=ot,H(O),G=!0;break e}g===i(m)&&r(m),H(O)}else r(m);g=i(m)}if(g!==null)G=!0;else{var D=i(p);D!==null&&rt(X,D.startTime-O),G=!1}}break t}finally{g=null,S=W,y=!1}G=void 0}}finally{G?Y():U=!1}}}var Y;if(typeof L=="function")Y=function(){L(I)};else if(typeof MessageChannel<"u"){var st=new MessageChannel,ct=st.port2;st.port1.onmessage=I,Y=function(){ct.postMessage(null)}}else Y=function(){_(I,0)};function rt(O,G){z=_(function(){O(o.unstable_now())},G)}o.unstable_IdlePriority=5,o.unstable_ImmediatePriority=1,o.unstable_LowPriority=4,o.unstable_NormalPriority=3,o.unstable_Profiling=null,o.unstable_UserBlockingPriority=2,o.unstable_cancelCallback=function(O){O.callback=null},o.unstable_forceFrameRate=function(O){0>O||125<O?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):Q=0<O?Math.floor(1e3/O):5},o.unstable_getCurrentPriorityLevel=function(){return S},o.unstable_next=function(O){switch(S){case 1:case 2:case 3:var G=3;break;default:G=S}var W=S;S=G;try{return O()}finally{S=W}},o.unstable_requestPaint=function(){M=!0},o.unstable_runWithPriority=function(O,G){switch(O){case 1:case 2:case 3:case 4:case 5:break;default:O=3}var W=S;S=O;try{return G()}finally{S=W}},o.unstable_scheduleCallback=function(O,G,W){var ut=o.unstable_now();switch(typeof W=="object"&&W!==null?(W=W.delay,W=typeof W=="number"&&0<W?ut+W:ut):W=ut,O){case 1:var ot=-1;break;case 2:ot=250;break;case 5:ot=1073741823;break;case 4:ot=1e4;break;default:ot=5e3}return ot=W+ot,O={id:v++,callback:G,priorityLevel:O,startTime:W,expirationTime:ot,sortIndex:-1},W>ut?(O.sortIndex=W,e(p,O),i(m)===null&&O===i(p)&&(C?(P(z),z=-1):C=!0,rt(X,W-ut))):(O.sortIndex=ot,e(m,O),A||y||(A=!0,U||(U=!0,Y()))),O},o.unstable_shouldYield=T,o.unstable_wrapCallback=function(O){var G=S;return function(){var W=S;S=G;try{return O.apply(this,arguments)}finally{S=W}}}})(Wf)),Wf}var cx;function tS(){return cx||(cx=1,Xf.exports=$v()),Xf.exports}var qf={exports:{}},Dn={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var dx;function iS(){if(dx)return bo;dx=1;var o=tS(),e=ph(),i=nS();function r(t){var n="https://react.dev/errors/"+t;if(1<arguments.length){n+="?args[]="+encodeURIComponent(arguments[1]);for(var a=2;a<arguments.length;a++)n+="&args[]="+encodeURIComponent(arguments[a])}return"Minified React error #"+t+"; visit "+n+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}function l(t){return!(!t||t.nodeType!==1&&t.nodeType!==9&&t.nodeType!==11)}function u(t){var n=t,a=t;if(t.alternate)for(;n.return;)n=n.return;else{t=n;do n=t,(n.flags&4098)!==0&&(a=n.return),t=n.return;while(t)}return n.tag===3?a:null}function d(t){if(t.tag===13){var n=t.memoizedState;if(n===null&&(t=t.alternate,t!==null&&(n=t.memoizedState)),n!==null)return n.dehydrated}return null}function h(t){if(t.tag===31){var n=t.memoizedState;if(n===null&&(t=t.alternate,t!==null&&(n=t.memoizedState)),n!==null)return n.dehydrated}return null}function m(t){if(u(t)!==t)throw Error(r(188))}function p(t){var n=t.alternate;if(!n){if(n=u(t),n===null)throw Error(r(188));return n!==t?null:t}for(var a=t,s=n;;){var c=a.return;if(c===null)break;var f=c.alternate;if(f===null){if(s=c.return,s!==null){a=s;continue}break}if(c.child===f.child){for(f=c.child;f;){if(f===a)return m(c),t;if(f===s)return m(c),n;f=f.sibling}throw Error(r(188))}if(a.return!==s.return)a=c,s=f;else{for(var x=!1,E=c.child;E;){if(E===a){x=!0,a=c,s=f;break}if(E===s){x=!0,s=c,a=f;break}E=E.sibling}if(!x){for(E=f.child;E;){if(E===a){x=!0,a=f,s=c;break}if(E===s){x=!0,s=f,a=c;break}E=E.sibling}if(!x)throw Error(r(189))}}if(a.alternate!==s)throw Error(r(190))}if(a.tag!==3)throw Error(r(188));return a.stateNode.current===a?t:n}function v(t){var n=t.tag;if(n===5||n===26||n===27||n===6)return t;for(t=t.child;t!==null;){if(n=v(t),n!==null)return n;t=t.sibling}return null}var g=Object.assign,S=Symbol.for("react.element"),y=Symbol.for("react.transitional.element"),A=Symbol.for("react.portal"),C=Symbol.for("react.fragment"),M=Symbol.for("react.strict_mode"),_=Symbol.for("react.profiler"),P=Symbol.for("react.consumer"),L=Symbol.for("react.context"),H=Symbol.for("react.forward_ref"),X=Symbol.for("react.suspense"),U=Symbol.for("react.suspense_list"),z=Symbol.for("react.memo"),Q=Symbol.for("react.lazy"),w=Symbol.for("react.activity"),T=Symbol.for("react.memo_cache_sentinel"),I=Symbol.iterator;function Y(t){return t===null||typeof t!="object"?null:(t=I&&t[I]||t["@@iterator"],typeof t=="function"?t:null)}var st=Symbol.for("react.client.reference");function ct(t){if(t==null)return null;if(typeof t=="function")return t.$$typeof===st?null:t.displayName||t.name||null;if(typeof t=="string")return t;switch(t){case C:return"Fragment";case _:return"Profiler";case M:return"StrictMode";case X:return"Suspense";case U:return"SuspenseList";case w:return"Activity"}if(typeof t=="object")switch(t.$$typeof){case A:return"Portal";case L:return t.displayName||"Context";case P:return(t._context.displayName||"Context")+".Consumer";case H:var n=t.render;return t=t.displayName,t||(t=n.displayName||n.name||"",t=t!==""?"ForwardRef("+t+")":"ForwardRef"),t;case z:return n=t.displayName||null,n!==null?n:ct(t.type)||"Memo";case Q:n=t._payload,t=t._init;try{return ct(t(n))}catch{}}return null}var rt=Array.isArray,O=e.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE,G=i.__DOM_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE,W={pending:!1,data:null,method:null,action:null},ut=[],ot=-1;function D(t){return{current:t}}function q(t){0>ot||(t.current=ut[ot],ut[ot]=null,ot--)}function mt(t,n){ot++,ut[ot]=t.current,t.current=n}var ft=D(null),Mt=D(null),J=D(null),dt=D(null);function At(t,n){switch(mt(J,n),mt(Mt,t),mt(ft,null),n.nodeType){case 9:case 11:t=(t=n.documentElement)&&(t=t.namespaceURI)?Rm(t):0;break;default:if(t=n.tagName,n=n.namespaceURI)n=Rm(n),t=Cm(n,t);else switch(t){case"svg":t=1;break;case"math":t=2;break;default:t=0}}q(ft),mt(ft,t)}function Pt(){q(ft),q(Mt),q(J)}function Nt(t){t.memoizedState!==null&&mt(dt,t);var n=ft.current,a=Cm(n,t.type);n!==a&&(mt(Mt,t),mt(ft,a))}function ee(t){Mt.current===t&&(q(ft),q(Mt)),dt.current===t&&(q(dt),_o._currentValue=W)}var Ce,ne;function fe(t){if(Ce===void 0)try{throw Error()}catch(a){var n=a.stack.trim().match(/\n( *(at )?)/);Ce=n&&n[1]||"",ne=-1<a.stack.indexOf(`
    at`)?" (<anonymous>)":-1<a.stack.indexOf("@")?"@unknown:0:0":""}return`
`+Ce+t+ne}var F=!1;function Qt(t,n){if(!t||F)return"";F=!0;var a=Error.prepareStackTrace;Error.prepareStackTrace=void 0;try{var s={DetermineComponentFrameRoot:function(){try{if(n){var vt=function(){throw Error()};if(Object.defineProperty(vt.prototype,"props",{set:function(){throw Error()}}),typeof Reflect=="object"&&Reflect.construct){try{Reflect.construct(vt,[])}catch(ht){var it=ht}Reflect.construct(t,[],vt)}else{try{vt.call()}catch(ht){it=ht}t.call(vt.prototype)}}else{try{throw Error()}catch(ht){it=ht}(vt=t())&&typeof vt.catch=="function"&&vt.catch(function(){})}}catch(ht){if(ht&&it&&typeof ht.stack=="string")return[ht.stack,it.stack]}return[null,null]}};s.DetermineComponentFrameRoot.displayName="DetermineComponentFrameRoot";var c=Object.getOwnPropertyDescriptor(s.DetermineComponentFrameRoot,"name");c&&c.configurable&&Object.defineProperty(s.DetermineComponentFrameRoot,"name",{value:"DetermineComponentFrameRoot"});var f=s.DetermineComponentFrameRoot(),x=f[0],E=f[1];if(x&&E){var B=x.split(`
`),et=E.split(`
...
`)+`
`+_);const L=P+M+d,H=P+_+h,X=tg(l,l.VERTEX_SHADER,L),U=tg(l,l.FRAGMENT_SHADER,H);l.attachShader(C,X),l.attachShader(C,U),i.index0AttributeName!==void 0?l.bindAttribLocation(C,0,i.index0AttributeName):i.morphTargets===!0&&l.bindAttribLocation(C,0,"position"),l.linkProgram(C);function z(I){if(o.debug.checkShaderErrors){const Y=l.getProgramInfoLog(C)||"",st=l.getShaderInfoLog(X)||"",ct=l.getShaderInfoLog(U)||"",rt=Y.trim(),O=st.trim(),G=ct.trim();let W=!0,ut=!0;if(l.getProgramParameter(C,l.LINK_STATUS)===!1)if(W=!1,typeof o.debug.onShaderError=="function")o.debug.onShaderError(l,C,X,U);else{const ot=ng(l,X,"vertex"),D=ng(l,U,"fragment");rn("THREE.WebGLProgram: Shader Error "+l.getError()+" - VALIDATE_STATUS "+l.getProgramParameter(C,l.VALIDATE_STATUS)+`
...
}`;function rE(o,e,i){let r=new Pg;const l=new We,u=new We,d=new sn,h=new DM({depthPacking:HS}),m=new UM,p={},v=i.maxTextureSize,g={[ja]:kn,[kn]:ja,[oa]:oa},S=new Li({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new We},radius:{value:4}},vertexShader:iE,fragmentShader:aE}),y=S.clone();y.defines.HORIZONTAL_PASS=1;const A=new Ni;A.setAttribute("position",new ii(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const C=new Za(A,S),M=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=hg;let _=this.type;this.render=function(U,z,Q){if(M.enabled===!1||M.autoUpdate===!1&&M.needsUpdate===!1||U.length===0)return;const w=o.getRenderTarget(),T=o.getActiveCubeFace(),I=o.getActiveMipmapLevel(),Y=o.state;Y.setBlending(ua),Y.buffers.depth.getReversed()===!0?Y.buffers.color.setClear(0,0,0,0):Y.buffers.color.setClear(1,1,1,1),Y.buffers.depth.setTest(!0),Y.setScissorTest(!1);const st=_!==sa&&this.type===sa,ct=_===sa&&this.type!==sa;for(let rt=0,O=U.length;rt<O;rt++){const G=U[rt],W=G.shadow;if(W===void 0){pe("WebGLShadowMap:",G,"has no shadow.");continue}if(W.autoUpdate===!1&&W.needsUpdate===!1)continue;l.copy(W.mapSize);const ut=W.getFrameExtents();if(l.multiply(ut),u.copy(W.mapSize),(l.x>v||l.y>v)&&(l.x>v&&(u.x=Math.floor(v/ut.x),l.x=u.x*ut.x,W.mapSize.x=u.x),l.y>v&&(u.y=Math.floor(v/ut.y),l.y=u.y*ut.y,W.mapSize.y=u.y)),W.map===null||st===!0||ct===!0){const D=this.type!==sa?{minFilter:ni,magFilter:ni}:{};W.map!==null&&W.map.dispose(),W.map=new Ar(l.x,l.y,D),W.map.texture.name=G.name+".shadowMap",W.camera.updateProjectionMatrix()}o.setRenderTarget(W.map),o.clear();const ot=W.getViewportCount();for(let D=0;D<ot;D++){const q=W.getViewport(D);d.set(u.x*q.x,u.y*q.y,u.x*q.z,u.y*q.w),Y.viewport(d),W.updateMatrices(G,D),r=W.getFrustum(),H(z,Q,W.camera,G,this.type)}W.isPointLightShadow!==!0&&this.type===sa&&P(W,Q),W.needsUpdate=!1}_=this.type,M.needsUpdate=!1,o.setRenderTarget(w,T,I)};function P(U,z){const Q=e.update(C);S.defines.VSM_SAMPLES!==U.blurSamples&&(S.defines.VSM_SAMPLES=U.blurSamples,y.defines.VSM_SAMPLES=U.blurSamples,S.needsUpdate=!0,y.needsUpdate=!0),U.mapPass===null&&(U.mapPass=new Ar(l.x,l.y)),S.uniforms.shadow_pass.value=U.map.texture,S.uniforms.resolution.value=U.mapSize,S.uniforms.radius.value=U.radius,o.setRenderTarget(U.mapPass),o.clear(),o.renderBufferDirect(z,null,Q,S,C,null),y.uniforms.shadow_pass.value=U.mapPass.texture,y.uniforms.resolution.value=U.mapSize,y.uniforms.radius.value=U.radius,o.setRenderTarget(U.map),o.clear(),o.renderBufferDirect(z,null,Q,y,C,null)}function L(U,z,Q,w){let T=null;const I=Q.isPointLight===!0?U.customDistanceMaterial:U.customDepthMaterial;if(I!==void 0)T=I;else if(T=Q.isPointLight===!0?m:h,o.localClippingEnabled&&z.clipShadows===!0&&Array.isArray(z.clippingPlanes)&&z.clippingPlanes.length!==0||z.displacementMap&&z.displacementScale!==0||z.alphaMap&&z.alphaTest>0||z.map&&z.alphaTest>0||z.alphaToCoverage===!0){const Y=T.uuid,st=z.uuid;let ct=p[Y];ct===void 0&&(ct={},p[Y]=ct);let rt=ct[st];rt===void 0&&(rt=T.clone(),ct[st]=rt,z.addEventListener("dispose",X)),T=rt}if(T.visible=z.visible,T.wireframe=z.wireframe,w===sa?T.side=z.shadowSide!==null?z.shadowSide:z.side:T.side=z.shadowSide!==null?z.shadowSide:g[z.side],T.alphaMap=z.alphaMap,T.alphaTest=z.alphaToCoverage===!0?.5:z.alphaTest,T.map=z.map,T.clipShadows=z.clipShadows,T.clippingPlanes=z.clippingPlanes,T.clipIntersection=z.clipIntersection,T.displacementMap=z.displacementMap,T.displacementScale=z.displacementScale,T.displacementBias=z.displacementBias,T.wireframeLinewidth=z.wireframeLinewidth,T.linewidth=z.linewidth,Q.isPointLight===!0&&T.isMeshDistanceMaterial===!0){const Y=o.properties.get(T);Y.light=Q}return T}function H(U,z,Q,w,T){if(U.visible===!1)return;if(U.layers.test(z.layers)&&(U.isMesh||U.isLine||U.isPoints)&&(U.castShadow||U.receiveShadow&&T===sa)&&(!U.frustumCulled||r.intersectsObject(U))){U.modelViewMatrix.multiplyMatrices(Q.matrixWorldInverse,U.matrixWorld);const st=e.update(U),ct=U.material;if(Array.isArray(ct)){const rt=st.groups;for(let O=0,G=rt.length;O<G;O++){const W=rt[O],ut=ct[W.materialIndex];if(ut&&ut.visible){const ot=L(U,ut,w,T);U.onBeforeShadow(o,U,z,Q,st,ot,W),o.renderBufferDirect(Q,null,st,ot,U,W),U.onAfterShadow(o,U,z,Q,st,ot,W)}}}else if(ct.visible){const rt=L(U,ct,w,T);U.onBeforeShadow(o,U,z,Q,st,rt,null),o.renderBufferDirect(Q,null,st,rt,U,null),U.onAfterShadow(o,U,z,Q,st,rt,null)}}const Y=U.children;for(let st=0,ct=Y.length;st<ct;st++)H(Y[st],z,Q,w,T)}function X(U){U.target.removeEventListener("dispose",X);for(const Q in p){const w=p[Q],T=U.target.uuid;T in w&&(w[T].dispose(),delete w[T])}}}const sE={[Ad]:Rd,[Cd]:Ud,[wd]:Ld,[Ms]:Dd,[Rd]:Ad,[Ud]:Cd,[Ld]:wd,[Dd]:Ms};function oE(o,e){function i(){let V=!1;const Lt=new sn;let Ct=null;const wt=new sn(0,0,0,0);return{setMask:function(Et){Ct!==Et&&!V&&(o.colorMask(Et,Et,Et,Et),Ct=Et)},setLocked:function(Et){V=Et},setClear:function(Et,St,Gt,ue,He){He===!0&&(Et*=ue,St*=ue,Gt*=ue),Lt.set(Et,St,Gt,ue),wt.equals(Lt)===!1&&(o.clearColor(Et,St,Gt,ue),wt.copy(Lt))},reset:function(){V=!1,Ct=null,wt.set(-1,0,0,0)}}}function r(){let V=!1,Lt=!1,Ct=null,wt=null,Et=null;return{setReversed:function(St){if(Lt!==St){const Gt=e.get("EXT_clip_control");St?Gt.clipControlEXT(Gt.LOWER_LEFT_EXT,Gt.ZERO_TO_ONE_EXT):Gt.clipControlEXT(Gt.LOWER_LEFT_EXT,Gt.NEGATIVE_ONE_TO_ONE_EXT),Lt=St;const ue=Et;Et=null,this.setClear(ue)}},getReversed:function(){return Lt},setTest:function(St){St?dt(o.DEPTH_TEST):At(o.DEPTH_TEST)},setMask:function(St){Ct!==St&&!V&&(o.depthMask(St),Ct=St)},setFunc:function(St){if(Lt&&(St=sE[St]),wt!==St){switch(St){case Ad:o.depthFunc(o.NEVER);break;case Rd:o.depthFunc(o.ALWAYS);break;case Cd:o.depthFunc(o.LESS);break;case Ms:o.depthFunc(o.LEQUAL);break;case wd:o.depthFunc(o.EQUAL);break;case Dd:o.depthFunc(o.GEQUAL);break;case Ud:o.depthFunc(o.GREATER);break;case Ld:o.depthFunc(o.NOTEQUAL);break;default:o.depthFunc(o.LEQUAL)}wt=St}},setLocked:function(St){V=St},setClear:function(St){Et!==St&&(Lt&&(St=1-St),o.clearDepth(St),Et=St)},reset:function(){V=!1,Ct=null,wt=null,Et=null,Lt=!1}}}function l(){let V=!1,Lt=null,Ct=null,wt=null,Et=null,St=null,Gt=null,ue=null,He=null;return{setTest:function(De){V||(De?dt(o.STENCIL_TEST):At(o.STENCIL_TEST))},setMask:function(De){Lt!==De&&!V&&(o.stencilMask(De),Lt=De)},setFunc:function(De,wn,Wn){(Ct!==De||wt!==wn||Et!==Wn)&&(o.stencilFunc(De,wn,Wn),Ct=De,wt=wn,Et=Wn)},setOp:function(De,wn,Wn){(St!==De||Gt!==wn||ue!==Wn)&&(o.stencilOp(De,wn,Wn),St=De,Gt=wn,ue=Wn)},setLocked:function(De){V=De},setClear:function(De){He!==De&&(o.clearStencil(De),He=De)},reset:function(){V=!1,Lt=null,Ct=null,wt=null,Et=null,St=null,Gt=null,ue=null,He=null}}}const u=new i,d=new r,h=new l,m=new WeakMap,p=new WeakMap;let v={},g={},S=new WeakMap,y=[],A=null,C=!1,M=null,_=null,P=null,L=null,H=null,X=null,U=null,z=new Be(0,0,0),Q=0,w=!1,T=null,I=null,Y=null,st=null,ct=null;const rt=o.getParameter(o.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let O=!1,G=0;const W=o.getParameter(o.VERSION);W.indexOf("WebGL")!==-1?(G=parseFloat(/^WebGL (\d)/.exec(W)[1]),O=G>=1):W.indexOf("OpenGL ES")!==-1&&(G=parseFloat(/^OpenGL ES (\d)/.exec(W)[1]),O=G>=2);let ut=null,ot={};const D=o.getParameter(o.SCISSOR_BOX),q=o.getParameter(o.VIEWPORT),mt=new sn().fromArray(D),ft=new sn().fromArray(q);function Mt(V,Lt,Ct,wt){const Et=new Uint8Array(4),St=o.createTexture();o.bindTexture(V,St),o.texParameteri(V,o.TEXTURE_MIN_FILTER,o.NEAREST),o.texParameteri(V,o.TEXTURE_MAG_FILTER,o.NEAREST);for(let Gt=0;Gt<Ct;Gt++)V===o.TEXTURE_3D||V===o.TEXTURE_2D_ARRAY?o.texImage3D(Lt,0,o.RGBA,1,1,wt,0,o.RGBA,o.UNSIGNED_BYTE,Et):o.texImage2D(Lt+Gt,0,o.RGBA,1,1,0,o.RGBA,o.UNSIGNED_BYTE,Et);return St}const J={};J[o.TEXTURE_2D]=Mt(o.TEXTURE_2D,o.TEXTURE_2D,1),J[o.TEXTURE_CUBE_MAP]=Mt(o.TEXTURE_CUBE_MAP,o.TEXTURE_CUBE_MAP_POSITIVE_X,6),J[o.TEXTURE_2D_ARRAY]=Mt(o.TEXTURE_2D_ARRAY,o.TEXTURE_2D_ARRAY,1,1),J[o.TEXTURE_3D]=Mt(o.TEXTURE_3D,o.TEXTURE_3D,1,1),u.setClear(0,0,0,1),d.setClear(1),h.setClear(0),dt(o.DEPTH_TEST),d.setFunc(Ms),Qt(!1),It(px),dt(o.CULL_FACE),fe(ua);function dt(V){v[V]!==!0&&(o.enable(V),v[V]=!0)}function At(V){v[V]!==!1&&(o.disable(V),v[V]=!1)}function Pt(V,Lt){return g[V]!==Lt?(o.bindFramebuffer(V,Lt),g[V]=Lt,V===o.DRAW_FRAMEBUFFER&&(g[o.FRAMEBUFFER]=Lt),V===o.FRAMEBUFFER&&(g[o.DRAW_FRAMEBUFFER]=Lt),!0):!1}function Nt(V,Lt){let Ct=y,wt=!1;if(V){Ct=S.get(Lt),Ct===void 0&&(Ct=[],S.set(Lt,Ct));const Et=V.textures;if(Ct.length!==Et.length||Ct[0]!==o.COLOR_ATTACHMENT0){for(let St=0,Gt=Et.length;St<Gt;St++)Ct[St]=o.COLOR_ATTACHMENT0+St;Ct.length=Et.length,wt=!0}}else Ct[0]!==o.BACK&&(Ct[0]=o.BACK,wt=!0);wt&&o.drawBuffers(Ct)}function ee(V){return A!==V?(o.useProgram(V),A=V,!0):!1}const Ce={[Mr]:o.FUNC_ADD,[dS]:o.FUNC_SUBTRACT,[hS]:o.FUNC_REVERSE_SUBTRACT};Ce[pS]=o.MIN,Ce[mS]=o.MAX;const ne={[xS]:o.ZERO,[gS]:o.ONE,[_S]:o.SRC_COLOR,[Ed]:o.SRC_ALPHA,[ES]:o.SRC_ALPHA_SATURATE,[yS]:o.DST_COLOR,[SS]:o.DST_ALPHA,[vS]:o.ONE_MINUS_SRC_COLOR,[Td]:o.ONE_MINUS_SRC_ALPHA,[bS]:o.ONE_MINUS_DST_COLOR,[MS]:o.ONE_MINUS_DST_ALPHA,[TS]:o.CONSTANT_COLOR,[AS]:o.ONE_MINUS_CONSTANT_COLOR,[RS]:o.CONSTANT_ALPHA,[CS]:o.ONE_MINUS_CONSTANT_ALPHA};function fe(V,Lt,Ct,wt,Et,St,Gt,ue,He,De){if(V===ua){C===!0&&(At(o.BLEND),C=!1);return}if(C===!1&&(dt(o.BLEND),C=!0),V!==fS){if(V!==M||De!==w){if((_!==Mr||H!==Mr)&&(o.blendEquation(o.FUNC_ADD),_=Mr,H=Mr),De)switch(V){case vs:o.blendFuncSeparate(o.ONE,o.ONE_MINUS_SRC_ALPHA,o.ONE,o.ONE_MINUS_SRC_ALPHA);break;case bd:o.blendFunc(o.ONE,o.ONE);break;case mx:o.blendFuncSeparate(o.ZERO,o.ONE_MINUS_SRC_COLOR,o.ZERO,o.ONE);break;case xx:o.blendFuncSeparate(o.DST_COLOR,o.ONE_MINUS_SRC_ALPHA,o.ZERO,o.ONE);break;default:rn("WebGLState: Invalid blending: ",V);break}else switch(V){case vs:o.blendFuncSeparate(o.SRC_ALPHA,o.ONE_MINUS_SRC_ALPHA,o.ONE,o.ONE_MINUS_SRC_ALPHA);break;case bd:o.blendFuncSeparate(o.SRC_ALPHA,o.ONE,o.ONE,o.ONE);break;case mx:rn("WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case xx:rn("WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:rn("WebGLState: Invalid blending: ",V);break}P=null,L=null,X=null,U=null,z.set(0,0,0),Q=0,M=V,w=De}return}Et=Et||Lt,St=St||Ct,Gt=Gt||wt,(Lt!==_||Et!==H)&&(o.blendEquationSeparate(Ce[Lt],Ce[Et]),_=Lt,H=Et),(Ct!==P||wt!==L||St!==X||Gt!==U)&&(o.blendFuncSeparate(ne[Ct],ne[wt],ne[St],ne[Gt]),P=Ct,L=wt,X=St,U=Gt),(ue.equals(z)===!1||He!==Q)&&(o.blendColor(ue.r,ue.g,ue.b,He),z.copy(ue),Q=He),M=V,w=!1}function F(V,Lt){V.side===oa?At(o.CULL_FACE):dt(o.CULL_FACE);let Ct=V.side===kn;Lt&&(Ct=!Ct),Qt(Ct),V.blending===vs&&V.transparent===!1?fe(ua):fe(V.blending,V.blendEquation,V.blendSrc,V.blendDst,V.blendEquationAlpha,V.blendSrcAlpha,V.blendDstAlpha,V.blendColor,V.blendAlpha,V.premultipliedAlpha),d.setFunc(V.depthFunc),d.setTest(V.depthTest),d.setMask(V.depthWrite),u.setMask(V.colorWrite);const wt=V.stencilWrite;h.setTest(wt),wt&&(h.setMask(V.stencilWriteMask),h.setFunc(V.stencilFunc,V.stencilRef,V.stencilFuncMask),h.setOp(V.stencilFail,V.stencilZFail,V.stencilZPass)),Dt(V.polygonOffset,V.polygonOffsetFactor,V.polygonOffsetUnits),V.alphaToCoverage===!0?dt(o.SAMPLE_ALPHA_TO_COVERAGE):At(o.SAMPLE_ALPHA_TO_COVERAGE)}function Qt(V){T!==V&&(V?o.frontFace(o.CW):o.frontFace(o.CCW),T=V)}function It(V){V!==lS?(dt(o.CULL_FACE),V!==I&&(V===px?o.cullFace(o.BACK):V===cS?o.cullFace(o.FRONT):o.cullFace(o.FRONT_AND_BACK))):At(o.CULL_FACE),I=V}function jt(V){V!==Y&&(O&&o.lineWidth(V),Y=V)}function Dt(V,Lt,Ct){V?(dt(o.POLYGON_OFFSET_FILL),(st!==Lt||ct!==Ct)&&(o.polygonOffset(Lt,Ct),st=Lt,ct=Ct)):At(o.POLYGON_OFFSET_FILL)}function ve(V){V?dt(o.SCISSOR_TEST):At(o.SCISSOR_TEST)}function Ht(V){V===void 0&&(V=o.TEXTURE0+rt-1),ut!==V&&(o.activeTexture(V),ut=V)}function Jt(V,Lt,Ct){Ct===void 0&&(ut===null?Ct=o.TEXTURE0+rt-1:Ct=ut);let wt=ot[Ct];wt===void 0&&(wt={type:void 0,texture:void 0},ot[Ct]=wt),(wt.type!==V||wt.texture!==Lt)&&(ut!==Ct&&(o.activeTexture(Ct),ut=Ct),o.bindTexture(V,Lt||J[V]),wt.type=V,wt.texture=Lt)}function N(){const V=ot[ut];V!==void 0&&V.type!==void 0&&(o.bindTexture(V.type,null),V.type=void 0,V.texture=void 0)}function b(){try{o.compressedTexImage2D(...arguments)}catch(V){V("WebGLState:",V)}}function $(){try{o.compressedTexImage3D(...arguments)}catch(V){V("WebGLState:",V)}}function gt(){try{o.texSubImage2D(...arguments)}catch(V){V("WebGLState:",V)}}function yt(){try{o.texSubImage3D(...arguments)}catch(V){V("WebGLState:",V)}}function at(){try{o.compressedTexSubImage2D(...arguments)}catch(V){V("WebGLState:",V)}}function Wt(){try{o.compressedTexSubImage3D(...arguments)}catch(V){V("WebGLState:",V)}}function Ut(){try{o.texStorage2D(...arguments)}catch(V){V("WebGLState:",V)}}function ie(){try{o.texStorage3D(...arguments)}catch(V){V("WebGLState:",V)}}function Yt(){try{o.texImage2D(...arguments)}catch(V){V("WebGLState:",V)}}function bt(){try{o.texImage3D(...arguments)}catch(V){V("WebGLState:",V)}}function Tt(V){mt.equals(V)===!1&&(o.scissor(V.x,V.y,V.z,V.w),mt.copy(V))}function Zt(V){ft.equals(V)===!1&&(o.viewport(V.x,V.y,V.z,V.w),ft.copy(V))}function Xt(V,Lt){let Ct=p.get(Lt);Ct===void 0&&(Ct=new WeakMap,p.set(Lt,Ct));let wt=Ct.get(V);wt===void 0&&(wt=o.getUniformBlockIndex(Lt,V.name),Ct.set(V,wt))}function Ft(V,Lt){const wt=p.get(Lt).get(V);m.get(Lt)!==wt&&(o.uniformBlockBinding(Lt,wt,V.__bindingPointIndex),m.set(Lt,wt))}function le(){o.disable(o.BLEND),o.disable(o.CULL_FACE),o.disable(o.DEPTH_TEST),o.disable(o.POLYGON_OFFSET_FILL),o.disable(o.SCISSOR_TEST),o.disable(o.STENCIL_TEST),o.disable(o.SAMPLE_ALPHA_TO_COVERAGE),o.blendEquation(o.FUNC_ADD),o.blendFunc(o.ONE,o.ZERO),o.blendFuncSeparate(o.ONE,o.ZERO,o.ONE,o.ZERO),o.blendColor(0,0,0,0),o.colorMask(!0,!0,!0,!0),o.clearColor(0,0,0,0),o.depthMask(!0),o.depthFunc(o.LESS),d.setReversed(!1),o.clearDepth(1),o.stencilMask(4294967295),o.stencilFunc(o.ALWAYS,0,4294967295),o.stencilOp(o.KEEP,o.KEEP,o.KEEP),o.clearStencil(0),o.cullFace(o.BACK),o.frontFace(o.CCW),o.polygonOffset(0,0),o.activeTexture(o.TEXTURE0),o.bindFramebuffer(o.FRAMEBUFFER,null),o.bindFramebuffer(o.DRAW_FRAMEBUFFER,null),o.bindFramebuffer(o.READ_FRAMEBUFFER,null),o.useProgram(null),o.lineWidth(1),o.scissor(0,0,o.canvas.width,o.canvas.height),o.viewport(0,0,o.canvas.width,o.canvas.height),v={},ut=null,ot={},g={},S=new WeakMap,y=[],A=null,C=!1,M=null,_=null,P=null,L=null,H=null,X=null,U=null,z=new Be(0,0,0),Q=0,w=!1,T=null,I=null,Y=null,st=null,ct=null,mt.set(0,0,o.canvas.width,o.canvas.height),ft.set(0,0,o.canvas.width,o.canvas.height),u.reset(),d.reset(),h.reset()}return{buffers:{color:u,depth:d,stencil:h},enable:dt,disable:At,bindFramebuffer:Pt,drawBuffers:Nt,useProgram:ee,setBlending:fe,setMaterial:F,setFlipSided:Qt,setCullFace:It,setLineWidth:jt,setPolygonOffset:Dt,setScissorTest:ve,activeTexture:Ht,bindTexture:Jt,unbindTexture:N,compressedTexImage2D:b,compressedTexImage3D:$,texImage2D:Yt,texImage3D:bt,updateUBOMapping:Xt,uniformBlockBinding:Ft,texStorage2D:Ut,texStorage3D:ie,texSubImage2D:gt,texSubImage3D:yt,compressedTexSubImage2D:at,compressedTexSubImage3D:Wt,scissor:Tt,viewport:Zt,reset:le}}function lE(o,e,i,r,l,u,d){const h=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,m=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),p=new We,v=new WeakMap;let g;const S=new WeakMap;let y=!1;try{y=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function A(N,b){return y?new OffscreenCanvas(N,b):Cc("canvas")}function C(N,b,$){let gt=1;const yt=Jt(N);if((yt.width>$||yt.height>$)&&(gt=$/Math.max(yt.width,yt.height)),gt<1)if(typeof HTMLImageElement<"u"&&N instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&N instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&N instanceof ImageBitmap||typeof VideoFrame<"u"&&N instanceof VideoFrame){const at=Math.floor(gt*yt.width),Wt=Math.floor(gt*yt.height);g===void 0&&(g=A(at,Wt));const Ut=b?A(at,Wt):g;return Ut.width=at,Ut.height=Wt,Ut.getContext("2d").drawImage(N,0,0,at,Wt),pe("WebGLRenderer: Texture has been resized from ("+yt.width+"x"+yt.height+") to ("+at+"x"+Wt+")."),Ut}else return"data"in N&&pe("WebGLRenderer: Image in DataTexture is too big ("+yt.width+"x"+yt.height+")."),N;return N}function M(N){return N.generateMipmaps}function _(N){o.generateMipmap(N)}function P(N){return N.isWebGLCubeRenderTarget?o.TEXTURE_CUBE_MAP:N.isWebGL3DRenderTarget?o.TEXTURE_3D:N.isWebGLArrayRenderTarget||N.isCompressedArrayTexture?o.TEXTURE_2D_ARRAY:o.TEXTURE_2D}function L(N,b,$,gt,yt=!1){if(N!==null){if(o[N]!==void 0)return o[N];pe("WebGLRenderer: Attempt to use non-existing WebGL internal format '"+N+"'")}let at=b;if(b===o.RED&&($===o.FLOAT&&(at=o.R32F),$===o.HALF_FLOAT&&(at=o.R16F),$===o.UNSIGNED_BYTE&&(at=o.R8)),b===o.RED_INTEGER&&($===o.UNSIGNED_BYTE&&(at=o.R8UI),$===o.UNSIGNED_SHORT&&(at=o.R16UI),$===o.UNSIGNED_INT&&(at=o.R32UI),$===o.BYTE&&(at=o.R8I),$===o.SHORT&&(at=o.R16I),$===o.INT&&(at=o.R32I)),b===o.RG&&($===o.FLOAT&&(at=o.RG32F),$===o.HALF_FLOAT&&(at=o.RG16F),$===o.UNSIGNED_BYTE&&(at=o.RG8)),b===o.RG_INTEGER&&($===o.UNSIGNED_BYTE&&(at=o.RG8UI),$===o.UNSIGNED_SHORT&&(at=o.RG16UI),$===o.UNSIGNED_INT&&(at=o.RG32UI),$===o.BYTE&&(at=o.RG8I),$===o.SHORT&&(at=o.RG16I),$===o.INT&&(at=o.RG32I)),b===o.RGB_INTEGER&&($===o.UNSIGNED_BYTE&&(at=o.RGB8UI),$===o.UNSIGNED_SHORT&&(at=o.RGB16UI),$===o.UNSIGNED_INT&&(at=o.RGB32UI),$===o.BYTE&&(at=o.RGB8I),$===o.SHORT&&(at=o.RGB16I),$===o.INT&&(at=o.RGB32I)),b===o.RGBA_INTEGER&&($===o.UNSIGNED_BYTE&&(at=o.RGBA8UI),$===o.UNSIGNED_SHORT&&(at=o.RGBA16UI),$===o.UNSIGNED_INT&&(at=o.RGBA32UI),$===o.BYTE&&(at=o.RGBA8I),$===o.SHORT&&(at=o.RGBA16I),$===o.INT&&(at=o.RGBA32I)),b===o.RGB&&($===o.UNSIGNED_INT_5_9_9_9_REV&&(at=o.RGB9_E5),$===o.UNSIGNED_INT_10F_11F_11F_REV&&(at=o.R11F_G11F_B10F)),b===o.RGBA){const Wt=yt?Ac:Oe.getTransfer(gt);$===o.FLOAT&&(at=o.RGBA32F),$===o.HALF_FLOAT&&(at=o.RGBA16F),$===o.UNSIGNED_BYTE&&(at=Wt===Xe?o.SRGB8_ALPHA8:o.RGBA8),$===o.UNSIGNED_SHORT_4_4_4_4&&(at=o.RGBA4),$===o.UNSIGNED_SHORT_5_5_5_1&&(at=o.RGB5_A1)}return(at===o.R16F||at===o.R32F||at===o.RG16F||at===o.RG32F||at===o.RGBA16F||at===o.RGBA32F)&&e.get("EXT_color_buffer_float"),at}function H(N,b){let $;return N?b===null||b===Tr||b===Lo?$=o.DEPTH24_STENCIL8:b===ca?$=o.DEPTH32F_STENCIL8:b===Uo&&($=o.DEPTH24_STENCIL8,pe("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):b===null||b===Tr||b===Lo?$=o.DEPTH_COMPONENT24:b===ca?$=o.DEPTH_COMPONENT32F:b===Uo&&($=o.DEPTH_COMPONENT16),$}function X(N,b){return M(N)===!0||N.isFramebufferTexture&&N.minFilter!==ni&&N.minFilter!==pi?Math.log2(Math.max(b.width,b.height))+1:N.mipmaps!==void 0&&N.mipmaps.length>0?N.mipmaps.length:N.isCompressedTexture&&Array.isArray(N.image)?b.mipmaps.length:1}function U(N){const b=N.target;b.removeEventListener("dispose",U),Q(b),b.isVideoTexture&&v.delete(b)}function z(N){const b=N.target;b.removeEventListener("dispose",z),T(b)}function Q(N){const b=r.get(N);if(b.__webglInit===void 0)return;const $=N.source,gt=S.get($);if(gt){const yt=gt[b.__cacheKey];yt.usedTimes--,yt.usedTimes===0&&w(N),Object.keys(gt).length===0&&S.delete($)}r.remove(N)}function w(N){const b=r.get(N);o.deleteTexture(b.__webglTexture);const $=N.source,gt=S.get($);delete gt[b.__cacheKey],d.memory.textures--}function T(N){const b=r.get(N);if(N.depthTexture&&(N.depthTexture.dispose(),r.remove(N.depthTexture)),N.isWebGLCubeRenderTarget)for(let gt=0;gt<6;gt++){if(Array.isArray(b.__webglFramebuffer[gt]))for(let yt=0;yt<b.__webglFramebuffer[gt].length;yt++)o.deleteFramebuffer(b.__webglFramebuffer[gt][yt]);else o.deleteFramebuffer(b.__webglFramebuffer[gt]);b.__webglDepthbuffer&&o.deleteRenderbuffer(b.__webglDepthbuffer[gt])}else{if(Array.isArray(b.__webglFramebuffer))for(let gt=0;gt<b.__webglFramebuffer.length;gt++)o.deleteFramebuffer(b.__webglFramebuffer[gt]);else o.deleteFramebuffer(b.__webglFramebuffer);if(b.__webglDepthbuffer&&o.deleteRenderbuffer(b.__webglDepthbuffer),b.__webglMultisampledFramebuffer&&o.deleteFramebuffer(b.__webglMultisampledFramebuffer),b.__webglColorRenderbuffer)for(let gt=0;gt<b.__webglColorRenderbuffer.length;gt++)b.__webglColorRenderbuffer[gt]&&o.deleteRenderbuffer(b.__webglColorRenderbuffer[gt]);b.__webglDepthRenderbuffer&&o.deleteRenderbuffer(b.__webglDepthRenderbuffer)}const $=N.textures;for(let gt=0,yt=$.length;gt<yt;gt++){const at=r.get($[gt]);at.__webglTexture&&(o.deleteTexture(at.__webglTexture),d.memory.textures--),r.remove($[gt])}r.remove(N)}let I=0;function Y(){I=0}function st(){const N=I;return N>=l.maxTextures&&pe("WebGLTextures: Trying to use "+N+" texture units while this GPU supports only "+l.maxTextures),I+=1,N}function ct(N){const b=[];return b.push(N.wrapS),b.push(N.wrapT),b.push(N.wrapR||0),b.push(N.magFilter),b.push(N.minFilter),b.push(N.anisotropy),b.push(N.internalFormat),b.push(N.format),b.push(N.type),b.push(N.generateMipmaps),b.push(N.premultiplyAlpha),b.push(N.flipY),b.push(N.unpackAlignment),b.push(N.colorSpace),b.join()}function rt(N,b){const $=r.get(N);if(N.isVideoTexture&&ve(N),N.isRenderTargetTexture===!1&&N.isExternalTexture!==!0&&N.version>0&&$.__version!==N.version){const gt=N.image;if(gt===null)pe("WebGLRenderer: Texture marked for update but no image data found.");else if(gt.complete===!1)pe("WebGLRenderer: Texture marked for update but image is incomplete");else{J($,N,b);return}}else N.isExternalTexture&&($.__webglTexture=N.sourceTexture?N.sourceTexture:null);i.bindTexture(o.TEXTURE_2D,$.__webglTexture,o.TEXTURE0+b)}function O(N,b){const $=r.get(N);if(N.isRenderTargetTexture===!1&&N.version>0&&$.__version!==N.version){J($,N,b);return}else N.isExternalTexture&&($.__webglTexture=N.sourceTexture?N.sourceTexture:null);i.bindTexture(o.TEXTURE_2D_ARRAY,$.__webglTexture,o.TEXTURE0+b)}function G(N,b){const $=r.get(N);if(N.isRenderTargetTexture===!1&&N.version>0&&$.__version!==N.version){J($,N,b);return}i.bindTexture(o.TEXTURE_3D,$.__webglTexture,o.TEXTURE0+b)}function W(N,b){const $=r.get(N);if(N.version>0&&$.__version!==N.version){dt($,N,b);return}i.bindTexture(o.TEXTURE_CUBE_MAP,$.__webglTexture,o.TEXTURE0+b)}const ut={[Pd]:o.REPEAT,[la]:o.CLAMP_TO_EDGE,[zd]:o.MIRRORED_REPEAT},ot={[ni]:o.NEAREST,[IS]:o.NEAREST_MIPMAP_NEAREST,[Jl]:o.NEAREST_MIPMAP_LINEAR,[pi]:o.LINEAR,[Yf]:o.LINEAR_MIPMAP_NEAREST,[br]:o.LINEAR_MIPMAP_LINEAR},D={[kS]:o.NEVER,[ZS]:o.ALWAYS,[XS]:o.LESS,[bg]:o.LEQUAL,[WS]:o.EQUAL,[jS]:o.GEQUAL,[qS]:o.GREATER,[YS]:o.NOTEQUAL};function q(N,b){if(b.type===ca&&e.has("OES_texture_float_linear")===!1&&(b.magFilter===pi||b.magFilter===Yf||b.magFilter===Jl||b.magFilter===br||b.minFilter===pi||b.minFilter===Yf||b.minFilter===Jl||b.minFilter===br)&&pe("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),o.texParameteri(N,o.TEXTURE_WRAP_S,ut[b.wrapS]),o.texParameteri(N,o.TEXTURE_WRAP_T,ut[b.wrapT]),(N===o.TEXTURE_3D||N===o.TEXTURE_2D_ARRAY)&&o.texParameteri(N,o.TEXTURE_WRAP_R,ut[b.wrapR]),o.texParameteri(N,o.TEXTURE_MAG_FILTER,ot[b.magFilter]),o.texParameteri(N,o.TEXTURE_MIN_FILTER,ot[b.minFilter]),b.compareFunction&&(o.texParameteri(N,o.TEXTURE_COMPARE_MODE,o.COMPARE_REF_TO_TEXTURE),o.texParameteri(N,o.TEXTURE_COMPARE_FUNC,D[b.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(b.magFilter===ni||b.minFilter!==Jl&&b.minFilter!==br||b.type===ca&&e.has("OES_texture_float_linear")===!1)return;if(b.anisotropy>1||r.get(b).__currentAnisotropy){const $=e.get("EXT_texture_filter_anisotropic");o.texParameterf(N,$.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(b.anisotropy,l.getMaxAnisotropy())),r.get(b).__currentAnisotropy=b.anisotropy}}}function mt(N,b){let $=!1;N.__webglInit===void 0&&(N.__webglInit=!0,b.addEventListener("dispose",U));const gt=b.source;let yt=S.get(gt);yt===void 0&&(yt={},S.set(gt,yt));const at=ct(b);if(at!==N.__cacheKey){yt[at]===void 0&&(yt[at]={texture:o.createTexture(),usedTimes:0},d.memory.textures++,$=!0),yt[at].usedTimes++;const Wt=yt[N.__cacheKey];Wt!==void 0&&(yt[N.__cacheKey].usedTimes--,Wt.usedTimes===0&&w(b)),N.__cacheKey=at,N.__webglTexture=yt[at].texture}return $}function ft(N,b,$){return Math.floor(Math.floor(N/$)/b)}function Mt(N,b,$,gt){const at=N.updateRanges;if(at.length===0)i.texSubImage2D(o.TEXTURE_2D,0,0,0,b.width,b.height,$,gt,b.data);else{at.sort((bt,Tt)=>bt.start-Tt.start);let Wt=0;for(let bt=1;bt<at.length;bt++){const Tt=at[Wt],Zt=at[bt],Xt=Tt.start+Tt.count,Ft=ft(Zt.start,b.width,4),le=ft(Tt.start,b.width,4);Zt.start<=Xt+1&&Ft===le&&ft(Zt.start+Zt.count-1,b.width,4)===Ft?Tt.count=Math.max(Tt.count,Zt.start+Zt.count-Tt.start):(++Wt,at[Wt]=Zt)}at.length=Wt+1;const Ut=o.getParameter(o.UNPACK_ROW_LENGTH),ie=o.getParameter(o.UNPACK_SKIP_PIXELS),Yt=o.getParameter(o.UNPACK_SKIP_ROWS);o.pixelStorei(o.UNPACK_ROW_LENGTH,b.width);for(let bt=0,Tt=at.length;bt<Tt;bt++){const Zt=at[bt],Xt=Math.floor(Zt.start/4),Ft=Math.ceil(Zt.count/4),le=Xt%b.width,V=Math.floor(Xt/b.width),Lt=Ft,Ct=1;o.pixelStorei(o.UNPACK_SKIP_PIXELS,le),o.pixelStorei(o.UNPACK_SKIP_ROWS,V),i.texSubImage2D(o.TEXTURE_2D,0,le,V,Lt,Ct,$,gt,b.data)}N.clearUpdateRanges(),o.pixelStorei(o.UNPACK_ROW_LENGTH,Ut),o.pixelStorei(o.UNPACK_SKIP_PIXELS,ie),o.pixelStorei(o.UNPACK_SKIP_ROWS,Yt)}}function J(N,b,$){let gt=o.TEXTURE_2D;(b.isDataArrayTexture||b.isCompressedArrayTexture)&&(gt=o.TEXTURE_2D_ARRAY),b.isData3DTexture&&(gt=o.TEXTURE_3D);const yt=mt(N,b),at=b.source;i.bindTexture(gt,N.__webglTexture,o.TEXTURE0+$);const Wt=r.get(at);if(at.version!==Wt.__version||yt===!0){i.activeTexture(o.TEXTURE0+$);const Ut=Oe.getPrimaries(Oe.workingColorSpace),ie=b.colorSpace===Wa?null:Oe.getPrimaries(b.colorSpace),Yt=b.colorSpace===Wa||Ut===ie?o.NONE:o.BROWSER_DEFAULT_WEBGL;o.pixelStorei(o.UNPACK_FLIP_Y_WEBGL,b.flipY),o.pixelStorei(o.UNPACK_PREMULTIPLY_ALPHA_WEBGL,b.premultiplyAlpha),o.pixelStorei(o.UNPACK_ALIGNMENT,b.unpackAlignment),o.pixelStorei(o.UNPACK_COLORSPACE_CONVERSION_WEBGL,Yt);let bt=C(b.image,!1,l.maxTextureSize);bt=Ht(b,bt);const Tt=u.convert(b.format,b.colorSpace),Zt=u.convert(b.type);let Xt=L(b.internalFormat,Tt,Zt,b.colorSpace,b.isVideoTexture);q(gt,b);let Ft;const le=b.mipmaps,V=b.isVideoTexture!==!0,Lt=Wt.__version===void 0||yt===!0,Ct=at.dataReady,wt=X(b,bt);if(b.isDepthTexture)Xt=H(b.format===Oo,b.type),Lt&&(V?i.texStorage2D(o.TEXTURE_2D,1,Xt,bt.width,bt.height):i.texImage2D(o.TEXTURE_2D,0,Xt,bt.width,bt.height,0,Tt,Zt,null));else if(b.isDataTexture)if(le.length>0){V&&Lt&&i.texStorage2D(o.TEXTURE_2D,wt,Xt,le[0].width,le[0].height);for(let Et=0,St=le.length;Et<St;Et++)Ft=le[Et],V?Ct&&i.texSubImage2D(o.TEXTURE_2D,Et,0,0,Ft.width,Ft.height,Tt,Zt,Ft.data):i.texImage2D(o.TEXTURE_2D,Et,Xt,Ft.width,Ft.height,0,Tt,Zt,Ft.data);b.generateMipmaps=!1}else V?(Lt&&i.texStorage2D(o.TEXTURE_2D,wt,Xt,bt.width,bt.height),Ct&&Mt(b,bt,Tt,Zt)):i.texImage2D(o.TEXTURE_2D,0,Xt,bt.width,bt.height,0,Tt,Zt,bt.data);else if(b.isCompressedTexture)if(b.isCompressedArrayTexture){V&&Lt&&i.texStorage3D(o.TEXTURE_2D_ARRAY,wt,Xt,le[0].width,le[0].height,bt.depth);for(let Et=0,St=le.length;Et<St;Et++)if(Ft=le[Et],b.format!==Ei)if(Tt!==null)if(V){if(Ct)if(b.layerUpdates.size>0){const Gt=Hx(Ft.width,Ft.height,b.format,b.type);for(const ue of b.layerUpdates){const He=Ft.data.subarray(ue*Gt/Ft.data.BYTES_PER_ELEMENT,(ue+1)*Gt/Ft.data.BYTES_PER_ELEMENT);i.compressedTexSubImage3D(o.TEXTURE_2D_ARRAY,Et,0,0,ue,Ft.width,Ft.height,1,Tt,He)}b.clearLayerUpdates()}else i.compressedTexSubImage3D(o.TEXTURE_2D_ARRAY,Et,0,0,0,Ft.width,Ft.height,bt.depth,Tt,Ft.data)}else i.compressedTexImage3D(o.TEXTURE_2D_ARRAY,Et,Xt,Ft.width,Ft.height,bt.depth,0,Ft.data,0,0);else pe("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else V?Ct&&i.texSubImage3D(o.TEXTURE_2D_ARRAY,Et,0,0,0,Ft.width,Ft.height,bt.depth,Tt,Zt,Ft.data):i.texImage3D(o.TEXTURE_2D_ARRAY,Et,Xt,Ft.width,Ft.height,bt.depth,0,Tt,Zt,Ft.data)}else{V&&Lt&&i.texStorage2D(o.TEXTURE_2D,wt,Xt,le[0].width,le[0].height);for(let Et=0,St=le.length;Et<St;Et++)Ft=le[Et],b.format!==Ei?Tt!==null?V?Ct&&i.compressedTexSubImage2D(o.TEXTURE_2D,Et,0,0,Ft.width,Ft.height,Tt,Ft.data):i.compressedTexImage2D(o.TEXTURE_2D,Et,Xt,Ft.width,Ft.height,0,Ft.data):pe("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):V?Ct&&i.texSubImage2D(o.TEXTURE_2D,Et,0,0,Ft.width,Ft.height,Tt,Zt,Ft.data):i.texImage2D(o.TEXTURE_2D,Et,Xt,Ft.width,Ft.height,0,Tt,Zt,Ft.data)}else if(b.isDataArrayTexture)if(V){if(Lt&&i.texStorage3D(o.TEXTURE_2D_ARRAY,wt,Xt,bt.width,bt.height,bt.depth),Ct)if(b.layerUpdates.size>0){const Et=Hx(bt.width,bt.height,b.format,b.type);for(const St of b.layerUpdates){const Gt=bt.data.subarray(St*Et/bt.data.BYTES_PER_ELEMENT,(St+1)*Et/bt.data.BYTES_PER_ELEMENT);i.texSubImage3D(o.TEXTURE_2D_ARRAY,0,0,0,St,bt.width,bt.height,1,Tt,Zt,Gt)}b.clearLayerUpdates()}else i.texSubImage3D(o.TEXTURE_2D_ARRAY,0,0,0,0,bt.width,bt.height,bt.depth,Tt,Zt,bt.data)}else i.texImage3D(o.TEXTURE_2D_ARRAY,0,Xt,bt.width,bt.height,bt.depth,0,Tt,Zt,bt.data);else if(b.isData3DTexture)V?(Lt&&i.texStorage3D(o.TEXTURE_3D,wt,Xt,bt.width,bt.height,bt.depth),Ct&&i.texSubImage3D(o.TEXTURE_3D,0,0,0,0,bt.width,bt.height,bt.depth,Tt,Zt,bt.data)):i.texImage3D(o.TEXTURE_3D,0,Xt,bt.width,bt.height,bt.depth,0,Tt,Zt,bt.data);else if(b.isFramebufferTexture){if(Lt)if(V)i.texStorage2D(o.TEXTURE_2D,wt,Xt,bt.width,bt.height);else{let Et=bt.width,St=bt.height;for(let Gt=0;Gt<wt;Gt++)i.texImage2D(o.TEXTURE_2D,Gt,Xt,Et,St,0,Tt,Zt,null),Et>>=1,St>>=1}}else if(le.length>0){if(V&&Lt){const Et=Jt(le[0]);i.texStorage2D(o.TEXTURE_2D,wt,Xt,Et.width,Et.height)}for(let Et=0,St=le.length;Et<St;Et++)Ft=le[Et],V?Ct&&i.texSubImage2D(o.TEXTURE_2D,Et,0,0,Tt,Zt,Ft):i.texImage2D(o.TEXTURE_2D,Et,Xt,Tt,Zt,Ft);b.generateMipmaps=!1}else if(V){if(Lt){const Et=Jt(bt);i.texStorage2D(o.TEXTURE_2D,wt,Xt,Et.width,Et.height)}Ct&&i.texSubImage2D(o.TEXTURE_2D,0,0,0,Tt,Zt,bt)}else i.texImage2D(o.TEXTURE_2D,0,Xt,Tt,Zt,bt);M(b)&&_(gt),Wt.__version=at.version,b.onUpdate&&b.onUpdate(b)}N.__version=b.version}function dt(N,b,$){if(b.image.length!==6)return;const gt=mt(N,b),yt=b.source;i.bindTexture(o.TEXTURE_CUBE_MAP,N.__webglTexture,o.TEXTURE0+$);const at=r.get(yt);if(yt.version!==at.__version||gt===!0){i.activeTexture(o.TEXTURE0+$);const Wt=Oe.getPrimaries(Oe.workingColorSpace),Ut=b.colorSpace===Wa?null:Oe.getPrimaries(b.colorSpace),ie=b.colorSpace===Wa||Wt===Ut?o.NONE:o.BROWSER_DEFAULT_WEBGL;o.pixelStorei(o.UNPACK_FLIP_Y_WEBGL,b.flipY),o.pixelStorei(o.UNPACK_PREMULTIPLY_ALPHA_WEBGL,b.premultiplyAlpha),o.pixelStorei(o.UNPACK_ALIGNMENT,b.unpackAlignment),o.pixelStorei(o.UNPACK_COLORSPACE_CONVERSION_WEBGL,ie);const Yt=b.isCompressedTexture||b.image[0].isCompressedTexture,bt=b.image[0]&&b.image[0].isDataTexture,Tt=[];for(let St=0;St<6;St++)!Yt&&!bt?Tt[St]=C(b.image[St],!0,l.maxCubemapSize):Tt[St]=bt?b.image[St].image:b.image[St],Tt[St]=Ht(b,Tt[St]);const Zt=Tt[0],Xt=u.convert(b.format,b.colorSpace),Ft=u.convert(b.type),le=L(b.internalFormat,Xt,Ft,b.colorSpace),V=b.isVideoTexture!==!0,Lt=at.__version===void 0||gt===!0,Ct=yt.dataReady;let wt=X(b,Zt);q(o.TEXTURE_CUBE_MAP,b);let Et;if(Yt){V&&Lt&&i.texStorage2D(o.TEXTURE_CUBE_MAP,wt,le,Zt.width,Zt.height);for(let St=0;St<6;St++){Et=Tt[St].mipmaps;for(let Gt=0;Gt<Et.length;Gt++){const ue=Et[Gt];b.format!==Ei?Xt!==null?V?Ct&&i.compressedTexSubImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+St,Gt,0,0,ue.width,ue.height,Xt,ue.data):i.compressedTexImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+St,Gt,le,ue.width,ue.height,0,ue.data):pe("WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):V?Ct&&i.texSubImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+St,Gt,0,0,ue.width,ue.height,Xt,Ft,ue.data):i.texImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+St,Gt,le,ue.width,ue.height,0,Xt,Ft,ue.data)}}}else{if(Et=b.mipmaps,V&&Lt){Et.length>0&&wt++;const St=Jt(Tt[0]);i.texStorage2D(o.TEXTURE_CUBE_MAP,wt,le,St.width,St.height)}for(let St=0;St<6;St++)if(bt){V?Ct&&i.texSubImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+St,0,0,0,Tt[St].width,Tt[St].height,Xt,Ft,Tt[St].data):i.texImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+St,0,le,Tt[St].width,Tt[St].height,0,Xt,Ft,Tt[St].data);for(let Gt=0;Gt<Et.length;Gt++){const He=Et[Gt].image[St].image;V?Ct&&i.texSubImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+St,Gt+1,0,0,He.width,He.height,Xt,Ft,He.data):i.texImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+St,Gt+1,le,He.width,He.height,0,Xt,Ft,He.data)}}else{V?Ct&&i.texSubImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+St,0,0,0,Xt,Ft,Tt[St]):i.texImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+St,0,le,Xt,Ft,Tt[St]);for(let Gt=0;Gt<Et.length;Gt++){const ue=Et[Gt];V?Ct&&i.texSubImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+St,Gt+1,0,0,Xt,Ft,ue.image[St]):i.texImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+St,Gt+1,le,Xt,Ft,ue.image[St])}}}M(b)&&_(o.TEXTURE_CUBE_MAP),at.__version=yt.version,b.onUpdate&&b.onUpdate(b)}N.__version=b.version}function At(N,b,$,gt,yt,at){const Wt=u.convert($.format,$.colorSpace),Ut=u.convert($.type),ie=L($.internalFormat,Wt,Ut,$.colorSpace),Yt=r.get(b),bt=r.get($);if(bt.__renderTarget=b,!Yt.__hasExternalTextures){const Tt=Math.max(1,b.width>>at),Zt=Math.max(1,b.height>>at);yt===o.TEXTURE_3D||yt===o.TEXTURE_2D_ARRAY?i.texImage3D(yt,at,ie,Tt,Zt,b.depth,0,Wt,Ut,null):i.texImage2D(yt,at,ie,Tt,Zt,0,Wt,Ut,null)}i.bindFramebuffer(o.FRAMEBUFFER,N),Dt(b)?h.framebufferTexture2DMultisampleEXT(o.FRAMEBUFFER,gt,yt,bt.__webglTexture,0,jt(b)):(yt===o.TEXTURE_2D||yt>=o.TEXTURE_CUBE_MAP_POSITIVE_X&&yt<=o.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&o.framebufferTexture2D(o.FRAMEBUFFER,gt,yt,bt.__webglTexture,at),i.bindFramebuffer(o.FRAMEBUFFER,null)}function Pt(N,b,$){if(o.bindRenderbuffer(o.RENDERBUFFER,N),b.depthBuffer){const gt=b.depthTexture,yt=gt&&gt.isDepthTexture?gt.type:null,at=H(b.stencilBuffer,yt),Wt=b.stencilBuffer?o.DEPTH_STENCIL_ATTACHMENT:o.DEPTH_ATTACHMENT,Ut=jt(b);Dt(b)?h.renderbufferStorageMultisampleEXT(o.RENDERBUFFER,Ut,at,b.width,b.height):$?o.renderbufferStorageMultisample(o.RENDERBUFFER,Ut,at,b.width,b.height):o.renderbufferStorage(o.RENDERBUFFER,at,b.width,b.height),o.framebufferRenderbuffer(o.FRAMEBUFFER,Wt,o.RENDERBUFFER,N)}else{const gt=b.textures;for(let yt=0;yt<gt.length;yt++){const at=gt[yt],Wt=u.convert(at.format,at.colorSpace),Ut=u.convert(at.type),ie=L(at.internalFormat,Wt,Ut,at.colorSpace),Yt=jt(b);$&&Dt(b)===!1?o.renderbufferStorageMultisample(o.RENDERBUFFER,Yt,ie,b.width,b.height):Dt(b)?h.renderbufferStorageMultisampleEXT(o.RENDERBUFFER,Yt,ie,b.width,b.height):o.renderbufferStorage(o.RENDERBUFFER,ie,b.width,b.height)}}o.bindRenderbuffer(o.RENDERBUFFER,null)}function Nt(N,b){if(b&&b.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(i.bindFramebuffer(o.FRAMEBUFFER,N),!(b.depthTexture&&b.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const gt=r.get(b.depthTexture);gt.__renderTarget=b,(!gt.__webglTexture||b.depthTexture.image.width!==b.width||b.depthTexture.image.height!==b.height)&&(b.depthTexture.image.width=b.width,b.depthTexture.image.height=b.height,b.depthTexture.needsUpdate=!0),rt(b.depthTexture,0);const yt=gt.__webglTexture,at=jt(b);if(b.depthTexture.format===No)Dt(b)?h.framebufferTexture2DMultisampleEXT(o.FRAMEBUFFER,o.DEPTH_ATTACHMENT,o.TEXTURE_2D,yt,0,at):o.framebufferTexture2D(o.FRAMEBUFFER,o.DEPTH_ATTACHMENT,o.TEXTURE_2D,yt,0);else if(b.depthTexture.format===Oo)Dt(b)?h.framebufferTexture2DMultisampleEXT(o.FRAMEBUFFER,o.DEPTH_STENCIL_ATTACHMENT,o.TEXTURE_2D,yt,0,at):o.framebufferTexture2D(o.FRAMEBUFFER,o.DEPTH_STENCIL_ATTACHMENT,o.TEXTURE_2D,yt,0);else throw new Error("Unknown depthTexture format")}function ee(N){const b=r.get(N),$=N.isWebGLCubeRenderTarget===!0;if(b.__boundDepthTexture!==N.depthTexture){const gt=N.depthTexture;if(b.__depthDisposeCallback&&b.__depthDisposeCallback(),gt){const yt=()=>{delete b.__boundDepthTexture,delete b.__depthDisposeCallback,gt.removeEventListener("dispose",yt)};gt.addEventListener("dispose",yt),b.__depthDisposeCallback=yt}b.__boundDepthTexture=gt}if(N.depthTexture&&!b.__autoAllocateDepthBuffer){if($)throw new Error("target.depthTexture not supported in Cube render targets");const gt=N.texture.mipmaps;gt&&gt.length>0?Nt(b.__webglFramebuffer[0],N):Nt(b.__webglFramebuffer,N)}else if($){b.__webglDepthbuffer=[];for(let gt=0;gt<6;gt++)if(i.bindFramebuffer(o.FRAMEBUFFER,b.__webglFramebuffer[gt]),b.__webglDepthbuffer[gt]===void 0)b.__webglDepthbuffer[gt]=o.createRenderbuffer(),Pt(b.__webglDepthbuffer[gt],N,!1);else{const yt=N.stencilBuffer?o.DEPTH_STENCIL_ATTACHMENT:o.DEPTH_ATTACHMENT,at=b.__webglDepthbuffer[gt];o.bindRenderbuffer(o.RENDERBUFFER,at),o.framebufferRenderbuffer(o.FRAMEBUFFER,yt,o.RENDERBUFFER,at)}}else{const gt=N.texture.mipmaps;if(gt&&gt.length>0?i.bindFramebuffer(o.FRAMEBUFFER,b.__webglFramebuffer[0]):i.bindFramebuffer(o.FRAMEBUFFER,b.__webglFramebuffer),b.__webglDepthbuffer===void 0)b.__webglDepthbuffer=o.createRenderbuffer(),Pt(b.__webglDepthbuffer,N,!1);else{const yt=N.stencilBuffer?o.DEPTH_STENCIL_ATTACHMENT:o.DEPTH_ATTACHMENT,at=b.__webglDepthbuffer;o.bindRenderbuffer(o.RENDERBUFFER,at),o.framebufferRenderbuffer(o.FRAMEBUFFER,yt,o.RENDERBUFFER,at)}}i.bindFramebuffer(o.FRAMEBUFFER,null)}function Ce(N,b,$){const gt=r.get(N);b!==void 0&&At(gt.__webglFramebuffer,N,N.texture,o.COLOR_ATTACHMENT0,o.TEXTURE_2D,0),$!==void 0&&ee(N)}function ne(N){const b=N.texture,$=r.get(N),gt=r.get(b);N.addEventListener("dispose",z);const yt=N.textures,at=N.isWebGLCubeRenderTarget===!0,Wt=yt.length>1;if(Wt||(gt.__webglTexture===void 0&&(gt.__webglTexture=o.createTexture()),gt.__version=b.version,d.memory.textures++),at){$.__webglFramebuffer=[];for(let Ut=0;Ut<6;Ut++)if(b.mipmaps&&b.mipmaps.length>0){$.__webglFramebuffer[Ut]=[];for(let ie=0;ie<b.mipmaps.length;ie++)$.__webglFramebuffer[Ut][ie]=o.createFramebuffer()}else $.__webglFramebuffer[Ut]=o.createFramebuffer()}else{if(b.mipmaps&&b.mipmaps.length>0){$.__webglFramebuffer=[];for(let Ut=0;Ut<b.mipmaps.length;Ut++)$.__webglFramebuffer[Ut]=o.createFramebuffer()}else $.__webglFramebuffer=o.createFramebuffer();if(Wt)for(let Ut=0,ie=yt.length;Ut<ie;Ut++){const Yt=r.get(yt[Ut]);Yt.__webglTexture===void 0&&(Yt.__webglTexture=o.createTexture(),d.memory.textures++)}if(N.samples>0&&Dt(N)===!1){$.__webglMultisampledFramebuffer=o.createFramebuffer(),$.__webglColorRenderbuffer=[],i.bindFramebuffer(o.FRAMEBUFFER,$.__webglMultisampledFramebuffer);for(let Ut=0;Ut<yt.length;Ut++){const ie=yt[Ut];$.__webglColorRenderbuffer[Ut]=o.createRenderbuffer(),o.bindRenderbuffer(o.RENDERBUFFER,$.__webglColorRenderbuffer[Ut]);const Yt=u.convert(ie.format,ie.colorSpace),bt=u.convert(ie.type),Tt=L(ie.internalFormat,Yt,bt,ie.colorSpace,N.isXRRenderTarget===!0),Zt=jt(N);o.renderbufferStorageMultisample(o.RENDERBUFFER,Zt,Tt,N.width,N.height),o.framebufferRenderbuffer(o.FRAMEBUFFER,o.COLOR_ATTACHMENT0+Ut,o.RENDERBUFFER,$.__webglColorRenderbuffer[Ut])}o.bindRenderbuffer(o.RENDERBUFFER,null),N.depthBuffer&&($.__webglDepthRenderbuffer=o.createRenderbuffer(),Pt($.__webglDepthRenderbuffer,N,!0)),i.bindFramebuffer(o.FRAMEBUFFER,null)}}if(at){i.bindTexture(o.TEXTURE_CUBE_MAP,gt.__webglTexture),q(o.TEXTURE_CUBE_MAP,b);for(let Ut=0;Ut<6;Ut++)if(b.mipmaps&&b.mipmaps.length>0)for(let ie=0;ie<b.mipmaps.length;ie++)At($.__webglFramebuffer[Ut][ie],N,b,o.COLOR_ATTACHMENT0,o.TEXTURE_CUBE_MAP_POSITIVE_X+Ut,ie);else At($.__webglFramebuffer[Ut],N,b,o.COLOR_ATTACHMENT0,o.TEXTURE_CUBE_MAP_POSITIVE_X+Ut,0);M(b)&&_(o.TEXTURE_CUBE_MAP),i.unbindTexture()}else if(Wt){for(let Ut=0,ie=yt.length;Ut<ie;Ut++){const Yt=yt[Ut],bt=r.get(Yt);let Tt=o.TEXTURE_2D;(N.isWebGL3DRenderTarget||N.isWebGLArrayRenderTarget)&&(Tt=N.isWebGL3DRenderTarget?o.TEXTURE_3D:o.TEXTURE_2D_ARRAY),i.bindTexture(Tt,bt.__webglTexture),q(Tt,Yt),At($.__webglFramebuffer,N,Yt,o.COLOR_ATTACHMENT0+Ut,Tt,0),M(Yt)&&_(Tt)}i.unbindTexture()}else{let Ut=o.TEXTURE_2D;if((N.isWebGL3DRenderTarget||N.isWebGLArrayRenderTarget)&&(Ut=N.isWebGL3DRenderTarget?o.TEXTURE_3D:o.TEXTURE_2D_ARRAY),i.bindTexture(Ut,gt.__webglTexture),q(Ut,b),b.mipmaps&&b.mipmaps.length>0)for(let ie=0;ie<b.mipmaps.length;ie++)At($.__webglFramebuffer[ie],N,b,o.COLOR_ATTACHMENT0,Ut,ie);else At($.__webglFramebuffer,N,b,o.COLOR_ATTACHMENT0,Ut,0);M(b)&&_(Ut),i.unbindTexture()}N.depthBuffer&&ee(N)}function fe(N){const b=N.textures;for(let $=0,gt=b.length;$<gt;$++){const yt=b[$];if(M(yt)){const at=P(N),Wt=r.get(yt).__webglTexture;i.bindTexture(at,Wt),_(at),i.unbindTexture()}}}const F=[],Qt=[];function It(N){if(N.samples>0){if(Dt(N)===!1){const b=N.textures,$=N.width,gt=N.height;let yt=o.COLOR_BUFFER_BIT;const at=N.stencilBuffer?o.DEPTH_STENCIL_ATTACHMENT:o.DEPTH_ATTACHMENT,Wt=r.get(N),Ut=b.length>1;if(Ut)for(let Yt=0;Yt<b.length;Yt++)i.bindFramebuffer(o.FRAMEBUFFER,Wt.__webglMultisampledFramebuffer),o.framebufferRenderbuffer(o.FRAMEBUFFER,o.COLOR_ATTACHMENT0+Yt,o.RENDERBUFFER,null),i.bindFramebuffer(o.FRAMEBUFFER,Wt.__webglFramebuffer),o.framebufferTexture2D(o.DRAW_FRAMEBUFFER,o.COLOR_ATTACHMENT0+Yt,o.TEXTURE_2D,null,0);i.bindFramebuffer(o.READ_FRAMEBUFFER,Wt.__webglMultisampledFramebuffer);const ie=N.texture.mipmaps;ie&&ie.length>0?i.bindFramebuffer(o.DRAW_FRAMEBUFFER,Wt.__webglFramebuffer[0]):i.bindFramebuffer(o.DRAW_FRAMEBUFFER,Wt.__webglFramebuffer);for(let Yt=0;Yt<b.length;Yt++){if(N.resolveDepthBuffer&&(N.depthBuffer&&(yt|=o.DEPTH_BUFFER_BIT),N.stencilBuffer&&N.resolveStencilBuffer&&(yt|=o.STENCIL_BUFFER_BIT)),Ut){o.framebufferRenderbuffer(o.READ_FRAMEBUFFER,o.COLOR_ATTACHMENT0,o.RENDERBUFFER,Wt.__webglColorRenderbuffer[Yt]);const bt=r.get(b[Yt]).__webglTexture;o.framebufferTexture2D(o.DRAW_FRAMEBUFFER,o.COLOR_ATTACHMENT0,o.TEXTURE_2D,bt,0)}o.blitFramebuffer(0,0,$,gt,0,0,$,gt,yt,o.NEAREST),m===!0&&(F.length=0,Qt.length=0,F.push(o.COLOR_ATTACHMENT0+Yt),N.depthBuffer&&N.resolveDepthBuffer===!1&&(F.push(at),Qt.push(at),o.invalidateFramebuffer(o.DRAW_FRAMEBUFFER,Qt)),o.invalidateFramebuffer(o.READ_FRAMEBUFFER,F))}if(i.bindFramebuffer(o.READ_FRAMEBUFFER,null),i.bindFramebuffer(o.DRAW_FRAMEBUFFER,null),Ut)for(let Yt=0;Yt<b.length;Yt++){i.bindFramebuffer(o.FRAMEBUFFER,Wt.__webglMultisampledFramebuffer),o.framebufferRenderbuffer(o.FRAMEBUFFER,o.COLOR_ATTACHMENT0+Yt,o.RENDERBUFFER,Wt.__webglColorRenderbuffer[Yt]);const bt=r.get(b[Yt]).__webglTexture;i.bindFramebuffer(o.FRAMEBUFFER,Wt.__webglFramebuffer),o.framebufferTexture2D(o.DRAW_FRAMEBUFFER,o.COLOR_ATTACHMENT0+Yt,o.TEXTURE_2D,bt,0)}i.bindFramebuffer(o.DRAW_FRAMEBUFFER,Wt.__webglMultisampledFramebuffer)}else if(N.depthBuffer&&N.resolveDepthBuffer===!1&&m){const b=N.stencilBuffer?o.DEPTH_STENCIL_ATTACHMENT:o.DEPTH_ATTACHMENT;o.invalidateFramebuffer(o.DRAW_FRAMEBUFFER,[b])}}}function jt(N){return Math.min(l.maxSamples,N.samples)}function Dt(N){const b=r.get(N);return N.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&b.__useRenderToTexture!==!1}function ve(N){const b=d.render.frame;v.get(N)!==b&&(v.set(N,b),N.update())}function Ht(N,b){const $=N.colorSpace,gt=N.format,yt=N.type;return N.isCompressedTexture===!0||N.isVideoTexture===!0||$!==Es&&$!==Wa&&(Oe.getTransfer($)===Xe?(gt!==Ei||yt!==da)&&pe("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):rn("WebGLTextures: Unsupported texture color space:",$)),b}function Jt(N){return typeof HTMLImageElement<"u"&&N instanceof HTMLImageElement?(p.width=N.naturalWidth||N.width,p.height=N.naturalHeight||N.height):typeof VideoFrame<"u"&&N instanceof VideoFrame?(p.width=N.displayWidth,p.height=N.displayHeight):(p.width=N.width,p.height=N.height),p}this.allocateTextureUnit=st,this.resetTextureUnits=Y,this.setTexture2D=rt,this.setTexture2DArray=O,this.setTexture3D=G,this.setTextureCube=W,this.rebindTextures=Ce,this.setupRenderTarget=ne,this.updateRenderTargetMipmap=fe,this.updateMultisampleRenderTarget=It,this.setupDepthRenderbuffer=ee,this.setupFrameBufferTexture=At,this.useMultisampledRTT=Dt}function cE(o,e){function i(r,l=Wa){let u;const d=Oe.getTransfer(l);if(r===da)return o.UNSIGNED_BYTE;if(r===gh)return o.UNSIGNED_SHORT_4_4_4_4;if(r===_h)return o.UNSIGNED_SHORT_5_5_5_1;if(r===_g)return o.UNSIGNED_INT_5_9_9_9_REV;if(r===vg)return o.UNSIGNED_INT_10F_11F_11F_REV;if(r===xg)return o.BYTE;if(r===gg)return o.SHORT;if(r===Uo)return o.UNSIGNED_SHORT;if(r===xh)return o.INT;if(r===Tr)return o.UNSIGNED_INT;if(r===ca)return o.FLOAT;if(r===As)return o.HALF_FLOAT;if(r===Sg)return o.ALPHA;if(r===Mg)return o.RGB;if(r===Ei)return o.RGBA;if(r===No)return o.DEPTH_COMPONENT;if(r===Oo)return o.DEPTH_STENCIL;if(r===yg)return o.RED;if(r===vh)return o.RED_INTEGER;if(r===Sh)return o.RG;if(r===Mh)return o.RG_INTEGER;if(r===yh)return o.RGBA_INTEGER;if(r===Mc||r===yc||r===bc||r===Ec)if(d===Xe)if(u=e.get("WEBGL_compressed_texture_s3tc_srgb"),u!==null){if(r===Mc)return u.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(r===yc)return u.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(r===bc)return u.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(r===Ec)return u.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(u=e.get("WEBGL_compressed_texture_s3tc"),u!==null){if(r===Mc)return u.COMPRESSED_RGB_S3TC_DXT1_EXT;if(r===yc)return u.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(r===bc)return u.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(r===Ec)return u.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(r===Fd||r===Id||r===Bd||r===Hd)if(u=e.get("WEBGL_compressed_texture_pvrtc"),u!==null){if(r===Fd)return u.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(r===Id)return u.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(r===Bd)return u.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(r===Hd)return u.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(r===Gd||r===Vd||r===kd)if(u=e.get("WEBGL_compressed_texture_etc"),u!==null){if(r===Gd||r===Vd)return d===Xe?u.COMPRESSED_SRGB8_ETC2:u.COMPRESSED_RGB8_ETC2;if(r===kd)return d===Xe?u.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:u.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(r===Xd||r===Wd||r===qd||r===Yd||r===jd||r===Zd||r===Kd||r===Qd||r===Jd||r===$d||r===th||r===eh||r===nh||r===ih)if(u=e.get("WEBGL_compressed_texture_astc"),u!==null){if(r===Xd)return d===Xe?u.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:u.COMPRESSED_RGBA_ASTC_4x4_KHR;if(r===Wd)return d===Xe?u.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:u.COMPRESSED_RGBA_ASTC_5x4_KHR;if(r===qd)return d===Xe?u.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:u.COMPRESSED_RGBA_ASTC_5x5_KHR;if(r===Yd)return d===Xe?u.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:u.COMPRESSED_RGBA_ASTC_6x5_KHR;if(r===jd)return d===Xe?u.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:u.COMPRESSED_RGBA_ASTC_6x6_KHR;if(r===Zd)return d===Xe?u.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:u.COMPRESSED_RGBA_ASTC_8x5_KHR;if(r===Kd)return d===Xe?u.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:u.COMPRESSED_RGBA_ASTC_8x6_KHR;if(r===Qd)return d===Xe?u.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:u.COMPRESSED_RGBA_ASTC_8x8_KHR;if(r===Jd)return d===Xe?u.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:u.COMPRESSED_RGBA_ASTC_10x5_KHR;if(r===$d)return d===Xe?u.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:u.COMPRESSED_RGBA_ASTC_10x6_KHR;if(r===th)return d===Xe?u.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:u.COMPRESSED_RGBA_ASTC_10x8_KHR;if(r===eh)return d===Xe?u.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:u.COMPRESSED_RGBA_ASTC_10x10_KHR;if(r===nh)return d===Xe?u.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:u.COMPRESSED_RGBA_ASTC_12x10_KHR;if(r===ih)return d===Xe?u.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:u.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(r===ah||r===rh||r===sh)if(u=e.get("EXT_texture_compression_bptc"),u!==null){if(r===ah)return d===Xe?u.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:u.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(r===rh)return u.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(r===sh)return u.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(r===oh||r===lh||r===ch||r===uh)if(u=e.get("EXT_texture_compression_rgtc"),u!==null){if(r===oh)return u.COMPRESSED_RED_RGTC1_EXT;if(r===lh)return u.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(r===ch)return u.COMPRESSED_RED_GREEN_RGTC2_EXT;if(r===uh)return u.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return r===Lo?o.UNSIGNED_INT_24_8:o[r]!==void 0?o[r]:null}return{convert:i}}const uE=`
void main() {
...
}`;class dE{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(e,i){if(this.texture===null){const r=new Fg(e.texture);(e.depthNear!==i.depthNear||e.depthFar!==i.depthFar)&&(this.depthNear=e.depthNear,this.depthFar=e.depthFar),this.texture=r}}getMesh(e){if(this.texture!==null&&this.mesh===null){const i=e.cameras[0].viewport,r=new Li({vertexShader:uE,fragmentShader:fE,uniforms:{depthColor:{value:this.texture},depthWidth:{value:i.z},depthHeight:{value:i.w}}});this.mesh=new Za(new Uc(20,20),r)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}}class hE extends Rs{constructor(e,i){super();const r=this;let l=null,u=1,d=null,h="local-floor",m=1,p=null,v=null,g=null,S=null,y=null,A=null;const C=typeof XRWebGLBinding<"u",M=new dE,_={},P=i.getContextAttributes();let L=null,H=null;const X=[],U=[],z=new We;let Q=null;const w=new yi;w.viewport=new sn;const T=new yi;T.viewport=new sn;const I=[w,T],Y=new LM;let st=null,ct=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(J){let dt=X[J];return dt===void 0&&(dt=new xd,X[J]=dt),dt.getTargetRaySpace()},this.getControllerGrip=function(J){let dt=X[J];return dt===void 0&&(dt=new xd,X[J]=dt),dt.getGripSpace()},this.getHand=function(J){let dt=X[J];return dt===void 0&&(dt=new xd,X[J]=dt),dt.getHandSpace()};function rt(J){const dt=U.indexOf(J.inputSource);if(dt===-1)return;const At=X[dt];At!==void 0&&(At.update(J.inputSource,J.frame,p||d),At.dispatchEvent({type:J.type,data:J.inputSource}))}function O(){l.removeEventListener("select",rt),l.removeEventListener("selectstart",rt),l.removeEventListener("selectend",rt),l.removeEventListener("squeeze",rt),l.removeEventListener("squeezestart",rt),l.removeEventListener("squeezeend",rt),l.removeEventListener("end",O),l.removeEventListener("inputsourceschange",G);for(let J=0;J<X.length;J++){const dt=U[J];dt!==null&&(U[J]=null,X[J].disconnect(dt))}st=null,ct=null,M.reset();for(const J in _)delete _[J];e.setRenderTarget(L),y=null,S=null,g=null,l=null,H=null,Mt.stop(),r.isPresenting=!1,e.setPixelRatio(Q),e.setSize(z.width,z.height,!1),r.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(J){u=J,r.isPresenting===!0&&pe("WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(J){h=J,r.isPresenting===!0&&pe("WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return p||d},this.setReferenceSpace=function(J){p=J},this.getBaseLayer=function(){return S!==null?S:y},this.getBinding=function(){return g===null&&C&&(g=new XRWebGLBinding(l,i)),g},this.getFrame=function(){return A},this.getSession=function(){return l},this.setSession=async function(J){if(l=J,l!==null){if(L=e.getRenderTarget(),l.addEventListener("select",rt),l.addEventListener("selectstart",rt),l.addEventListener("selectend",rt),l.addEventListener("squeeze",rt),l.addEventListener("squeezestart",rt),l.addEventListener("squeezeend",rt),l.addEventListener("end",O),l.addEventListener("inputsourceschange",G),P.xrCompatible!==!0&&await i.makeXRCompatible(),Q=e.getPixelRatio(),e.getSize(z),C&&"createProjectionLayer"in XRWebGLBinding.prototype){let At=null,Pt=null,Nt=null;P.depth&&(Nt=P.stencil?i.DEPTH24_STENCIL8:i.DEPTH_COMPONENT24,At=P.stencil?Oo:No,Pt=P.stencil?Lo:Tr);const ee={colorFormat:i.RGBA8,depthFormat:Nt,scaleFactor:u};g=this.getBinding(),S=g.createProjectionLayer(ee),l.updateRenderState({layers:[S]}),e.setPixelRatio(1),e.setSize(S.textureWidth,S.textureHeight,!1),H=new Ar(S.textureWidth,S.textureHeight,{format:Ei,type:da,depthTexture:new zg(S.textureWidth,S.textureHeight,Pt,void 0,void 0,void 0,void 0,void 0,void 0,At),stencilBuffer:P.stencil,colorSpace:e.outputColorSpace,samples:P.antialias?4:0,resolveDepthBuffer:S.ignoreDepthValues===!1,resolveStencilBuffer:S.ignoreDepthValues===!1})}else{const At={antialias:P.antialias,alpha:!0,depth:P.depth,stencil:P.stencil,framebufferScaleFactor:u};y=new XRWebGLLayer(l,i,At),l.updateRenderState({baseLayer:y}),e.setPixelRatio(1),e.setSize(y.framebufferWidth,y.framebufferHeight,!1),H=new Ar(y.framebufferWidth,y.framebufferHeight,{format:Ei,type:da,colorSpace:e.outputColorSpace,stencilBuffer:P.stencil,resolveDepthBuffer:y.ignoreDepthValues===!1,resolveStencilBuffer:y.ignoreDepthValues===!1})}H.isXRRenderTarget=!0,this.setFoveation(m),p=null,d=await l.requestReferenceSpace(h),Mt.setContext(l),Mt.start(),r.isPresenting=!0,r.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(l!==null)return l.environmentBlendMode},this.getDepthTexture=function(){return M.getDepthTexture()};function G(J){for(let dt=0;dt<J.removed.length;dt++){const At=J.removed[dt],Pt=U.indexOf(At);Pt>=0&&(U[Pt]=null,X[Pt].disconnect(At))}for(let dt=0;dt<J.added.length;dt++){const At=J.added[dt];let Pt=U.indexOf(At);if(Pt===-1){for(let ee=0;ee<X.length;ee++)if(ee>=U.length){U.push(At),Pt=ee;break}else if(U[ee]===null){U[ee]=At,Pt=ee;break}if(Pt===-1)break}const Nt=X[Pt];Nt&&Nt.connect(At)}}const W=new pt,ut=new pt;function ot(J,dt,At){W.setFromMatrixPosition(dt.matrixWorld),ut.setFromMatrixPosition(At.matrixWorld);const Pt=W.distanceTo(ut),Nt=dt.projectionMatrix.elements,ee=At.projectionMatrix.elements,Ce=Nt[14]/(Nt[10]-1),ne=Nt[14]/(Nt[10]+1),fe=(Nt[9]+1)/Nt[5],F=(Nt[9]-1)/Nt[5],Qt=(Nt[8]-1)/Nt[0],It=(ee[8]+1)/ee[0],jt=Ce*Qt,Dt=Ce*It,ve=Pt/(-Qt+It),Ht=ve*-Qt;if(dt.matrixWorld.decompose(J.position,J.quaternion,J.scale),J.translateX(Ht),J.translateZ(ve),J.matrixWorld.compose(J.position,J.quaternion,J.scale),J.matrixWorldInverse.copy(J.matrixWorld).invert(),Nt[10]===-1)J.projectionMatrix.copy(dt.projectionMatrix),J.projectionMatrixInverse.copy(dt.projectionMatrixInverse);else{const Jt=Ce+ve,N=ne+ve,b=jt-Ht,$=Dt+(Pt-Ht),gt=fe*ne/N*Jt,yt=F*ne/N*Jt;J.projectionMatrix.makePerspective(b,$,gt,yt,Jt,N),J.projectionMatrixInverse.copy(J.projectionMatrix).invert()}}function D(J,dt){dt===null?J.matrixWorld.copy(J.matrix):J.matrixWorld.multiplyMatrices(dt.matrixWorld,J.matrix),J.matrixWorldInverse.copy(J.matrixWorld).invert()}this.updateCamera=function(J){if(l===null)return;let dt=J.near,At=J.far;M.texture!==null&&(M.depthNear>0&&(dt=M.depthNear),M.depthFar>0&&(At=M.depthFar)),Y.near=T.near=w.near=dt,Y.far=T.far=w.far=At,(st!==Y.near||ct!==Y.far)&&(l.updateRenderState({depthNear:Y.near,depthFar:Y.far}),st=Y.near,ct=Y.far),Y.layers.mask=J.layers.mask|6,w.layers.mask=Y.layers.mask&3,T.layers.mask=Y.layers.mask&5;const Pt=J.parent,Nt=Y.cameras;D(Y,Pt);for(let ee=0;ee<Nt.length;ee++)D(Nt[ee],Pt);Nt.length===2?ot(Y,w,T):Y.projectionMatrix.copy(w.projectionMatrix),q(J,Y,Pt)};function q(J,dt,At){At===null?J.matrix.copy(dt.matrixWorld):(J.matrix.copy(At.matrixWorld),J.matrix.invert(),J.matrix.multiply(dt.matrixWorld)),J.matrix.decompose(J.position,J.quaternion,J.scale),J.updateMatrixWorld(!0),J.projectionMatrix.copy(dt.projectionMatrix),J.projectionMatrixInverse.copy(dt.projectionMatrixInverse),J.isPerspectiveCamera&&(J.fov=fh*2*Math.atan(1/J.projectionMatrix.elements[5]),J.zoom=1)}this.getCamera=function(){return Y},this.getFoveation=function(){if(!(S===null&&y===null))return m},this.setFoveation=function(J){m=J,S!==null&&(S.fixedFoveation=J),y!==null&&y.fixedFoveation!==void 0&&(y.fixedFoveation=J)},this.hasDepthSensing=function(){return M.texture!==null},this.getDepthSensingMesh=function(){return M.getMesh(Y)},this.getCameraTexture=function(J){return _[J]};let mt=null;function ft(J,dt){if(v=dt.getViewerPose(p||d),A=dt,v!==null){const At=v.views;y!==null&&(e.setRenderTargetFramebuffer(H,y.framebuffer),e.setRenderTarget(H));let Pt=!1;At.length!==Y.cameras.length&&(Y.cameras.length=0,Pt=!0);for(let ne=0;ne<At.length;ne++){const fe=At[ne];let F=null;if(y!==null)F=y.getViewport(fe);else{const It=g.getViewSubImage(S,fe);F=It.viewport,ne===0&&(e.setRenderTargetTextures(H,It.colorTexture,It.depthStencilTexture),e.setRenderTarget(H))}let Qt=I[ne];Qt===void 0&&(Qt=new yi,Qt.layers.enable(ne),Qt.viewport=new sn,I[ne]=Qt),Qt.matrix.fromArray(fe.transform.matrix),Qt.matrix.decompose(Qt.position,Qt.quaternion,Qt.scale),Qt.projectionMatrix.fromArray(fe.projectionMatrix),Qt.projectionMatrixInverse.copy(Qt.projectionMatrix).invert(),Qt.viewport.set(F.x,F.y,F.width,F.height),ne===0&&(Y.matrix.copy(Qt.matrix),Y.matrix.decompose(Y.position,Y.quaternion,Y.scale)),Pt===!0&&Y.cameras.push(Qt)}const Nt=l.enabledFeatures;if(Nt&&Nt.includes("depth-sensing")&&l.depthUsage=="gpu-optimized"&&C){g=r.getBinding();const ne=g.getDepthInformation(At[0]);ne&&ne.isValid&&ne.texture&&M.init(ne,l.renderState)}if(Nt&&Nt.includes("camera-access")&&C){e.state.unbindTexture(),g=r.getBinding();for(let ne=0;ne<At.length;ne++){const fe=At[ne].camera;if(fe){let F=_[fe];F||(F=new Fg,_[fe]=F);const Qt=g.getCameraImage(fe);F.sourceTexture=Qt}}}}for(let At=0;At<X.length;At++){const Pt=U[At],Nt=X[At];Pt!==null&&Nt!==void 0&&Nt.update(Pt,dt,p||d)}mt&&mt(J,dt),dt.detectedPlanes&&r.dispatchEvent({type:"planesdetected",data:dt}),A=null}const Mt=new Bg;Mt.setAnimationLoop(ft),this.setAnimationLoop=function(J){mt=J},this.dispose=function(){}}}const vr=new ha,pE=new hn;function mE(o,e){function i(M,_){M.matrixAutoUpdate===!0&&M.updateMatrix(),_.value.copy(M.matrix)}function r(M,_){_.color.getRGB(M.fogColor.value,Lg(o)),_.isFog?(M.fogNear.value=_.near,M.fogFar.value=_.far):_.isFogExp2&&(M.fogDensity.value=_.density)}function l(M,_,P,L,H){_.isMeshBasicMaterial||_.isMeshLambertMaterial?u(M,_):_.isMeshToonMaterial?(u(M,_),g(M,_)):_.isMeshPhongMaterial?(u(M,_),v(M,_)):_.isMeshStandardMaterial?(u(M,_),S(M,_),_.isMeshPhysicalMaterial&&y(M,_,H)):_.isMeshMatcapMaterial?(u(M,_),A(M,_)):_.isMeshDepthMaterial?u(M,_):_.isMeshDistanceMaterial?(u(M,_),C(M,_)):_.isMeshNormalMaterial?u(M,_):_.isLineBasicMaterial?(d(M,_),_.isLineDashedMaterial&&h(M,_)):_.isPointsMaterial?m(M,_,P,L):_.isSpriteMaterial?p(M,_):_.isShadowMaterial?(M.color.value.copy(_.color),M.opacity.value=_.opacity):_.isShaderMaterial&&(_.uniformsNeedUpdate=!1)}function u(M,_){M.opacity.value=_.opacity,_.color&&M.diffuse.value.copy(_.color),_.emissive&&M.emissive.value.copy(_.emissive).multiplyScalar(_.emissiveIntensity),_.map&&(M.map.value=_.map,i(_.map,M.mapTransform)),_.alphaMap&&(M.alphaMap.value=_.alphaMap,i(_.alphaMap,M.alphaMapTransform)),_.bumpMap&&(M.bumpMap.value=_.bumpMap,i(_.bumpMap,M.bumpMapTransform),M.bumpScale.value=_.bumpScale,_.side===kn&&(M.bumpScale.value*=-1)),_.normalMap&&(M.normalMap.value=_.normalMap,i(_.normalMap,M.normalMapTransform),M.normalScale.value.copy(_.normalScale),_.side===kn&&M.normalScale.value.negate()),_.displacementMap&&(M.displacementMap.value=_.displacementMap,i(_.displacementMap,M.displacementMapTransform),M.displacementScale.value=_.displacementScale,M.displacementBias.value=_.displacementBias),_.emissiveMap&&(M.emissiveMap.value=_.emissiveMap,i(_.emissiveMap,M.emissiveMapTransform)),_.specularMap&&(M.specularMap.value=_.specularMap,i(_.specularMap,M.specularMapTransform)),_.alphaTest>0&&(M.alphaTest.value=_.alphaTest);const P=e.get(_),L=P.envMap,H=P.envMapRotation;L&&(M.envMap.value=L,vr.copy(H),vr.x*=-1,vr.y*=-1,vr.z*=-1,L.isCubeTexture&&L.isRenderTargetTexture===!1&&(vr.y*=-1,vr.z*=-1),M.envMapRotation.value.setFromMatrix4(pE.makeRotationFromEuler(vr)),M.flipEnvMap.value=L.isCubeTexture&&L.isRenderTargetTexture===!1?-1:1,M.reflectivity.value=_.reflectivity,M.ior.value=_.ior,M.refractionRatio.value=_.refractionRatio),_.lightMap&&(M.lightMap.value=_.lightMap,M.lightMapIntensity.value=_.lightMapIntensity,i(_.lightMap,M.lightMapTransform)),_.aoMap&&(M.aoMap.value=_.aoMap,M.aoMapIntensity.value=_.aoMapIntensity,i(_.aoMap,M.aoMapTransform))}function d(M,_){M.diffuse.value.copy(_.color),M.opacity.value=_.opacity,_.map&&(M.map.value=_.map,i(_.map,M.mapTransform))}function h(M,_){M.dashSize.value=_.dashSize,M.totalSize.value=_.dashSize+_.gapSize,M.scale.value=_.scale}function m(M,_,P,L){M.diffuse.value.copy(_.color),M.opacity.value=_.opacity,M.size.value=_.size*P,M.scale.value=L*.5,_.map&&(M.map.value=_.map,i(_.map,M.uvTransform)),_.alphaMap&&(M.alphaMap.value=_.alphaMap,i(_.alphaMap,M.alphaMapTransform)),_.alphaTest>0&&(M.alphaTest.value=_.alphaTest)}function p(M,_){M.diffuse.value.copy(_.color),M.opacity.value=_.opacity,M.rotation.value=_.rotation,_.map&&(M.map.value=_.map,i(_.map,M.mapTransform)),_.alphaMap&&(M.alphaMap.value=_.alphaMap,i(_.alphaMap,M.alphaMapTransform)),_.alphaTest>0&&(M.alphaTest.value=_.alphaTest)}function v(M,_){M.specular.value.copy(_.specular),M.shininess.value=Math.max(_.shininess,1e-4)}function g(M,_){_.gradientMap&&(M.gradientMap.value=_.gradientMap)}function S(M,_){M.metalness.value=_.metalness,_.metalnessMap&&(M.metalnessMap.value=_.metalnessMap,i(_.metalnessMap,M.metalnessMapTransform)),M.roughness.value=_.roughness,_.roughnessMap&&(M.roughnessMap.value=_.roughnessMap,i(_.roughnessMap,M.roughnessMapTransform)),_.envMap&&(M.envMapIntensity.value=_.envMapIntensity)}function y(M,_,P){M.ior.value=_.ior,_.sheen>0&&(M.sheenColor.value.copy(_.sheenColor).multiplyScalar(_.sheen),M.sheenRoughness.value=_.sheenRoughness,_.sheenColorMap&&(M.sheenColorMap.value=_.sheenColorMap,i(_.sheenColorMap,M.sheenColorMapTransform)),_.sheenRoughnessMap&&(M.sheenRoughnessMap.value=_.sheenRoughnessMap,i(_.sheenRoughnessMap,M.sheenRoughnessMapTransform))),_.clearcoat>0&&(M.clearcoat.value=_.clearcoat,M.clearcoatRoughness.value=_.clearcoatRoughness,_.clearcoatMap&&(M.clearcoatMap.value=_.clearcoatMap,i(_.clearcoatMap,M.clearcoatMapTransform)),_.clearcoatRoughnessMap&&(M.clearcoatRoughnessMap.value=_.clearcoatRoughnessMap,i(_.clearcoatRoughnessMap,M.clearcoatRoughnessMapTransform)),_.clearcoatNormalMap&&(M.clearcoatNormalMap.value=_.clearcoatNormalMap,i(_.clearcoatNormalMap,M.clearcoatNormalMapTransform),M.clearcoatNormalScale.value.copy(_.clearcoatNormalScale),_.side===kn&&M.clearcoatNormalScale.value.negate())),_.dispersion>0&&(M.dispersion.value=_.dispersion),_.iridescence>0&&(M.iridescence.value=_.iridescence,M.iridescenceIOR.value=_.iridescenceIOR,M.iridescenceThicknessMinimum.value=_.iridescenceThicknessRange[0],M.iridescenceThicknessMaximum.value=_.iridescenceThicknessRange[1],_.iridescenceMap&&(M.iridescenceMap.value=_.iridescenceMap,i(_.iridescenceMap,M.iridescenceMapTransform)),_.iridescenceThicknessMap&&(M.iridescenceThicknessMap.value=_.iridescenceThicknessMap,i(_.iridescenceThicknessMap,M.iridescenceThicknessMapTransform))),_.transmission>0&&(M.transmission.value=_.transmission,M.transmissionSamplerMap.value=P.texture,M.transmissionSamplerSize.value.set(P.width,P.height),_.transmissionMap&&(M.transmissionMap.value=_.transmissionMap,i(_.transmissionMap,M.transmissionMapTransform)),M.thickness.value=_.thickness,_.thicknessMap&&(M.thicknessMap.value=_.thicknessMap,i(_.thicknessMap,M.thicknessMapTransform)),M.attenuationDistance.value=_.attenuationDistance,M.attenuationColor.value.copy(_.attenuationColor)),_.anisotropy>0&&(M.anisotropyVector.value.set(_.anisotropy*Math.cos(_.anisotropyRotation),_.anisotropy*Math.sin(_.anisotropyRotation)),_.anisotropyMap&&(M.anisotropyMap.value=_.anisotropyMap,i(_.anisotropyMap,M.anisotropyMapTransform))),M.specularIntensity.value=_.specularIntensity,M.specularColor.value.copy(_.specularColor),_.specularColorMap&&(M.specularColorMap.value=_.specularColorMap,i(_.specularColorMap,M.specularColorMapTransform)),_.specularIntensityMap&&(M.specularIntensityMap.value=_.specularIntensityMap,i(_.specularIntensityMap,M.specularIntensityMapTransform))}function A(M,_){_.matcap&&(M.matcap.value=_.matcap)}function C(M,_){const P=e.get(_).light;M.referencePosition.value.setFromMatrixPosition(P.matrixWorld),M.nearDistance.value=P.shadow.camera.near,M.farDistance.value=P.shadow.camera.far}return{refreshFogUniforms:r,refreshMaterialUniforms:l}}function xE(o,e,i,r){let l={},u={},d=[];const h=o.getParameter(o.MAX_UNIFORM_BUFFER_BINDINGS);function m(P,L){const H=L.program;r.uniformBlockBinding(P,H)}function p(P,L){let H=l[P.id];H===void 0&&(A(P),H=v(P),l[P.id]=H,P.addEventListener("dispose",M));const X=L.program;r.updateUBOMapping(P,X);const U=e.render.frame;u[P.id]!==U&&(S(P),u[P.id]=U)}function v(P){const L=g();P.__bindingPointIndex=L;const H=o.createBuffer(),X=P.__size,U=P.usage;return o.bindBuffer(o.UNIFORM_BUFFER,H),o.bufferData(o.UNIFORM_BUFFER,X,U),o.bindBuffer(o.UNIFORM_BUFFER,null),o.bindBufferBase(o.UNIFORM_BUFFER,L,H),H}function g(){for(let P=0;P<h;P++)if(d.indexOf(P)===-1)return d.push(P),P;return rn("WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function S(P){const L=l[P.id],H=P.uniforms,X=P.__cache;o.bindBuffer(o.UNIFORM_BUFFER,L);for(let U=0,z=H.length;U<z;U++){const Q=Array.isArray(H[U])?H[U]:[H[U]];for(let w=0,T=Q.length;w<T;w++){const I=Q[w];if(y(I,U,w,X)===!0){const Y=I.__offset,st=Array.isArray(I.value)?I.value:[I.value];let ct=0;for(let rt=0;rt<st.length;rt++){const O=st[rt],G=C(O);typeof O=="number"||typeof O=="boolean"?(I.__data[0]=O,o.bufferSubData(o.UNIFORM_BUFFER,Y+ct,I.__data)):O.isMatrix3?(I.__data[0]=O.elements[0],I.__data[1]=O.elements[1],I.__data[2]=O.elements[2],I.__data[3]=0,I.__data[4]=O.elements[3],I.__data[5]=O.elements[4],I.__data[6]=O.elements[5],I.__data[7]=0,I.__data[8]=O.elements[6],I.__data[9]=O.elements[7],I.__data[10]=O.elements[8],I.__data[11]=0):(O.toArray(I.__data,ct),ct+=G.storage/Float32Array.BYTES_PER_ELEMENT)}o.bufferSubData(o.UNIFORM_BUFFER,Y,I.__data)}}}o.bindBuffer(o.UNIFORM_BUFFER,null)}function y(P,L,H,X){const U=P.value,z=L+"_"+H;if(X[z]===void 0)return typeof U=="number"||typeof U=="boolean"?X[z]=U:X[z]=U.clone(),!0;{const Q=X[z];if(typeof U=="number"||typeof U=="boolean"){if(Q!==U)return X[z]=U,!0}else if(Q.equals(U)===!1)return Q.copy(U),!0}return!1}function A(P){const L=P.uniforms;let H=0;const X=16;for(let z=0,Q=L.length;z<Q;z++){const w=Array.isArray(L[z])?L[z]:[L[z]];for(let T=0,I=w.length;T<I;T++){const Y=w[T],st=Array.isArray(Y.value)?Y.value:[Y.value];for(let ct=0,rt=st.length;ct<rt;ct++){const O=st[ct],G=C(O),W=H%X,ut=W%G.boundary,ot=W+ut;H+=ut,ot!==0&&X-ot<G.storage&&(H+=X-ot),Y.__data=new Float32Array(G.storage/Float32Array.BYTES_PER_ELEMENT),Y.__offset=H,H+=G.storage}}}const U=H%X;return U>0&&(H+=X-U),P.__size=H,P.__cache={},this}function C(P){const L={boundary:0,storage:0};return typeof P=="number"||typeof P=="boolean"?(L.boundary=4,L.storage=4):P.isVector2?(L.boundary=8,L.storage=8):P.isVector3||P.isColor?(L.boundary=16,L.storage=12):P.isVector4?(L.boundary=16,L.storage=16):P.isMatrix3?(L.boundary=48,L.storage=48):P.isMatrix4?(L.boundary=64,L.storage=64):P.isTexture?pe("WebGLRenderer: Texture samplers can not be part of an uniforms group."):pe("WebGLRenderer: Unsupported uniform value type.",P),L}function M(P){const L=P.target;L.removeEventListener("dispose",M);const H=d.indexOf(L.__bindingPointIndex);d.splice(H,1),o.deleteBuffer(l[L.id]),delete l[L.id],delete u[L.id]}function _(){for(const P in l)o.deleteBuffer(l[P]);d=[],l={},u={}}return{bind:m,update:p,dispose:_}}const gE=new Uint16Array([11481,15204,11534,15171,11808,15015,12385,14843,12894,14716,13396,14600,13693,14483,13976,14366,14237,14171,14405,13961,14511,13770,14605,13598,14687,13444,14760,13305,14822,13066,14876,12857,14923,12675,14963,12517,14997,12379,15025,12230,15049,12023,15070,11843,15086,11687,15100,11551,15111,11433,15120,11330,15127,11217,15132,11060,15135,10922,15138,10801,15139,10695,15139,10600,13012,14923,13020,14917,13064,14886,13176,14800,13349,14666,13513,14526,13724,14398,13960,14230,14200,14020,14383,13827,14488,13651,14583,13491,14667,13348,14740,13132,14803,12908,14856,12713,14901,12542,14938,12394,14968,12241,14992,12017,15010,11822,15024,11654,15034,11507,15041,11380,15044,11269,15044,11081,15042,10913,15037,10764,15031,10635,15023,10520,15014,10419,15003,10330,13657,14676,13658,14673,13670,14660,13698,14622,13750,14547,13834,14442,13956,14317,14112,14093,14291,13889,14407,13704,14499,13538,14586,13389,14664,13201,14733,12966,14792,12758,14842,12577,14882,12418,14915,12272,14940,12033,14959,11826,14972,11646,14980,11490,14983,11355,14983,11212,14979,11008,14971,10830,14961,10675,14950,10540,14936,10420,14923,10315,14909,10204,14894,10041,14089,14460,14090,14459,14096,14452,14112,14431,14141,14388,14186,14305,14252,14130,14341,13941,14399,13756,14467,13585,14539,13430,14610,13272,14677,13026,14737,12808,14790,12617,14833,12449,14869,12303,14896,12065,14916,11845,14929,11655,14937,11490,14939,11347,14936,11184,14930,10970,14921,10783,14912,10621,14900,10480,14885,10356,14867,10247,14848,10062,14827,9894,14805,9745,14400,14208,14400,14206,14402,14198,14406,14174,14415,14122,14427,14035,14444,13913,14469,13767,14504,13613,14548,13463,14598,13324,14651,13082,14704,12858,14752,12658,14795,12483,14831,12330,14860,12106,14881,11875,14895,11675,14903,11501,14905,11351,14903,11178,14900,10953,14892,10757,14880,10589,14865,10442,14847,10313,14827,10162,14805,9965,14782,9792,14757,9642,14731,9507,14562,13883,14562,13883,14563,13877,14566,13862,14570,13830,14576,13773,14584,13689,14595,13582,14613,13461,14637,13336,14668,13120,14704,12897,14741,12695,14776,12516,14808,12358,14835,12150,14856,11910,14870,11701,14878,11519,14882,11361,14884,11187,14880,10951,14871,10748,14858,10572,14842,10418,14823,10286,14801,10099,14777,9897,14751,9722,14725,9567,14696,9430,14666,9309,14702,13604,14702,13604,14702,13600,14703,13591,14705,13570,14707,13533,14709,13477,14712,13400,14718,13305,14727,13106,14743,12907,14762,12716,14784,12539,14807,12380,14827,12190,14844,11943,14855,11727,14863,11539,14870,11376,14871,11204,14868,10960,14858,10748,14845,10565,14829,10406,14809,10269,14786,10058,14761,9852,14734,9671,14705,9512,14674,9374,14641,9253,14608,9076,14821,13366,14821,13365,14821,13364,14821,13358,14821,13344,14821,13320,14819,13252,14817,13145,14815,13011,14814,12858,14817,12698,14823,12539,14832,12389,14841,12214,14850,11968,14856,11750,14861,11558,14866,11390,14867,11226,14862,10972,14853,10754,14840,10565,14823,10401,14803,10259,14780,10032,14754,9820,14725,9635,14694,9473,14661,9333,14627,9203,14593,8988,14557,8798,14923,13014,14922,13014,14922,13012,14922,13004,14920,12987,14919,12957,14915,12907,14909,12834,14902,12738,14894,12623,14888,12498,14883,12370,14880,12203,14878,11970,14875,11759,14873,11569,14874,11401,14872,11243,14865,10986,14855,10762,14842,10568,14825,10401,14804,10255,14781,10017,14754,9799,14725,9611,14692,9445,14658,9301,14623,9139,14587,8920,14548,8729,14509,8562,15008,12672,15008,12672,15008,12671,15007,12667,15005,12656,15001,12637,14997,12605,14989,12556,14978,12490,14966,12407,14953,12313,14940,12136,14927,11934,14914,11742,14903,11563,14896,11401,14889,11247,14879,10992,14866,10767,14851,10570,14833,10400,14812,10252,14789,10007,14761,9784,14731,9592,14698,9424,14663,9279,14627,9088,14588,8868,14548,8676,14508,8508,14467,8360,15080,12386,15080,12386,15079,12385,15078,12383,15076,12378,15072,12367,15066,12347,15057,12315,15045,12253,15030,12138,15012,11998,14993,11845,14972,11685,14951,11530,14935,11383,14920,11228,14904,10981,14887,10762,14870,10567,14850,10397,14827,10248,14803,9997,14774,9771,14743,9578,14710,9407,14674,9259,14637,9048,14596,8826,14555,8632,14514,8464,14471,8317,14427,8182,15139,12008,15139,12008,15138,12008,15137,12007,15135,12003,15130,11990,15124,11969,15115,11929,15102,11872,15086,11794,15064,11693,15041,11581,15013,11459,14987,11336,14966,11170,14944,10944,14921,10738,14898,10552,14875,10387,14850,10239,14824,9983,14794,9758,14762,9563,14728,9392,14692,9244,14653,9014,14611,8791,14569,8597,14526,8427,14481,8281,14436,8110,14391,7885,15188,11617,15188,11617,15187,11617,15186,11618,15183,11617,15179,11612,15173,11601,15163,11581,15150,11546,15133,11495,15110,11427,15083,11346,15051,11246,15024,11057,14996,10868,14967,10687,14938,10517,14911,10362,14882,10206,14853,9956,14821,9737,14787,9543,14752,9375,14715,9228,14675,8980,14632,8760,14589,8565,14544,8395,14498,8248,14451,8049,14404,7824,14357,7630,15228,11298,15228,11298,15227,11299,15226,11301,15223,11303,15219,11302,15213,11299,15204,11290,15191,11271,15174,11217,15150,11129,15119,11015,15087,10886,15057,10744,15024,10599,14990,10455,14957,10318,14924,10143,14891,9911,14856,9701,14820,9516,14782,9352,14744,9200,14703,8946,14659,8725,14615,8533,14568,8366,14521,8220,14472,7992,14423,7770,14374,7578,14315,7408,15260,10819,15260,10819,15259,10822,15258,10826,15256,10832,15251,10836,15246,10841,15237,10838,15225,10821,15207,10788,15183,10734,15151,10660,15120,10571,15087,10469,15049,10359,15012,10249,14974,10041,14937,9837,14900,9647,14860,9475,14820,9320,14779,9147,14736,8902,14691,8688,14646,8499,14598,8335,14549,8189,14499,7940,14448,7720,14397,7529,14347,7363,14256,7218,15285,10410,15285,10411,15285,10413,15284,10418,15282,10425,15278,10434,15272,10442,15264,10449,15252,10445,15235,10433,15210,10403,15179,10358,15149,10301,15113,10218,15073,10059,15033,9894,14991,9726,14951,9565,14909,9413,14865,9273,14822,9073,14777,8845,14730,8641,14682,8459,14633,8300,14583,8129,14531,7883,14479,7670,14426,7482,14373,7321,14305,7176,14201,6939,15305,9939,15305,9940,15305,9945,15304,9955,15302,9967,15298,9989,15293,10010,15286,10033,15274,10044,15258,10045,15233,10022,15205,9975,15174,9903,15136,9808,15095,9697,15053,9578,15009,9451,14965,9327,14918,9198,14871,8973,14825,8766,14775,8579,14725,8408,14675,8259,14622,8058,14569,7821,14515,7615,14460,7435,14405,7276,14350,7108,14256,6866,14149,6653,15321,9444,15321,9445,15321,9448,15320,9458,15317,9470,15314,9490,15310,9515,15302,9540,15292,9562,15276,9579,15251,9577,15226,9559,15195,9519,15156,9463,15116,9389,15071,9304,15025,9208,14978,9023,14927,8838,14878,8661,14827,8496,14774,8344,14722,8206,14667,7973,14612,7749,14556,7555,14499,7382,14443,7229,14385,7025,14322,6791,14210,6588,14100,6409,15333,8920,15333,8921,15332,8927,15332,8943,15329,8965,15326,9002,15322,9048,15316,9106,15307,9162,15291,9204,15267,9221,15244,9221,15212,9196,15175,9134,15133,9043,15088,8930,15040,8801,14990,8665,14938,8526,14886,8391,14830,8261,14775,8087,14719,7866,14661,7664,14603,7482,14544,7322,14485,7178,14426,6936,14367,6713,14281,6517,14166,6348,14054,6198,15341,8360,15341,8361,15341,8366,15341,8379,15339,8399,15336,8431,15332,8473,15326,8527,15318,8585,15302,8632,15281,8670,15258,8690,15227,8690,15191,8664,15149,8612,15104,8543,15055,8456,15001,8360,14948,8259,14892,8122,14834,7923,14776,7734,14716,7558,14656,7397,14595,7250,14534,7070,14472,6835,14410,6628,14350,6443,14243,6283,14125,6135,14010,5889,15348,7715,15348,7717,15348,7725,15347,7745,15345,7780,15343,7836,15339,7905,15334,8e3,15326,8103,15310,8193,15293,8239,15270,8270,15240,8287,15204,8283,15163,8260,15118,8223,15067,8143,15014,8014,14958,7873,14899,7723,14839,7573,14778,7430,14715,7293,14652,7164,14588,6931,14524,6720,14460,6531,14396,6362,14330,6210,14207,6015,14086,5781,13969,5576,15352,7114,15352,7116,15352,7128,15352,7159,15350,7195,15348,7237,15345,7299,15340,7374,15332,7457,15317,7544,15301,7633,15280,7703,15251,7754,15216,7775,15176,7767,15131,7733,15079,7670,15026,7588,14967,7492,14906,7387,14844,7278,14779,7171,14714,6965,14648,6770,14581,6587,14515,6420,14448,6269,14382,6123,14299,5881,14172,5665,14049,5477,13929,5310,15355,6329,15355,6330,15355,6339,15355,6362,15353,6410,15351,6472,15349,6572,15344,6688,15337,6835,15323,6985,15309,7142,15287,7220,15260,7277,15226,7310,15188,7326,15142,7318,15090,7285,15036,7239,14976,7177,14914,7045,14849,6892,14782,6736,14714,6581,14645,6433,14576,6293,14506,6164,14438,5946,14369,5733,14270,5540,14140,5369,14014,5216,13892,5043,15357,5483,15357,5484,15357,5496,15357,5528,15356,5597,15354,5692,15351,5835,15347,6011,15339,6195,15328,6317,15314,6446,15293,6566,15268,6668,15235,6746,15197,6796,15152,6811,15101,6790,15046,6748,14985,6673,14921,6583,14854,6479,14785,6371,14714,6259,14643,6149,14571,5946,14499,5750,14428,5567,14358,5401,14242,5250,14109,5111,13980,4870,13856,4657,15359,4555,15359,4557,15358,4573,15358,4633,15357,4715,15355,4841,15353,5061,15349,5216,15342,5391,15331,5577,15318,5770,15299,5967,15274,6150,15243,6223,15206,6280,15161,6310,15111,6317,15055,6300,14994,6262,14928,6208,14860,6141,14788,5994,14715,5838,14641,5684,14566,5529,14492,5384,14418,5247,14346,5121,14216,4892,14079,4682,13948,4496,13822,4330,15359,3498,15359,3501,15359,3520,15359,3598,15358,3719,15356,3860,15355,4137,15351,4305,15344,4563,15334,4809,15321,5116,15303,5273,15280,5418,15250,5547,15214,5653,15170,5722,15120,5761,15064,5763,15002,5733,14935,5673,14865,5597,14792,5504,14716,5400,14640,5294,14563,5185,14486,5041,14410,4841,14335,4655,14191,4482,14051,4325,13918,4183,13790,4012,15360,2282,15360,2285,15360,2306,15360,2401,15359,2547,15357,2748,15355,3103,15352,3349,15345,3675,15336,4020,15324,4272,15307,4496,15285,4716,15255,4908,15220,5086,15178,5170,15128,5214,15072,5234,15010,5231,14943,5206,14871,5166,14796,5102,14718,4971,14639,4833,14559,4687,14480,4541,14402,4401,14315,4268,14167,4142,14025,3958,13888,3747,13759,3556,15360,923,15360,925,15360,946,15360,1052,15359,1214,15357,1494,15356,1892,15352,2274,15346,2663,15338,3099,15326,3393,15309,3679,15288,3980,15260,4183,15226,4325,15185,4437,15136,4517,15080,4570,15018,4591,14950,4581,14877,4545,14800,4485,14720,4411,14638,4325,14556,4231,14475,4136,14395,3988,14297,3803,14145,3628,13999,3465,13861,3314,13729,3177,15360,263,15360,264,15360,272,15360,325,15359,407,15358,548,15356,780,15352,1144,15347,1580,15339,2099,15328,2425,15312,2795,15292,3133,15264,3329,15232,3517,15191,3689,15143,3819,15088,3923,15025,3978,14956,3999,14882,3979,14804,3931,14722,3855,14639,3756,14554,3645,14470,3529,14388,3409,14279,3289,14124,3173,13975,3055,13834,2848,13701,2658,15360,49,15360,49,15360,52,15360,75,15359,111,15358,201,15356,283,15353,519,15348,726,15340,1045,15329,1415,15314,1795,15295,2173,15269,2410,15237,2649,15197,2866,15150,3054,15095,3140,15032,3196,14963,3228,14888,3236,14808,3224,14725,3191,14639,3146,14553,3088,14466,2976,14382,2836,14262,2692,14103,2549,13952,2409,13808,2278,13674,2154,15360,4,15360,4,15360,4,15360,13,15359,33,15358,59,15357,112,15353,199,15348,302,15341,456,15331,628,15316,827,15297,1082,15272,1332,15241,1601,15202,1851,15156,2069,15101,2172,15039,2256,14970,2314,14894,2348,14813,2358,14728,2344,14640,2311,14551,2263,14463,2203,14376,2133,14247,2059,14084,1915,13930,1761,13784,1609,13648,1464,15360,0,15360,0,15360,0,15360,3,15359,18,15358,26,15357,53,15354,80,15348,97,15341,165,15332,238,15318,326,15299,427,15275,529,15245,654,15207,771,15161,885,15108,994,15046,1089,14976,1170,14900,1229,14817,1266,14731,1284,14641,1282,14550,1260,14460,1223,14370,1174,14232,1116,14066,1050,13909,981,13761,910,13623,839]);let ra=null;function _E(){return ra===null&&(ra=new EM(gE,32,32,Sh,As),ra.minFilter=pi,ra.magFilter=pi,ra.wrapS=la,ra.wrapT=la,ra.generateMipmaps=!1,ra.needsUpdate=!0),ra}class vE{constructor(e={}){const{canvas:i=KS(),context:r=null,depth:l=!0,stencil:u=!1,alpha:d=!1,antialias:h=!1,premultipliedAlpha:m=!0,preserveDrawingBuffer:p=!1,powerPreference:v="default",failIfMajorPerformanceCaveat:g=!1,reversedDepthBuffer:S=!1}=e;this.isWebGLRenderer=!0;let y;if(r!==null){if(typeof WebGLRenderingContext<"u"&&r instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");y=r.getContextAttributes().alpha}else y=d;const A=new Set([yh,Mh,vh]),C=new Set([da,Tr,Uo,Lo,gh,_h]),M=new Uint32Array(4),_=new Int32Array(4);let P=null,L=null;const H=[],X=[];this.domElement=i,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.toneMapping=Ya,this.toneMappingExposure=1,this.transmissionResolutionScale=1;const U=this;let z=!1;this._outputColorSpace=hi;let Q=0,w=0,T=null,I=-1,Y=null;const st=new sn,ct=new sn;let rt=null;const O=new Be(0);let G=0,W=i.width,ut=i.height,ot=1,D=null,q=null;const mt=new sn(0,0,W,ut),ft=new sn(0,0,W,ut);let Mt=!1;const J=new Pg;let dt=!1,At=!1;const Pt=new hn,Nt=new pt,ee=new sn,Ce={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0};let ne=!1;function fe(){return T===null?ot:1}let F=r;function Qt(R,j){return i.getContext(R,j)}try{const R={alpha:!0,depth:l,stencil:u,antialias:h,premultipliedAlpha:m,preserveDrawingBuffer:p,powerPreference:v,failIfMajorPerformanceCaveat:g};if("setAttribute"in i&&i.setAttribute("data-engine",`three.js r${mh}`),i.addEventListener("webglcontextlost",Et,!1),i.addEventListener("webglcontextrestored",St,!1),i.addEventListener("webglcontextcreationerror",Gt,!1),F===null){const j="webgl2";if(F=Qt(j,R),F===null)throw Qt(j)?new Error("Error creating WebGL context with your selected attributes."):new Error("Error creating WebGL context.")}}catch(R){throw R("WebGLRenderer: "+R.message),R}let It,jt,Dt,ve,Ht,Jt,N,b,$,gt,yt,at,Wt,Ut,ie,Yt,bt,Tt,Zt,Xt,Ft,le,V,Lt;function Ct(){It=new R3(F),It.init(),le=new cE(F,It),jt=new _3(F,It,e,le),Dt=new oE(F,It),jt.reversedDepthBuffer&&S&&Dt.buffers.depth.setReversed(!0),ve=new D3(F),Ht=new j1,Jt=new lE(F,It,Dt,Ht,jt,le,ve),N=new S3(U),b=new A3(U),$=new OM(F),V=new x3(F,$),gt=new C3(F,$,ve,V),yt=new L3(F,gt,$,ve),Zt=new U3(F,jt,Jt),Yt=new v3(Ht),at=new Y1(U,N,b,It,jt,V,Yt),Wt=new mE(U,Ht),Ut=new K1,ie=new nE(It),Tt=new m3(U,N,b,Dt,yt,y,m),bt=new rE(U,yt,jt),Lt=new xE(F,ve,jt,Dt),Xt=new g3(F,It,ve),Ft=new w3(F,It,ve),ve.programs=at.programs,U.capabilities=jt,U.extensions=It,U.properties=Ht,U.renderLists=Ut,U.shadowMap=bt,U.state=Dt,U.info=ve}Ct();const wt=new hE(U,F);this.xr=wt,this.getContext=function(){return F},this.getContextAttributes=function(){return F.getContextAttributes()},this.forceContextLoss=function(){const R=It.get("WEBGL_lose_context");R&&R.loseContext()},this.forceContextRestore=function(){const R=It.get("WEBGL_lose_context");R&&R.restoreContext()},this.getPixelRatio=function(){return ot},this.setPixelRatio=function(R){R!==void 0&&(ot=R,this.setSize(W,ut,!1))},this.getSize=function(R){return R.set(W,ut)},this.setSize=function(R,j,lt=!0){if(wt.isPresenting){pe("WebGLRenderer: Can't change size while VR device is presenting.");return}W=R,ut=j,i.width=Math.floor(R*ot),i.height=Math.floor(j*ot),lt===!0&&(i.style.width=R+"px",i.style.height=j+"px"),this.setViewport(0,0,R,j)},this.getDrawingBufferSize=function(R){return R.set(W*ot,ut*ot).floor()},this.setDrawingBufferSize=function(R,j,lt){W=R,ut=j,ot=lt,i.width=Math.floor(R*lt),i.height=Math.floor(j*lt),this.setViewport(0,0,R,j)},this.getCurrentViewport=function(R){return R.copy(st)},this.getViewport=function(R){return R.copy(mt)},this.setViewport=function(R,j,lt,nt){R.isVector4?mt.set(R.x,R.y,R.z,R.w):mt.set(R,j,lt,nt),Dt.viewport(st.copy(mt).multiplyScalar(ot).round())},this.getScissor=function(R){return R.copy(ft)},this.setScissor=function(R,j,lt,nt){R.isVector4?ft.set(R.x,R.y,R.z,R.w):ft.set(R,j,lt,nt),Dt.scissor(ct.copy(ft).multiplyScalar(ot).round())},this.getScissorTest=function(){return Mt},this.setScissorTest=function(R){Dt.setScissorTest(Mt=R)},this.setOpaqueSort=function(R){D=R},this.setTransparentSort=function(R){q=R},this.getClearColor=function(R){return R.copy(Tt.getClearColor())},this.setClearColor=function(){Tt.setClearColor(...arguments)},this.getClearAlpha=function(){return Tt.getClearAlpha()},this.setClearAlpha=function(){Tt.setClearAlpha(...arguments)},this.clear=function(R=!0,j=!0,lt=!0){let nt=0;if(R){let K=!1;if(T!==null){const Rt=T.texture.format;K=A.has(Rt)}if(K){const Rt=T.texture.type,Ot=C.has(Rt),Bt=Tt.getClearColor(),Vt=Tt.getClearAlpha(),re=Bt.r,oe=Bt.g,$t=Bt.b;Ot?(M[0]=re,M[1]=oe,M[2]=$t,M[3]=Vt,F.clearBufferuiv(F.COLOR,0,M)):(_[0]=re,_[1]=oe,_[2]=$t,_[3]=Vt,F.clearBufferiv(F.COLOR,0,_))}else nt|=F.COLOR_BUFFER_BIT}j&&(nt|=F.DEPTH_BUFFER_BIT),lt&&(nt|=F.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),F.clear(nt)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.dispose=function(){i.removeEventListener("webglcontextlost",Et,!1),i.removeEventListener("webglcontextrestored",St,!1),i.removeEventListener("webglcontextcreationerror",Gt,!1),Tt.dispose(),Ut.dispose(),ie.dispose(),Ht.dispose(),N.dispose(),b.dispose(),yt.dispose(),V.dispose(),Lt.dispose(),at.dispose(),wt.dispose(),wt.removeEventListener("sessionstart",ws),wt.removeEventListener("sessionend",Ds),mi.stop()};function Et(R){R.preventDefault(),Mx("WebGLRenderer: Context Lost."),z=!0}function St(){Mx("WebGLRenderer: Context Restored."),z=!1;const R=ve.autoReset,j=bt.enabled,lt=bt.autoUpdate,nt=bt.needsUpdate,K=bt.type;Ct(),ve.autoReset=R,bt.enabled=j,bt.autoUpdate=lt,bt.needsUpdate=nt,bt.type=K}function Gt(R){rn("WebGLRenderer: A WebGL context could not be created. Reason: ",R.statusMessage)}function ue(R){const j=R.target;j.removeEventListener("dispose",ue),He(j)}function He(R){De(R),Ht.remove(R)}function De(R){const j=Ht.get(R).programs;j!==void 0&&(j.forEach(function(lt){at.releaseProgram(lt)}),R.isShaderMaterial&&at.releaseShaderCache(R))}this.renderBufferDirect=function(R,j,lt,nt,K,Rt){j===null&&(j=Ce);const Ot=K.isMesh&&K.matrixWorld.determinant()<0,Bt=Oc(R,j,lt,nt,K);Dt.setMaterial(nt,Ot);let Vt=lt.index,re=1;if(nt.wireframe===!0){if(Vt=gt.getWireframeAttribute(lt),Vt===void 0)return;re=2}const oe=lt.drawRange,$t=lt.attributes.position;let me=oe.start*re,we=(oe.start+oe.count)*re;Rt!==null&&(me=Math.max(me,Rt.start*re),we=Math.min(we,(Rt.start+Rt.count)*re)),Vt!==null?(me=Math.max(me,0),we=Math.min(we,Vt.count)):$t!=null&&(me=Math.max(me,0),we=Math.min(we,$t.count));const Ue=we-me;if(Ue<0||Ue===1/0)return;V.setup(K,nt,Bt,lt,Vt);let Ee,ze=Xt;if(Vt!==null&&(Ee=$.get(Vt),ze=Ft,ze.setIndex(Ee)),K.isMesh)nt.wireframe===!0?(Dt.setLineWidth(nt.wireframeLinewidth*fe()),ze.setMode(F.LINES)):ze.setMode(F.TRIANGLES);else if(K.isLine){let ae=nt.linewidth;ae===void 0&&(ae=1),Dt.setLineWidth(ae*fe()),K.isLineSegments?ze.setMode(F.LINES):K.isLineLoop?ze.setMode(F.LINE_LOOP):ze.setMode(F.LINE_STRIP)}else K.isPoints?ze.setMode(F.POINTS):K.isSprite&&ze.setMode(F.TRIANGLES);if(K.isBatchedMesh)if(K._multiDrawInstances!==null)Po("WebGLRenderer: renderMultiDrawInstances has been deprecated and will be removed in r184. Append to renderMultiDraw arguments and use indirection."),ze.renderMultiDrawInstances(K._multiDrawStarts,K._multiDrawCounts,K._multiDrawCount,K._multiDrawInstances);else if(It.get("WEBGL_multi_draw"))ze.renderMultiDraw(K._multiDrawStarts,K._multiDrawCounts,K._multiDrawCount);else{const ae=K._multiDrawStarts,qe=K._multiDrawCounts,Te=K._multiDrawCount,vn=Vt?$.get(Vt).bytesPerElement:1,ma=Ht.get(nt).currentProgram.getUniforms();for(let je=0;je<Te;je++)ma.setValue(F,"_gl_DrawID",je),ze.render(ae[je]/vn,qe[je])}else if(K.isInstancedMesh)ze.renderInstances(me,Ue,K.count);else if(lt.isInstancedBufferGeometry){const ae=lt._maxInstanceCount!==void 0?lt._maxInstanceCount:1/0,qe=Math.min(lt.instanceCount,ae);ze.renderInstances(me,Ue,qe)}else ze.render(me,Ue)};function wn(R,j,lt){R.transparent===!0&&R.side===oa&&R.forceSinglePass===!1?(R.side=kn,R.needsUpdate=!0,pn(R,j,lt),R.side=ja,R.needsUpdate=!0,pn(R,j,lt),R.side=oa):pn(R,j,lt)}this.compile=function(R,j,lt=null){lt===null&&(lt=R),L=ie.get(lt),L.init(j),X.push(L),lt.traverseVisible(function(K){K.isLight&&K.layers.test(j.layers)&&(L.pushLight(K),K.castShadow&&L.pushShadow(K))}),R!==lt&&R.traverseVisible(function(K){K.isLight&&K.layers.test(j.layers)&&(L.pushLight(K),K.castShadow&&L.pushShadow(K))}),L.setupLights();const nt=new Set;return R.traverse(function(K){if(!(K.isMesh||K.isPoints||K.isLine||K.isSprite))return;const Rt=K.material;if(Rt)if(Array.isArray(Rt))for(let Ot=0;Ot<Rt.length;Ot++){const Bt=Rt[Ot];wn(Bt,lt,K),nt.add(Bt)}else wn(Rt,lt,K),nt.add(Rt)}),L=X.pop(),nt},this.compileAsync=function(R,j,lt=null){const nt=this.compile(R,j,lt);return new Promise(K=>{function Rt(){if(nt.forEach(function(Ot){Ht.get(Ot).currentProgram.isReady()&&nt.delete(Ot)}),nt.size===0){K(R);return}setTimeout(Rt,10)}It.get("KHR_parallel_shader_compile")!==null?Rt():setTimeout(Rt,10)})};let Wn=null;function Go(R){Wn&&Wn(R)}function ws(){mi.stop()}function Ds(){mi.start()}const mi=new Bg;mi.setAnimationLoop(Go),typeof self<"u"&&mi.setContext(self),this.setAnimationLoop=function(R){Wn=R,wt.setAnimationLoop(R),R===null?mi.stop():mi.start()},wt.addEventListener("sessionstart",ws),wt.addEventListener("sessionend",Ds),this.render=function(R,j){if(j!==void 0&&j.isCamera!==!0){rn("WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(z===!0)return;if(R.matrixWorldAutoUpdate===!0&&R.updateMatrixWorld(),j.parent===null&&j.matrixWorldAutoUpdate===!0&&j.updateMatrixWorld(),wt.enabled===!0&&wt.isPresenting===!0&&(wt.cameraAutoUpdate===!0&&wt.updateCamera(j),j=wt.getCamera()),R.isScene===!0&&R.onBeforeRender(U,R,j,T),L=ie.get(R,X.length),L.init(j),X.push(L),Pt.multiplyMatrices(j.projectionMatrix,j.matrixWorldInverse),J.setFromProjectionMatrix(Pt,Ui,j.reversedDepth),At=this.localClippingEnabled,dt=Yt.init(this.clippingPlanes,At),P=Ut.get(R,H.length),P.init(),H.push(P),wt.enabled===!0&&wt.isPresenting===!0){const Rt=U.xr.getDepthSensingMesh();Rt!==null&&Ka(Rt,j,-1/0,U.sortObjects)}Ka(R,j,0,U.sortObjects),P.finish(),U.sortObjects===!0&&P.sort(D,q),ne=wt.enabled===!1||wt.isPresenting===!1||wt.hasDepthSensing()===!1,ne&&Tt.addToRenderList(P,R),this.info.render.frame++,dt===!0&&Yt.beginShadows();const lt=L.state.shadowsArray;bt.render(lt,R,j),dt===!0&&Yt.endShadows(),this.info.autoReset===!0&&this.info.reset();const nt=P.opaque,K=P.transmissive;if(L.setupLights(),j.isArrayCamera){const Rt=j.cameras;if(K.length>0)for(let Ot=0,Bt=Rt.length;Ot<Bt;Ot++){const Vt=Rt[Ot];Ls(nt,K,R,Vt)}ne&&Tt.render(R);for(let Ot=0,Bt=Rt.length;Ot<Bt;Ot++){const Vt=Rt[Ot];Us(P,R,Vt,Vt.viewport)}}else K.length>0&&Ls(nt,K,R,j),ne&&Tt.render(R),Us(P,R,j);T!==null&&w===0&&(Jt.updateMultisampleRenderTarget(T),Jt.updateRenderTargetMipmap(T)),R.isScene===!0&&R.onAfterRender(U,R,j),V.resetDefaultState(),I=-1,Y=null,X.pop(),X.length>0?(L=X[X.length-1],dt===!0&&Yt.setGlobalState(U.clippingPlanes,L.state.camera)):L=null,H.pop(),H.length>0?P=H[H.length-1]:P=null};function Ka(R,j,lt,nt){if(R.visible===!1)return;if(R.layers.test(j.layers)){if(R.isGroup)lt=R.renderOrder;else if(R.isLOD)R.autoUpdate===!0&&R.update(j);else if(R.isLight)L.pushLight(R),R.castShadow&&L.pushShadow(R);else if(R.isSprite){if(!R.frustumCulled||J.intersectsSprite(R)){nt&&ee.setFromMatrixPosition(R.matrixWorld).applyMatrix4(Pt);const Ot=yt.update(R),Bt=R.material;Bt.visible&&P.push(R,Ot,Bt,lt,ee.z,null)}}else if((R.isMesh||R.isLine||R.isPoints)&&(!R.frustumCulled||J.intersectsObject(R))){const Ot=yt.update(R),Bt=R.material;if(nt&&(R.boundingSphere!==void 0?(R.boundingSphere===null&&R.computeBoundingSphere(),ee.copy(R.boundingSphere.center)):(Ot.boundingSphere===null&&Ot.computeBoundingSphere(),ee.copy(Ot.boundingSphere.center)),ee.applyMatrix4(R.matrixWorld).applyMatrix4(Pt)),Array.isArray(Bt)){const Vt=Ot.groups;for(let re=0,oe=Vt.length;re<oe;re++){const $t=Vt[re],me=Bt[$t.materialIndex];me&&me.visible&&P.push(R,Ot,me,lt,ee.z,$t)}}else Bt.visible&&P.push(R,Ot,Bt,lt,ee.z,null)}}const Rt=R.children;for(let Ot=0,Bt=Rt.length;Ot<Bt;Ot++)Ka(Rt[Ot],j,lt,nt)}function Us(R,j,lt,nt){const{opaque:K,transmissive:Rt,transparent:Ot}=R;L.setupLightsView(lt),dt===!0&&Yt.setGlobalState(U.clippingPlanes,lt),nt&&Dt.viewport(st.copy(nt)),K.length>0&&qn(K,j,lt),Rt.length>0&&qn(Rt,j,lt),Ot.length>0&&qn(Ot,j,lt),Dt.buffers.depth.setTest(!0),Dt.buffers.depth.setMask(!0),Dt.buffers.color.setMask(!0),Dt.setPolygonOffset(!1)}function Ls(R,j,lt,nt){if((lt.isScene===!0?lt.overrideMaterial:null)!==null)return;L.state.transmissionRenderTarget[nt.id]===void 0&&(L.state.transmissionRenderTarget[nt.id]=new Ar(1,1,{generateMipmaps:!0,type:It.has("EXT_color_buffer_half_float")||It.has("EXT_color_buffer_float")?As:da,minFilter:br,samples:4,stencilBuffer:u,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:Oe.workingColorSpace}));const Rt=L.state.transmissionRenderTarget[nt.id],Ot=nt.viewport||st;Rt.setSize(Ot.z*U.transmissionResolutionScale,Ot.w*U.transmissionResolutionScale);const Bt=U.getRenderTarget(),Vt=U.getActiveCubeFace(),re=U.getActiveMipmapLevel();U.setRenderTarget(Rt),U.getClearColor(O),G=U.getClearAlpha(),G<1&&U.setClearColor(16777215,.5),U.clear(),ne&&Tt.render(lt);const oe=U.toneMapping;U.toneMapping=Ya;const $t=nt.viewport;if(nt.viewport!==void 0&&(nt.viewport=void 0),L.setupLightsView(nt),dt===!0&&Yt.setGlobalState(U.clippingPlanes,nt),qn(R,lt,nt),Jt.updateMultisampleRenderTarget(Rt),Jt.updateRenderTargetMipmap(Rt),It.has("WEBGL_multisampled_render_to_texture")===!1){let me=!1;for(let we=0,Ue=j.length;we<Ue;we++){const Ee=j[we],{object:ze,geometry:ae,material:qe,group:Te}=Ee;if(qe.side===oa&&ze.layers.test(nt.layers)){const vn=qe.side;qe.side=kn,qe.needsUpdate=!0,on(ze,lt,nt,ae,qe,Te),qe.side=vn,qe.needsUpdate=!0,me=!0}}me===!0&&(Jt.updateMultisampleRenderTarget(Rt),Jt.updateRenderTargetMipmap(Rt))}U.setRenderTarget(Bt,Vt,re),U.setClearColor(O,G),$t!==void 0&&(nt.viewport=$t),U.toneMapping=oe}function qn(R,j,lt){const nt=j.isScene===!0?j.overrideMaterial:null;for(let K=0,Rt=R.length;K<Rt;K++){const Ot=R[K],{object:Bt,geometry:Vt,group:re}=Ot;let oe=Ot.material;oe.allowOverride===!0&&nt!==null&&(oe=nt),Bt.layers.test(lt.layers)&&on(Bt,j,lt,Vt,oe,re)}}function on(R,j,lt,nt,K,Rt){R.onBeforeRender(U,j,lt,nt,K,Rt),R.modelViewMatrix.multiplyMatrices(lt.matrixWorldInverse,R.matrixWorld),R.normalMatrix.getNormalMatrix(R.modelViewMatrix),K.onBeforeRender(U,j,lt,nt,R,Rt),K.transparent===!0&&K.side===oa&&K.forceSinglePass===!1?(K.side=kn,K.needsUpdate=!0,U.renderBufferDirect(lt,j,nt,K,R,Rt),K.side=ja,K.needsUpdate=!0,U.renderBufferDirect(lt,j,nt,K,R,Rt),K.side=oa):U.renderBufferDirect(lt,j,nt,K,R,Rt),R.onAfterRender(U,j,lt,nt,K,Rt)}function pn(R,j,lt){j.isScene!==!0&&(j=Ce);const nt=Ht.get(R),K=L.state.lights,Rt=L.state.shadowsArray,Ot=K.state.version,Bt=at.getParameters(R,K.state,Rt,j,lt),Vt=at.getProgramCacheKey(Bt);let re=nt.programs;nt.environment=R.isMeshStandardMaterial?j.environment:null,nt.fog=j.fog,nt.envMap=(R.isMeshStandardMaterial?b:N).get(R.envMap||nt.environment),nt.envMapRotation=nt.environment!==null&&R.envMap===null?j.environmentRotation:R.envMapRotation,re===void 0&&(R.addEventListener("dispose",ue),re=new Map,nt.programs=re);let oe=re.get(Vt);if(oe!==void 0){if(nt.currentProgram===oe&&nt.lightsStateVersion===Ot)return Rr(R,Bt),oe}else Bt.uniforms=at.getUniforms(R),R.onBeforeCompile(Bt,U),oe=at.acquireProgram(Bt,Vt),re.set(Vt,oe),nt.uniforms=Bt.uniforms;const $t=nt.uniforms;return(!R.isShaderMaterial&&!R.isRawShaderMaterial||R.clipping===!0)&&($t.clippingPlanes=Yt.uniform),Rr(R,Bt),nt.needsLights=Vo(R),nt.lightsStateVersion=Ot,nt.needsLights&&($t.ambientLightColor.value=K.state.ambient,$t.lightProbe.value=K.state.probe,$t.directionalLights.value=K.state.directional,$t.directionalLightShadows.value=K.state.directionalShadow,$t.spotLights.value=K.state.spot,$t.spotLightShadows.value=K.state.spotShadow,$t.rectAreaLights.value=K.state.rectArea,$t.ltc_1.value=K.state.rectAreaLTC1,$t.ltc_2.value=K.state.rectAreaLTC2,$t.pointLights.value=K.state.point,$t.pointLightShadows.value=K.state.pointShadow,$t.hemisphereLights.value=K.state.hemi,$t.directionalShadowMap.value=K.state.directionalShadowMap,$t.directionalShadowMatrix.value=K.state.directionalShadowMatrix,$t.spotShadowMap.value=K.state.spotShadowMap,$t.spotLightMatrix.value=K.state.spotLightMatrix,$t.spotLightMap.value=K.state.spotLightMap,$t.pointShadowMap.value=K.state.pointShadowMap,$t.pointShadowMatrix.value=K.state.pointShadowMatrix),nt.currentProgram=oe,nt.uniformsList=null,oe}function Oi(R){if(R.uniformsList===null){const j=R.currentProgram.getUniforms();R.uniformsList=Tc.seqWithValue(j.seq,R.uniforms)}return R.uniformsList}function Rr(R,j){const lt=Ht.get(R);lt.outputColorSpace=j.outputColorSpace,lt.batching=j.batching,lt.batchingColor=j.batchingColor,lt.instancing=j.instancing,lt.instancingColor=j.instancingColor,lt.instancingMorph=j.instancingMorph,lt.skinning=j.skinning,lt.morphTargets=j.morphTargets,lt.morphNormals=j.morphNormals,lt.morphColors=j.morphColors,lt.morphTargetsCount=j.morphTargetsCount,lt.numClippingPlanes=j.numClippingPlanes,lt.numIntersection=j.numClipIntersection,lt.vertexAlphas=j.vertexAlphas,lt.vertexTangents=j.vertexTangents,lt.toneMapping=j.toneMapping}function Oc(R,j,lt,nt,K){j.isScene!==!0&&(j=Ce),Jt.resetTextureUnits();const Rt=j.fog,Ot=nt.isMeshStandardMaterial?j.environment:null,Bt=T===null?U.outputColorSpace:T.isXRRenderTarget===!0?T.texture.colorSpace:Es,Vt=(nt.isMeshStandardMaterial?b:N).get(nt.envMap||Ot),re=nt.vertexColors===!0&&!!lt.attributes.color&&lt.attributes.color.itemSize===4,oe=!!lt.attributes.tangent&&(!!nt.normalMap||nt.anisotropy>0),$t=!!lt.morphAttributes.position,me=!!lt.morphAttributes.normal,we=!!lt.morphAttributes.color;let Ue=Ya;nt.toneMapped&&(T===null||T.isXRRenderTarget===!0)&&(Ue=U.toneMapping);const Ee=lt.morphAttributes.position||lt.morphAttributes.normal||lt.morphAttributes.color,ze=Ee!==void 0?Ee.length:0,ae=Ht.get(nt),qe=L.state.lights;if(dt===!0&&(At===!0||R!==Y)){const Mn=R===Y&&nt.id===I;Yt.setState(nt,R,Mn)}let Te=!1;nt.version===ae.__version?(ae.needsLights&&ae.lightsStateVersion!==qe.state.version||ae.outputColorSpace!==Bt||K.isBatchedMesh&&ae.batching===!1||!K.isBatchedMesh&&ae.batching===!0||K.isBatchedMesh&&ae.batchingColor===!0&&K.colorTexture===null||K.isBatchedMesh&&ae.batchingColor===!1&&K.colorTexture!==null||K.isInstancedMesh&&ae.instancing===!1||!K.isInstancedMesh&&ae.instancing===!0||K.isSkinnedMesh&&ae.skinning===!1||!K.isSkinnedMesh&&ae.skinning===!0||K.isInstancedMesh&&ae.instancingColor===!0&&K.instanceColor===null||K.isInstancedMesh&&ae.instancingColor===!1&&K.instanceColor!==null||K.isInstancedMesh&&ae.instancingMorph===!0&&K.morphTexture===null||K.isInstancedMesh&&ae.instancingMorph===!1&&K.morphTexture!==null||ae.envMap!==Vt||nt.fog===!0&&ae.fog!==Rt||ae.numClippingPlanes!==void 0&&(ae.numClippingPlanes!==Yt.numPlanes||ae.numIntersection!==Yt.numIntersection)||ae.vertexAlphas!==re||ae.vertexTangents!==oe||ae.morphTargets!==$t||ae.morphNormals!==me||ae.morphColors!==we||ae.toneMapping!==Ue||ae.morphTargetsCount!==ze)&&(Te=!0):(Te=!0,ae.__version=nt.version);let vn=ae.currentProgram;Te===!0&&(vn=pn(nt,j,K));let ma=!1,je=!1,Pi=!1;const Ze=vn.getUniforms(),Sn=ae.uniforms;if(Dt.useProgram(vn.program)&&(ma=!0,je=!0,Pi=!0),nt.id!==I&&(I=nt.id,je=!0),ma||Y!==R){Dt.buffers.depth.getReversed()&&R.reversedDepth!==!0&&(R._reversedDepth=!0,R.updateProjectionMatrix()),Ze.setValue(F,"projectionMatrix",R.projectionMatrix),Ze.setValue(F,"viewMatrix",R.matrixWorldInverse);const En=Ze.map.cameraPosition;En!==void 0&&En.setValue(F,Nt.setFromMatrixPosition(R.matrixWorld)),jt.logarithmicDepthBuffer&&Ze.setValue(F,"logDepthBufFC",2/(Math.log(R.far+1)/Math.LN2)),(nt.isMeshPhongMaterial||nt.isMeshToonMaterial||nt.isMeshLambertMaterial||nt.isMeshBasicMaterial||nt.isMeshStandardMaterial||nt.isShaderMaterial)&&Ze.setValue(F,"isOrthographic",R.isOrthographicCamera===!0),Y!==R&&(Y=R,je=!0,Pi=!0)}if(K.isSkinnedMesh){Ze.setOptional(F,K,"bindMatrix"),Ze.setOptional(F,K,"bindMatrixInverse");const Mn=K.skeleton;Mn&&(Mn.boneTexture===null&&Mn.computeBoneTexture(),Ze.setValue(F,"boneTexture",Mn.boneTexture,Jt))}K.isBatchedMesh&&(Ze.setOptional(F,K,"batchingTexture"),Ze.setValue(F,"batchingTexture",K._matricesTexture,Jt),Ze.setOptional(F,K,"batchingIdTexture"),Ze.setValue(F,"batchingIdTexture",K._indirectTexture,Jt),Ze.setOptional(F,K,"batchingColorTexture"),K._colorsTexture!==null&&Ze.setValue(F,"batchingColorTexture",K._colorsTexture,Jt));const mn=lt.morphAttributes;if((mn.position!==void 0||mn.normal!==void 0||mn.color!==void 0)&&Zt.update(K,lt,vn),(je||ae.receiveShadow!==K.receiveShadow)&&(ae.receiveShadow=K.receiveShadow,Ze.setValue(F,"receiveShadow",K.receiveShadow)),nt.isMeshGouraudMaterial&&nt.envMap!==null&&(Sn.envMap.value=Vt,Sn.flipEnvMap.value=Vt.isCubeTexture&&Vt.isRenderTargetTexture===!1?-1:1),nt.isMeshStandardMaterial&&nt.envMap===null&&j.environment!==null&&(Sn.envMapIntensity.value=j.environmentIntensity),Sn.dfgLUT!==void 0&&(Sn.dfgLUT.value=_E()),je&&(Ze.setValue(F,"toneMappingExposure",U.toneMappingExposure),ae.needsLights&&Pc(Sn,Pi),Rt&&nt.fog===!0&&Wt.refreshFogUniforms(Sn,Rt),Wt.refreshMaterialUniforms(Sn,nt,ot,ut,L.state.transmissionRenderTarget[R.id]),Tc.upload(F,Oi(ae),Sn,Jt)),nt.isShaderMaterial&&nt.uniformsNeedUpdate===!0&&(Tc.upload(F,Oi(ae),Sn,Jt),nt.uniformsNeedUpdate=!1),nt.isSpriteMaterial&&Ze.setValue(F,"center",K.center),Ze.setValue(F,"modelViewMatrix",K.modelViewMatrix),Ze.setValue(F,"normalMatrix",K.normalMatrix),Ze.setValue(F,"modelMatrix",K.matrixWorld),nt.isShaderMaterial||nt.isRawShaderMaterial){const Mn=nt.uniformsGroups;for(let En=0,Ti=Mn.length;En<Ti;En++){const zi=Mn[En];Lt.update(zi,vn),Lt.bind(zi,vn)}}return vn}function Pc(R,j){R.ambientLightColor.needsUpdate=j,R.lightProbe.needsUpdate=j,R.directionalLights.needsUpdate=j,R.directionalLightShadows.needsUpdate=j,R.pointLights.needsUpdate=j,R.pointLightShadows.needsUpdate=j,R.spotLights.needsUpdate=j,R.spotLightShadows.needsUpdate=j,R.rectAreaLights.needsUpdate=j,R.hemisphereLights.needsUpdate=j}function Vo(R){return R.isMeshLambertMaterial||R.isMeshToonMaterial||R.isMeshPhongMaterial||R.isMeshStandardMaterial||R.isShadowMaterial||R.isShaderMaterial&&R.lights===!0}this.getActiveCubeFace=function(){return Q},this.getActiveMipmapLevel=function(){return w},this.getRenderTarget=function(){return T},this.setRenderTargetTextures=function(R,j,lt){const nt=Ht.get(R);nt.__autoAllocateDepthBuffer=R.resolveDepthBuffer===!1,nt.__autoAllocateDepthBuffer===!1&&(nt.__useRenderToTexture=!1),Ht.get(R.texture).__webglTexture=j,Ht.get(R.depthTexture).__webglTexture=nt.__autoAllocateDepthBuffer?void 0:lt,nt.__hasExternalTextures=!0},this.setRenderTargetFramebuffer=function(R,j){const lt=Ht.get(R);lt.__webglFramebuffer=j,lt.__useDefaultFramebuffer=j===void 0};const Qa=F.createFramebuffer();this.setRenderTarget=function(R,j=0,lt=0){T=R,Q=j,w=lt;let nt=!0,K=null,Rt=!1,Ot=!1;if(R){const Vt=Ht.get(R);if(Vt.__useDefaultFramebuffer!==void 0)Dt.bindFramebuffer(F.FRAMEBUFFER,null),nt=!1;else if(Vt.__webglFramebuffer===void 0)Jt.setupRenderTarget(R);else if(Vt.__hasExternalTextures)Jt.rebindTextures(R,Ht.get(R.texture).__webglTexture,Ht.get(R.depthTexture).__webglTexture);else if(R.depthBuffer){const $t=R.depthTexture;if(Vt.__boundDepthTexture!==$t){if($t!==null&&Ht.has($t)&&(R.width!==$t.image.width||R.height!==$t.image.height))throw new Error("WebGLRenderTarget: Attached DepthTexture is initialized to the incorrect size.");Jt.setupDepthRenderbuffer(R)}}const re=R.texture;(re.isData3DTexture||re.isDataArrayTexture||re.isCompressedArrayTexture)&&(Ot=!0);const oe=Ht.get(R).__webglFramebuffer;R.isWebGLCubeRenderTarget?(Array.isArray(oe[j])?K=oe[j][lt]:K=oe[j],Rt=!0):R.samples>0&&Jt.useMultisampledRTT(R)===!1?K=Ht.get(R).__webglMultisampledFramebuffer:Array.isArray(oe)?K=oe[lt]:K=oe,st.copy(R.viewport),ct.copy(R.scissor),rt=R.scissorTest}else st.copy(mt).multiplyScalar(ot).floor(),ct.copy(ft).multiplyScalar(ot).floor(),rt=Mt;if(lt!==0&&(K=Qa),Dt.bindFramebuffer(F.FRAMEBUFFER,K)&&nt&&Dt.drawBuffers(R,K),Dt.viewport(st),Dt.scissor(ct),Dt.setScissorTest(rt),Rt){const Vt=Ht.get(R.texture);F.framebufferTexture2D(F.FRAMEBUFFER,F.COLOR_ATTACHMENT0,F.TEXTURE_CUBE_MAP_POSITIVE_X+j,Vt.__webglTexture,lt)}else if(Ot){const Vt=j;for(let re=0;re<R.textures.length;re++){const oe=Ht.get(R.textures[re]);F.framebufferTextureLayer(F.FRAMEBUFFER,F.COLOR_ATTACHMENT0+re,oe.__webglTexture,lt,Vt)}}else if(R!==null&&lt!==0){const Vt=Ht.get(R.texture);F.framebufferTexture2D(F.FRAMEBUFFER,F.COLOR_ATTACHMENT0,F.TEXTURE_2D,Vt.__webglTexture,lt)}I=-1},this.readRenderTargetPixels=function(R,j,lt,nt,K,Rt,Ot,Bt=0){if(!(R&&R.isWebGLRenderTarget)){rn("WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let Vt=Ht.get(R).__webglFramebuffer;if(R.isWebGLCubeRenderTarget&&Ot!==void 0&&(Vt=Vt[Ot]),Vt){Dt.bindFramebuffer(F.FRAMEBUFFER,Vt);try{const re=R.textures[Bt],oe=re.format,$t=re.type;if(!jt.textureFormatReadable(oe)){rn("WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!jt.textureTypeReadable($t)){rn("WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}j>=0&&j<=R.width-nt&&lt>=0&&lt<=R.height-K&&(R.textures.length>1&&F.readBuffer(F.COLOR_ATTACHMENT0+Bt),F.readPixels(j,lt,nt,K,le.convert(oe),le.convert($t),Rt))}finally{const re=T!==null?Ht.get(T).__webglFramebuffer:null;Dt.bindFramebuffer(F.FRAMEBUFFER,re)}}},this.readRenderTargetPixelsAsync=async function(R,j,lt,nt,K,Rt,Ot,Bt=0){if(!(R&&R.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let Vt=Ht.get(R).__webglFramebuffer;if(R.isWebGLCubeRenderTarget&&Ot!==void 0&&(Vt=Vt[Ot]),Vt)if(j>=0&&j<=R.width-nt&&lt>=0&&lt<=R.height-K){Dt.bindFramebuffer(F.FRAMEBUFFER,Vt);const re=R.textures[Bt],oe=re.format,$t=re.type;if(!jt.textureFormatReadable(oe))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!jt.textureTypeReadable($t))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");const me=F.createBuffer();F.bindBuffer(F.PIXEL_PACK_BUFFER,me),F.bufferData(F.PIXEL_PACK_BUFFER,Rt.byteLength,F.STREAM_READ),R.textures.length>1&&F.readBuffer(F.COLOR_ATTACHMENT0+Bt),F.readPixels(j,lt,nt,K,le.convert(oe),le.convert($t),0);const we=T!==null?Ht.get(T).__webglFramebuffer:null;Dt.bindFramebuffer(F.FRAMEBUFFER,we);const Ue=F.fenceSync(F.SYNC_GPU_COMMANDS_COMPLETE,0);return F.flush(),await QS(F,Ue,4),F.bindBuffer(F.PIXEL_PACK_BUFFER,me),F.getBufferSubData(F.PIXEL_PACK_BUFFER,0,Rt),F.deleteBuffer(me),F.deleteSync(Ue),Rt}else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")},this.copyFramebufferToTexture=function(R,j=null,lt=0){const nt=Math.pow(2,-lt),K=Math.floor(R.image.width*nt),Rt=Math.floor(R.image.height*nt),Ot=j!==null?j.x:0,Bt=j!==null?j.y:0;Jt.setTexture2D(R,0),F.copyTexSubImage2D(F.TEXTURE_2D,lt,0,0,Ot,Bt,K,Rt),Dt.unbindTexture()};const Ns=F.createFramebuffer(),pa=F.createFramebuffer();this.copyTextureToTexture=function(R,j,lt=null,nt=null,K=0,Rt=null){Rt===null&&(K!==0?(Po("WebGLRenderer: copyTextureToTexture function signature has changed to support src and dst mipmap levels."),Rt=K,K=0):Rt=0);let Ot,Bt,Vt,re,oe,$t,me,we,Ue;const Ee=R.isCompressedTexture?R.mipmaps[Rt]:R.image;if(lt!==null)Ot=lt.max.x-lt.min.x,Bt=lt.max.y-lt.min.y,Vt=lt.isBox3?lt.max.z-lt.min.z:1,re=lt.min.x,oe=lt.min.y,$t=lt.isBox3?lt.min.z:0;else{const mn=Math.pow(2,-K);Ot=Math.floor(Ee.width*mn),Bt=Math.floor(Ee.height*mn),R.isDataArrayTexture?Vt=Ee.depth:R.isData3DTexture?Vt=Math.floor(Ee.depth*mn):Vt=1,re=0,oe=0,$t=0}nt!==null?(me=nt.x,we=nt.y,Ue=nt.z):(me=0,we=0,Ue=0);const ze=le.convert(j.format),ae=le.convert(j.type);let qe;j.isData3DTexture?(Jt.setTexture3D(j,0),qe=F.TEXTURE_3D):j.isDataArrayTexture||j.isCompressedArrayTexture?(Jt.setTexture2DArray(j,0),qe=F.TEXTURE_2D_ARRAY):(Jt.setTexture2D(j,0),qe=F.TEXTURE_2D),F.pixelStorei(F.UNPACK_FLIP_Y_WEBGL,j.flipY),F.pixelStorei(F.UNPACK_PREMULTIPLY_ALPHA_WEBGL,j.premultiplyAlpha),F.pixelStorei(F.UNPACK_ALIGNMENT,j.unpackAlignment);const Te=F.getParameter(F.UNPACK_ROW_LENGTH),vn=F.getParameter(F.UNPACK_IMAGE_HEIGHT),ma=F.getParameter(F.UNPACK_SKIP_PIXELS),je=F.getParameter(F.UNPACK_SKIP_ROWS),Pi=F.getParameter(F.UNPACK_SKIP_IMAGES);F.pixelStorei(F.UNPACK_ROW_LENGTH,Ee.width),F.pixelStorei(F.UNPACK_IMAGE_HEIGHT,Ee.height),F.pixelStorei(F.UNPACK_SKIP_PIXELS,re),F.pixelStorei(F.UNPACK_SKIP_ROWS,oe),F.pixelStorei(F.UNPACK_SKIP_IMAGES,$t);const Ze=R.isDataArrayTexture||R.isData3DTexture,Sn=j.isDataArrayTexture||j.isData3DTexture;if(R.isDepthTexture){const mn=Ht.get(R),Mn=Ht.get(j),En=Ht.get(mn.__renderTarget),Ti=Ht.get(Mn.__renderTarget);Dt.bindFramebuffer(F.READ_FRAMEBUFFER,En.__webglFramebuffer),Dt.bindFramebuffer(F.DRAW_FRAMEBUFFER,Ti.__webglFramebuffer);for(let zi=0;zi<Vt;zi++)Ze&&(F.framebufferTextureLayer(F.READ_FRAMEBUFFER,F.COLOR_ATTACHMENT0,Ht.get(R).__webglTexture,K,$t+zi),F.framebufferTextureLayer(F.DRAW_FRAMEBUFFER,F.COLOR_ATTACHMENT0,Ht.get(j).__webglTexture,Rt,Ue+zi)),F.blitFramebuffer(re,oe,Ot,Bt,me,we,Ot,Bt,F.DEPTH_BUFFER_BIT,F.NEAREST);Dt.bindFramebuffer(F.READ_FRAMEBUFFER,null),Dt.bindFramebuffer(F.DRAW_FRAMEBUFFER,null)}else if(K!==0||R.isRenderTargetTexture||Ht.has(R)){const mn=Ht.get(R),Mn=Ht.get(j);Dt.bindFramebuffer(F.READ_FRAMEBUFFER,Ns),Dt.bindFramebuffer(F.DRAW_FRAMEBUFFER,pa);for(let En=0;En<Vt;En++)Ze?F.framebufferTextureLayer(F.READ_FRAMEBUFFER,F.COLOR_ATTACHMENT0,mn.__webglTexture,K,$t+En):F.framebufferTexture2D(F.READ_FRAMEBUFFER,F.COLOR_ATTACHMENT0,F.TEXTURE_2D,mn.__webglTexture,K),Sn?F.framebufferTextureLayer(F.DRAW_FRAMEBUFFER,F.COLOR_ATTACHMENT0,Mn.__webglTexture,Rt,Ue+En):F.framebufferTexture2D(F.DRAW_FRAMEBUFFER,F.COLOR_ATTACHMENT0,F.TEXTURE_2D,Mn.__webglTexture,Rt),K!==0?F.blitFramebuffer(re,oe,Ot,Bt,me,we,Ot,Bt,F.COLOR_BUFFER_BIT,F.NEAREST):Sn?F.copyTexSubImage3D(qe,Rt,me,we,Ue+En,re,oe,Ot,Bt):F.copyTexSubImage2D(qe,Rt,me,we,re,oe,Ot,Bt);Dt.bindFramebuffer(F.READ_FRAMEBUFFER,null),Dt.bindFramebuffer(F.DRAW_FRAMEBUFFER,null)}else Sn?R.isDataTexture||R.isData3DTexture?F.texSubImage3D(qe,Rt,me,we,Ue,Ot,Bt,Vt,ze,ae,Ee.data):j.isCompressedArrayTexture?F.compressedTexSubImage3D(qe,Rt,me,we,Ue,Ot,Bt,Vt,ze,Ee.data):F.texSubImage3D(qe,Rt,me,we,Ue,Ot,Bt,Vt,ze,ae,Ee):R.isDataTexture?F.texSubImage2D(F.TEXTURE_2D,Rt,me,we,Ot,Bt,ze,ae,Ee.data):R.isCompressedTexture?F.compressedTexSubImage2D(F.TEXTURE_2D,Rt,me,we,Ee.width,Ee.height,ze,Ee.data):F.texSubImage2D(F.TEXTURE_2D,Rt,me,we,Ot,Bt,ze,ae,Ee);F.pixelStorei(F.UNPACK_ROW_LENGTH,Te),F.pixelStorei(F.UNPACK_IMAGE_HEIGHT,vn),F.pixelStorei(F.UNPACK_SKIP_PIXELS,ma),F.pixelStorei(F.UNPACK_SKIP_ROWS,je),F.pixelStorei(F.UNPACK_SKIP_IMAGES,Pi),Rt===0&&j.generateMipmaps&&F.generateMipmap(qe),Dt.unbindTexture()},this.initRenderTarget=function(R){Ht.get(R).__webglFramebuffer===void 0&&Jt.setupRenderTarget(R)},this.initTexture=function(R){R.isCubeTexture?Jt.setTextureCube(R,0):R.isData3DTexture?Jt.setTexture3D(R,0):R.isDataArrayTexture||R.isCompressedArrayTexture?Jt.setTexture2DArray(R,0):Jt.setTexture2D(R,0),Dt.unbindTexture()},this.resetState=function(){Q=0,w=0,T=null,Dt.reset(),V.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return Ui}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(e){this._outputColorSpace=e;const i=this.getContext();i.drawingBufferColorSpace=Oe._getDrawingBufferColorSpace(e),i.unpackColorSpace=Oe._getUnpackColorSpace()}}const SE="./02.jpg",ME=`
  uniform float uTime;
...
`,bE=({analysis:o,capturedImage:e,active:i,growthTrigger:r,width:l,height:u})=>{const d=Kt.useRef(null),h=Kt.useRef(null),m=Kt.useRef(null),p=Kt.useRef(null),v=Kt.useRef(null),g=Kt.useRef(0),S=Kt.useRef(null),y=Kt.useRef(0),A=Kt.useRef(null),C=Kt.useRef(0),M=Kt.useRef(null),_=Kt.useRef(null),P=5e4,L=Kt.useRef(null),H=Kt.useRef(Date.now());Kt.useEffect(()=>{if(!e||!o||!i)return;(async()=>{const w=new Image;w.src=SE,await new Promise(rt=>{w.onload=rt});const T=document.createElement("canvas");T.width=l,T.height=u;const I=T.getContext("2d");if(!I)return;const Y=Math.max(l/w.width,u/w.height),st=(l-w.width*Y)/2,ct=(u-w.height*Y)/2;I.drawImage(w,st,ct,w.width*Y,w.height*Y),console.log("=== PlantGrowth Debug (Mask Mode) ==="),console.log("Mask Image size:",w.width,"x",w.height),console.log("Canvas size:",l,"x",u),console.log("Scale:",Y),console.log("Offset:",st,ct);try{const O=I.getImageData(0,0,l,u).data,G=[],W=[];for(let ut=0;ut<u;ut+=3)for(let ot=0;ot<l;ot+=3){const D=(ut*l+ot)*4,q=O[D],mt=O[D+1],ft=O[D+2];if(q>200&&mt<100&&ft<100){const Mt=ot-l/2,J=u/2-ut;Math.random()<.3?G.push(Mt,J):W.push(Mt,J)}}console.log("Red mask points - Edges:",G.length/2,"Surface:",W.length/2),console.log("======================================"),S.current=new Float32Array(G),y.current=G.length/2,A.current=new Float32Array(W),C.current=W.length/2}catch(rt){console.error("Mask detection failed",rt)}})()},[e,o,i,l,u]),Kt.useEffect(()=>{if(!d.current)return;const Q=new bM,w=new Ig(l/-2,l/2,u/2,u/-2,1,1e3);w.position.z=100;const T=new vE({alpha:!0,antialias:!1});T.setSize(l,u),T.setPixelRatio(Math.min(window.devicePixelRatio,2)),d.current.appendChild(T.domElement);const I=new Ni,Y=new Float32Array(P*3),st=new Float32Array(P*3),ct=new Float32Array(P).fill(0);I.setAttribute("position",new ii(Y,3)),I.setAttribute("color",new ii(st,3)),I.setAttribute("aType",new ii(ct,1));const rt=new Li({uniforms:{uTime:{value:0}},vertexShader:ME,fragmentShader:yE,transparent:!0,blending:bd,depthTest:!1}),O=new wM(I,rt);return Q.add(O),L.current={positions:Y,colors:st,types:ct,velocities:new Float32Array(P*3),life:new Float32Array(P),activeHeads:[]},m.current=Q,p.current=w,v.current=T,M.current=I,_.current=rt,z(),()=>{cancelAnimationFrame(g.current),d.current&&T.domElement&&d.current.removeChild(T.domElement),I.dispose(),rt.dispose(),T.dispose()}},[l,u]),Kt.useEffect(()=>{r>0&&i&&X(40)},[r,i]);const X=Q=>{if(!L.current)return;const{positions:w,colors:T,types:I,velocities:Y,life:st,activeHeads:ct}=L.current,rt=S.current,O=y.current,G=A.current,W=C.current;if(!rt&&!G)return;let ut=0;for(let ot=0;ot<P&&!(ut>=Q);ot++)if(I[ot]===0){let D=0,q=0;if(W>0&&(Math.random()>.5||O===0)&&G){const ft=Math.floor(Math.random()*W);D=G[ft*2],q=G[ft*2+1]}else if(rt&&O>0){const ft=Math.floor(Math.random()*O);D=rt[ft*2],q=rt[ft*2+1]}else continue;I[ot]=1,st[ot]=1,w[ot*3]=D,w[ot*3+1]=q,w[ot*3+2]=0,Y[ot*3]=(Math.random()-.5)*2,Y[ot*3+1]=(Math.random()-.5)*2,T[ot*3]=0,T[ot*3+1]=1,T[ot*3+2]=.5,ct.push(ot),ut++}M.current&&(M.current.attributes.aType.needsUpdate=!0)},U=(Q,w,T)=>{if(!L.current)return;const{positions:I,colors:Y,types:st,life:ct}=L.current,rt=Math.floor(Math.random()*P);for(let O=0;O<50;O++){const G=(rt+O)%P;if(st[G]===0){st[G]=T,I[G*3]=Q,I[G*3+1]=w,I[G*3+2]=0,ct[G]=-1,T===2?(Y[G*3]=0+Math.random()*.1,Y[G*3+1]=.2+Math.random()*.15,Y[G*3+2]=.1+Math.random()*.1):T===3?(Y[G*3]=1,Y[G*3+1]=0+Math.random()*.2,Y[G*3+2]=.8+Math.random()*.2):T===4&&(Y[G*3]=0+Math.random()*.2,Y[G*3+1]=.3+Math.random()*.3,Y[G*3+2]=.8+Math.random()*.2);return}}},z=()=>{var O;if(!m.current||!L.current||!M.current||!_.current)return;const{positions:Q,types:w,velocities:T,life:I,activeHeads:Y}=L.current,st=(Date.now()-H.current)/1e3;_.current.uniforms.uTime.value=st;const ct=(O=h.current)==null?void 0:O.getContext("2d");ct&&(ct.clearRect(0,0,l,u),ct.strokeStyle="rgba(250, 250, 250, 0.9)",ct.fillStyle="#00FF00",ct.lineWidth=1,ct.font="10px monospace");const rt=[];for(const G of Y){if(w[G]!==1)continue;const W=Q[G*3],ut=Q[G*3+1];if(ct){const ot=W+l/2,D=u/2-ut;if(ct.strokeRect(ot-10,D-10,20,20),Math.random()>.8&&ct.fillText(Math.random().toFixed(3),ot+12,D-2),rt.length>0&&Math.random()>.5){const q=rt[rt.length-1],mt=Q[q*3]+l/2,ft=u/2-Q[q*3+1];Math.abs(mt-ot)<100&&Math.abs(ft-D)<100&&(ct.beginPath(),ct.moveTo(ot,D),ct.lineTo(mt,ft),ct.stroke())}}Q[G*3]+=T[G*3],Q[G*3+1]+=T[G*3+1],Math.random()<.6&&U(W,ut,2),T[G*3]+=(Math.random()-.5)*.8,T[G*3+1]+=(Math.random()-.5)*.8,T[G*3]*=.92,T[G*3+1]*=.92,Math.random()<.03&&U(W+(Math.random()-.5)*15,ut+(Math.random()-.5)*15,3),Math.random()<.02&&U(W+(Math.random()-.5)*30,ut+(Math.random()-.5)*30,4),I[G]-=.015,I[G]<=0?(w[G]=0,U(W,ut,3),U(W+5,ut+5,3)):rt.push(G)}L.current.activeHeads=rt,M.current.attributes.position.needsUpdate=!0,M.current.attributes.color.needsUpdate=!0,M.current.attributes.aType.needsUpdate=!0,v.current&&m.current&&p.current&&v.current.render(m.current,p.current),g.current=requestAnimationFrame(z)};return ce.jsxs(ce.Fragment,{children:[ce.jsx("div",{ref:d,className:"absolute inset-0 pointer-events-none z-10"}),ce.jsx("canvas",{ref:h,width:l,height:u,className:"absolute inset-0 pointer-events-none z-15 mix-blend-screen opacity-70"})]})},EE=({baseImage:o,maskImage:e,width:i,height:r,active:l})=>{const u=Kt.useRef(null),d=Kt.useRef(null),h=Kt.useRef(null),m=Kt.useRef(null),p=Kt.useRef(0),v=Kt.useRef(0);return Kt.useEffect(()=>{console.log("================================================="),console.log("MaskedGlitchEffect: COMPONENT MOUNTED!"),console.log("Active:",l),console.log("Width:",i,"Height:",r),console.log("================================================="),(async()=>{console.log("MaskedGlitchEffect: Loading images..."),console.log("Base image path:",o),console.log("Mask image path:",e);try{const S=new Image;S.crossOrigin="anonymous",S.src=o,await new Promise((U,z)=>{S.onload=U,S.onerror=z}),d.current=S,console.log("Base image loaded:",S.width,"x",S.height);const y=new Image;y.crossOrigin="anonymous",y.src=e,await new Promise((U,z)=>{y.onload=U,y.onerror=z}),h.current=y,console.log("Mask image loaded:",y.width,"x",y.height);const A=document.createElement("canvas");A.width=i,A.height=r;const C=A.getContext("2d",{willReadFrequently:!0});if(!C)return;const M=Math.max(i/y.width,r/y.height),_=(i-y.width*M)/2,P=(r-y.height*M)/2;C.drawImage(y,_,P,y.width*M,y.height*M);const L=C.getImageData(0,0,i,r),H=new Uint8Array(i*r);let X=0;for(let U=0;U<L.data.length;U+=4){const z=L.data[U],Q=L.data[U+1],w=L.data[U+2],T=U/4;z>150&&Q<100&&w<100&&(H[T]=1,X++)}m.current=H,console.log(`Mask created: ${X} red pixels out of ${i*r} total pixels`),console.log(`Red region coverage: ${(X/(i*r)*100).toFixed(2)}%`)}catch(S){console.error("Failed to load images:",S)}})()},[o,e,i,r]),Kt.useEffect(()=>{if(!l||!u.current)return;const g=u.current,S=g.getContext("2d",{willReadFrequently:!0});if(!S)return;g.width=i,g.height=r;const y=document.createElement("canvas");y.width=i,y.height=r;const A=y.getContext("2d",{willReadFrequently:!0});if(!A)return;let C=Date.now(),M=0;const _=()=>{const P=d.current,L=m.current;if(!P||!L){p.current=requestAnimationFrame(_);return}M++,M%60===0&&console.log("MaskedGlitchEffect: Animating frame",M);const H=Date.now(),X=(H-C)/1e3;C=H,v.current+=X;const U=Math.max(i/P.width,r/P.height),z=(i-P.width*U)/2,Q=(r-P.height*U)/2;A.clearRect(0,0,i,r),A.drawImage(P,z,Q,P.width*U,P.height*U);const w=A.getImageData(0,0,i,r),T=w.data,I=new Uint8ClampedArray(T),Y=v.current,st=4,ct=3,rt=.01,O=35,G=3,W=2,ut=.03;for(let D=0;D<T.length;D+=4)T[D+3]=0;for(let D=0;D<r;D++){const q=Math.sin(D*rt+Y*st)*ct,mt=Math.random()<ut,ft=mt?(Math.random()-.1)*2*W:0,Mt=Math.floor(q+ft),J=mt?G:O,At=Math.random()<.01,Pt=At?Mt+Math.floor((Math.random()-.5)*2*J):Mt,Nt=At?Mt+Math.floor((Math.random()-.5)*J*.5):Mt,ee=At?Mt-Math.floor((Math.random()-.5)*2*J):Mt;for(let Ce=0;Ce<i;Ce++){const ne=D*i+Ce;if(L[ne]===1){const fe=Ce+Pt,F=Ce+Nt,Qt=Ce+ee,It=ne*4;if(fe>=0&&fe<i){const jt=(D*i+fe)*4;T[jt]=I[It],T[jt+3]=255}if(F>=0&&F<i){const jt=(D*i+F)*4;T[jt+1]=I[It+1],T[jt+3]=255}if(Qt>=0&&Qt<i){const jt=(D*i+Qt)*4;T[jt+2]=I[It+2],T[jt+3]=255}}}}if(Math.random()<.15){const D=Math.floor(Math.random()*r),q=Math.floor(Math.random()*20)+10,mt=Math.floor((Math.random()-.5)*50);for(let ft=0;ft<q;ft++){const Mt=D+ft;if(!(Mt<0||Mt>=r))for(let J=0;J<i;J++){const dt=Mt*i+J;if(L[dt]===1){const At=Math.max(0,Math.min(i-1,J+mt)),Pt=Mt*i+At,Nt=dt*4,ee=Pt*4;T[Nt]=I[ee],T[Nt+1]=I[ee+1],T[Nt+2]=I[ee+2]}}}}S.clearRect(0,0,i,r),S.putImageData(w,0,0),p.current=requestAnimationFrame(_)};return _(),()=>{cancelAnimationFrame(p.current)}},[l,i,r]),l?ce.jsx("canvas",{ref:u,className:"absolute top-0 left-0 w-full h-full pointer-events-none",style:{opacity:.5,zIndex:10}}):null},ug="./01.jpg",fg="./02.jpg",TE=()=>{console.log("###################################################"),console.log("APP.TSX: COMPONENT RENDERING!"),console.log("###################################################");const o=Kt.useRef(null),e=Kt.useRef(null),i=Kt.useRef(null),r=Kt.useRef(null),l=Kt.useRef(null),u=Kt.useRef(null),d=Kt.useRef(null),h=Kt.useRef(0),m=Kt.useRef(0),p=Kt.useRef(null),v=Kt.useRef(null),g=Kt.useRef(0),S=Kt.useRef([]),[y,A]=Kt.useState(!1),[C,M]=Kt.useState({width:160,height:120}),[_,P]=Kt.useState(en.IDLE),[L,H]=Kt.useState(null),[X,U]=Kt.useState("Align camera to reference image"),[z,Q]=Kt.useState(null),[w,T]=Kt.useState({width:window.innerWidth,height:window.innerHeight}),[I,Y]=Kt.useState(!1),[st,ct]=Kt.useState(0),[rt,O]=Kt.useState(0);console.log("APP STATE - gameState:",_,"capturedImage:",!!z,"isAligned:",I),Kt.useEffect(()=>{const ut=()=>T({width:window.innerWidth,height:window.innerHeight});return window.addEventListener("resize",ut),()=>window.removeEventListener("resize",ut)},[]),Kt.useEffect(()=>{let ut=!1;const ot=q=>new Promise((mt,ft)=>{const Mt=new Image;Mt.crossOrigin="anonymous",Mt.onload=()=>mt(Mt),Mt.onerror=J=>ft(J),Mt.src=q});return(async()=>{try{const[q,mt]=await Promise.all([ot(ug),ot(fg)]);if(ut)return;r.current=q;const ft=200,Mt=Math.round(ft*(q.height/q.width));M({width:ft,height:Mt});const J=document.createElement("canvas");J.width=ft,J.height=Mt;const dt=J.getContext("2d",{willReadFrequently:!0});if(dt){const Nt=Math.min(ft/q.width,Mt/q.height),ee=(ft-q.width*Nt)/2,Ce=(Mt-q.height*Nt)/2;dt.drawImage(q,ee,Ce,q.width*Nt,q.height*Nt),l.current=dt.getImageData(0,0,ft,Mt);const ne=new Float32Array(ft*Mt),fe=new Float32Array(ft*Mt);let F=0,Qt=0;const It=l.current.data;for(let jt=0;jt<Mt;jt++)for(let Dt=0;Dt<ft;Dt++){const ve=(jt*ft+Dt)*4,Ht=(It[ve]+It[ve+1]+It[ve+2])/3;ne[jt*ft+Dt]=Ht,F+=Ht;const Jt=ft-1-Dt;fe[jt*ft+Jt]=Ht,Qt+=Ht}u.current=ne,d.current=fe,h.current=F/ne.length,m.current=Qt/fe.length}const At=document.createElement("canvas");At.width=ft,At.height=Mt;const Pt=At.getContext("2d",{willReadFrequently:!0});if(Pt){const Nt=Math.max(ft/mt.width,Mt/mt.height),ee=(ft-mt.width*Nt)/2,Ce=(Mt-mt.height*Nt)/2;Pt.drawImage(mt,ee,Ce,mt.width*Nt,mt.height*Nt);const ne=Pt.getImageData(0,0,ft,Mt).data,fe=new Uint8Array(ft*Mt),F=new Uint8Array(ft*Mt);let Qt=0;for(let It=0;It<Mt;It++)for(let jt=0;jt<ft;jt++){const Dt=(It*ft+jt)*4,ve=ne[Dt],Ht=ne[Dt+1],Jt=ne[Dt+2];if(ve>180&&Ht<100&&Jt<100){const N=It*ft+jt;fe[N]=1;const b=ft-1-jt;F[It*ft+b]=1,Qt++}}p.current=fe,v.current=F,g.current=Qt,console.log(`Mask processed: ${Qt} ROI pixels (${(Qt/(ft*Mt)*100).toFixed(1)}%)`)}console.log("Reference and mask loaded and processed"),A(!0)}catch(q){console.error("Failed to load reference/mask images",q),U("IMAGE LOAD ERROR"),P(en.ERROR)}})(),()=>{ut=!0}},[]),Kt.useEffect(()=>{(async()=>{try{console.log("Starting camera...");const ot=await navigator.mediaDevices.getUserMedia({video:{facingMode:"environment",width:{ideal:1920},height:{ideal:1080}},audio:!1});o.current&&(o.current.srcObject=ot)}catch(ot){console.error("Camera access denied:",ot),U("CAMERA ERROR"),P(en.ERROR)}})()},[]),Kt.useEffect(()=>{if(_!==en.IDLE||!y||!o.current||!i.current||!l.current)return;console.log("Starting continuous alignment detection...");const ut=()=>{const D=o.current,q=i.current,mt=l.current;if(!D||!q||!mt||D.videoWidth===0||!u.current||!d.current)return;q.width=C.width,q.height=C.height;const ft=q.getContext("2d");if(!ft)return;ft.clearRect(0,0,C.width,C.height);const Mt=Math.max(C.width/D.videoWidth,C.height/D.videoHeight),J=(C.width-D.videoWidth*Mt)/2,dt=(C.height-D.videoHeight*Mt)/2;ft.drawImage(D,J,dt,D.videoWidth*Mt,D.videoHeight*Mt);const At=ft.getImageData(0,0,C.width,C.height),Pt=new Float32Array(C.width*C.height);for(let It=0;It<At.data.length;It+=4){const jt=(At.data[It]+At.data[It+1]+At.data[It+2])/3,Dt=It/4;Pt[Dt]=jt}const Nt=(It,jt,Dt)=>{let ve=0,Ht=0,Jt=0;if(Dt)for(let at=0;at<It.length;at++)Dt[at]&&(ve+=It[at],Ht+=jt[at],Jt++);else{Jt=It.length;for(let at=0;at<It.length;at++)ve+=It[at],Ht+=jt[at]}if(Jt===0)return-1;const N=ve/Jt,b=Ht/Jt;let $=0,gt=0,yt=0;for(let at=0;at<It.length;at++){if(Dt&&!Dt[at])continue;const Wt=It[at]-N,Ut=jt[at]-b;$+=Wt*Ut,gt+=Wt*Wt,yt+=Ut*Ut}return gt===0||yt===0?-1:$/Math.sqrt(gt*yt)},ee=Nt(Pt,u.current,p.current),Ce=Nt(Pt,d.current,v.current),ne=Math.max(ee,Ce),fe=Math.max(0,Math.min(100,(ne+1)*50));S.current.push(fe),S.current.length>5&&S.current.shift();const F=S.current.reduce((It,jt)=>It+jt,0)/S.current.length;ct(F);const Qt=40;Y(F>=Qt),F>=Qt?U(`ALIGNED ${F.toFixed(0)}% - TAP TO CAPTURE`):U(`Align camera: ${F.toFixed(0)}%`)};ut();const ot=setInterval(ut,500);return()=>clearInterval(ot)},[_,y,C.width,C.height]);const G=Kt.useCallback(async()=>{if(_===en.IDLE){if(!o.current||!e.current)return;if(!I){U("PLEASE ALIGN WITH REFERENCE IMAGE"),setTimeout(()=>U(""),2e3);return}P(en.CAPTURING),U("");const ut=o.current,ot=e.current;ot.width=ut.videoWidth,ot.height=ut.videoHeight;const D=ot.getContext("2d");if(!D)return;D.drawImage(ut,0,0,ot.width,ot.height);const q=ot.toDataURL("image/jpeg",.8);Q(q),P(en.ANALYZING),U("VENI VIDI VICI"),H({detected:!0,box_2d:[0,0,1e3,1e3],confidence:1,label:"mask_area"}),U(""),P(en.GROWING),O(ft=>ft+1)}else _===en.GROWING&&O(ut=>ut+1)},[_,I]),W=()=>{P(en.IDLE),Q(null),H(null),O(0),ct(0),Y(!1),S.current=[],U("")};return ce.jsxs("div",{className:"relative w-full h-screen bg-void-black overflow-hidden font-future select-none",children:[ce.jsx("canvas",{ref:e,className:"hidden"}),ce.jsx("canvas",{ref:i,className:"hidden"}),ce.jsx("video",{ref:o,autoPlay:!0,playsInline:!0,muted:!0,className:`absolute top-0 left-0 w-full h-full object-cover transition-opacity duration-700 ${z?"opacity-0":"opacity-100"}`,style:{filter:"contrast(1.1) brightness(1.1) saturate(0.8) sepia(0.2)"}}),!z&&_===en.IDLE&&ce.jsxs(ce.Fragment,{children:[ce.jsx(EE,{baseImage:ug,maskImage:fg,width:w.width,height:w.height,active:!0}),ce.jsx("div",{className:"absolute inset-0 pointer-events-none transition-all duration-300",style:{border:I?"8px solid #00FF00":"8px solid #FF0000",boxShadow:I?"0 0 30px rgba(0, 255, 0, 0.8), inset 0 0 30px rgba(0, 255, 0, 0.3)":"0 0 20px rgba(255, 0, 0, 0.5)"}})]}),z&&ce.jsx("img",{src:z,alt:"Frozen Reality",className:"absolute top-0 left-0 w-full h-full object-cover",style:{filter:"contrast(1.2) brightness(0.9) saturate(0.5) sepia(0.3) blur(0.5px)"}}),ce.jsx(bE,{active:_===en.GROWING,analysis:L,capturedImage:z,growthTrigger:rt,width:w.width,height:w.height}),ce.jsx(oS,{gameState:_,onInteraction:G,onReset:W,analysisText:X,analysisResult:L}),ce.jsx("div",{className:"absolute inset-0 pointer-events-none bg-[radial-gradient(circle_at_center,transparent_40%,rgba(0,10,0,0.6)_100%)] mix-blend-multiply"}),ce.jsx("div",{className:"absolute inset-0 pointer-events-none opacity-20 bg-[url('https://grainy-gradients.vercel.app/noise.svg')] brightness-150 contrast-150"})]})},Xg=document.getElementById("root");if(!Xg)throw new Error("Could not find root element to mount to");const AE=sS.createRoot(Xg);AE.render(ce.jsx(Jv.StrictMode,{children:ce.jsx(TE,{})}));
